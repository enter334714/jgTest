...
module.exports = function (r) {
  ...
  var o = Object.assign || function (e) {
    ...
    return e && e.__esModule ? e : { default: e };
      ...
      var t;return e.method = (e.method || O[115]).toUpperCase(), O[503] !== e.method || e.header || (e.header = { "Content-Type": O[504] }), e.private || (t = wx.getStorageSync(O[505]), e.data = o({}, d.default.baseParams, d.default.gameParams, d.default.agentParams, d.default.deviceParams, e.data, { "device-ext": encodeURIComponent(JSON.stringify(d.default.extParams)), token: t ? t.user_token : "", ts: new Date().getTime() })), e.data.sign = this.sign(e), /^http/.test(e.url) || (e.url = d.default.baseUrl + e.url), delete e.private, delete e.signUrl, e;
    }, setting: function () {
      return o({}, d.default.setting, 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {});
    }, sign: function (t) {
      var e = "";e = t.data.channel_id ? O[506] : O[507], t.app_key && (e = O[508] + t.app_key);var n = (t.signUrl || t.url).substr(1),
          r = Object.keys(t.data).sort(),
          a = "";r.forEach(function (e) {
        a += "&" + e + "=" + t.data[e];
      });return t.app_key ? (0, u.default)(a.substr(1) + "&" + e) : (0, u.default)((t.method + "&" + encodeURIComponent(n) + "&" + encodeURIComponent(a.substr(1)) + "&" + e).replace(/\(/g, O[509]).replace(/\)/g, O[510]));
    }, renderQRCode: function (e, t, n) {
      var r = t.getContext("2d"),
          a = wx.createImage();a.src = n.image, a.onload = function () {
        r.lineJoin = O[243], r.lineWidth = 30, r.strokeStyle = O[511], r.strokeRect((window.innerWidth - 240) / 2, (window.innerHeight - 264) / 2, 240, 264), r.fillStyle = O[511], r.fillRect((window.innerWidth - 220) / 2, (window.innerHeight - 244) / 2, 220, 244), r.fillStyle = O[512], r.font = O[513], r.textAlign = O[514], r.fillText(n.intro, window.innerWidth / 2, (window.innerHeight - 258) / 2 + 218 + 30, 250), r.drawImage(a, (window.innerWidth - 218) / 2, (window.innerHeight - 258) / 2, 218, 218);
      }, s = { canvas: e, qrcvs: t, qrctx: r, data: n }, e.addEventListener(O[515], c);
    }, removeOffScreen: function () {
      s && (s.qrctx.clearRect(0, 0, s.qrcvs.width, s.qrcvs.height), s.canvas.removeEventListener(O[515], c));
    } };function c(e) {
    e.preventDefault();var t = e.touches[0],
        e = t.clientX,
        t = t.clientY;e >= (window.innerWidth - 218) / 2 && e <= (window.innerWidth - 218) / 2 + 218 && t >= (window.innerHeight - 258) / 2 && t <= (window.innerHeight - 258) / 2 + 218 ? wx.previewImage({ urls: [s.data.image] }) : (s.qrctx.clearRect(0, 0, s.qrcvs.width, s.qrcvs.height), s.canvas.removeEventListener(O[515], c));
  }e.exports = n;
}, function (e, t, n) {
  "use strict";
  ...
  var o = Object.assign || function (e) {
    ...
    return t in e ? Object.defineProperty(e, t, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : e[t] = n, e;
      ...
      var m = this,
          h = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};return [O[516], O[517], O[518], O[519], O[520], O[521], O[522]].map(function (e) {
        void 0 !== h[e] && (O[516] === e ? g.default.baseParams[e] = h.app_id : O[517] === e ? g.default.gameParams[O[523]] = h.mp_id : O[522] === e ? g.default.debug = h.debug : g.default.setting[e] = h[e]);
        ...
        h.app_id ? i.default.getDNSInfo({ data: o({ ts: parseInt(new Date().getTime() / 1e3), channel_id: g.default.channelId, url: g.default.baseUrl, un_url: "", app_id: g.default.baseParams.app_id }, g.default.deviceParams) }).then(function (e) {
          ...
          } else g.default.launchOptions = { state: t || r || "" }, l({ msg: O[526] });
        }, function (e) {
          l({ msg: O[526] });
        }) : e({ msg: O[527] });
      });
      ...
      var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};return new Promise(function (n, r) {
        wx.login({ success: function (e) {
            var t;e.code ? (a.data = Object.assign({}, a.data, (c(t = {}, O[528], g.default.extParams), c(t, O[529], g.default.launchOptions.ext), c(t, O[530], g.default.launchOptions.state), c(t, O[531], e.code), t)), n(i.default.reversal(a))) : r(e);
          }, fail: function (e) {
            r(e);
          } });
      });
      ...
      var r = this,
        ...
        wx.checkSession({ success: function (e) {
            ...
            console.log(O[533], a), i.default.wxLogin(a).then(function (e) {
              var t = wx.getLaunchOptionsSync();i.default.reportAdClick({ data: { click_id: t.query && t.query.gdt_vid || "", url: "" } }).then(function (e) {
                console.log(O[532], e);
              }), n(r.getUserInfo(a));
            }, function (e) {
      ...
      var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};return new Promise(function (t, n) {
        i.default.mpPay(e).then(function (e) {
          ...
          n({ msg: e.errMsg || O[527] });
        });
      });
    }, mpPayQuery: function () {
      var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};var t;return e.data && void 0 !== e.data[O[534]] || (t = wx.getStorageSync(O[535]), e.data = o({}, e.data, { "order-order_id": t ? t.order_id : "" })), i.default.mpPayQuery(e);
    }, midasPay: function () {
      var a = this,
        ...
        i.default.midasPay(o).then(function (e) {
          ...
          t({ msg: e.errMsg || O[527] });
        });
      });
    }, midasPayQuery: function () {
      var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};var t;return e.data && void 0 !== e.data[O[534]] || (t = wx.getStorageSync(O[535]), e.data = o({}, e.data, { "order-order_id": t ? t.order_id : "" })), i.default.midasPayQuery(e);
    }, checkPay: function () {
      ...
      var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {},
          r = o({}, g.default.baseParams, g.default.gameParams, g.default.agentParams, g.default.deviceParams, { token: wx.getStorageSync(O[505]).user_token, ts: new Date().getTime() });return r.sign = a.default.sign({ url: O[536], data: r }), new Promise(function (t, n) {
        wx.uploadFile({ url: g.default.baseUrl + O[536], filePath: e.data.filePath, name: O[537], formData: r, success: function (e) {
            e = e.data;200 === (e = JSON.parse(e)).code ? t({ msg: O[526] }) : n({ msg: e.msg || O[527] });
          } });
      });
    } };e.exports = n;
}, function (e, t, n) {
  ...
  var d = Object.assign || function (e) {
    ...
    var r = e.data,
      ...
      l.default.ajax(e).then(function (e) {
        e.data && e.data.data ? t({ data: e.data.data, msg: O[526] }) : t({ msg: O[526] });
      }, function (e) {
        ...
        } else n({ msg: e.data ? e.data.msg || O[538] : e.errMsg });
      });
    });
  }var o = !1,
      u = { getDNSInfo: function (e) {
      return Pb(d({ method: O[539], url: O[540], signUrl: O[541], private: !0 }, e));
    }, cpUserCheck: function (e) {
      return Pb(d({ method: O[539], url: O[542], private: !0 }, e));
    }, login: function (e) {
      return r.default.launchOptions.ext ? e.data = Object.assign({}, e.data, d({ state: r.default.launchOptions.state }, e)) : e.data = Object.assign({}, e.data, d({}, e)), r.default.launchOptions && r.default.launchOptions.state && (e.data.state = r.default.launchOptions.state), Pb(d({ method: O[539], url: O[543] }, e)).then(function (e) {
        return e && wx.setStorageSync(O[505], e.data), e;
      });
    }, wxLogin: function (r) {
      ...
      return Pb(d({ method: O[539], url: O[544] }, e));
    }, setUserInfo: function (e) {
      return Pb(d({ method: O[539], url: O[545] }, e)).then(function (e) {
        return wx.setStorageSync(O[505], e.data), e;
      });
    }, upRoleInfo: function (e) {
      return e.conf = { showLoading: !1, showToast: !1 }, Pb(d({ method: O[539], url: O[546] }, e)).then(function (e) {
        return e;
      });
    }, getUserInfo: function (e) {
      return Pb(d({ method: O[539], url: O[547] }, e)).then(function (e) {
        if (e.data.report_status && 2 == e.data.report_status) try {
          require(O[548]);
        } catch (e) {}return wx.setStorageSync(O[505], e.data), e;
      });
    }, getShareInfo: function (e) {
      return Pb(d({ url: O[549] }, e));
    }, addShareInfo: function (e) {
      return Pb(d({ url: O[550] }, e));
    }, getShareQrcode: function (e) {
      return Pb(d({ url: O[551] }, e));
    }, mpPay: function (t) {
      var n = this;return this.preOrder(t).then(function (e) {
        return t.data = d({}, t.data, { payway: O[552], "order-order_id": e.data.order_id }), n.mpOrder(t);
      });
    }, midasPay: function (t) {
      var n = this;return this.preOrder(t).then(function (e) {
      ...
      var f = this;return new Promise(function (t, n) {
        var e = c.mode,
            ...
            s.data[O[534]] = c.order_id, s.conf = { showLoading: !1, showToast: !1 }, f.midasPayQuery(s).then(function (e) {
            ...
            e.errMsg && (O[553] === e.errMsg ? (t = wx.getStorageSync(O[505]), e.msg = t && t.ios_text || O[554], e.duration = 3e3) : e.msg = e.errMsg);var t = l.default.setting(s.conf);t.showToast && (e.msg && (t.toastParams.title = e.msg), e.duration && (t.toastParams.duration = e.duration), wx.showToast(t.toastParams)), n(e);
          } });
      });
    }, checkPay: function (t) {
      var n = this;return this.preOrder(t).then(function (e) {
        return 2 === e.data.check ? n.wxMidasPay(e.data, t) : (t.data[O[534]] = e.data.order_id, n.checkPayInfo(t));
      });
    }, preOrder: function (e) {
      return Pb(d({ method: O[539], url: O[555] }, e)).then(function (e) {
        return wx.setStorageSync(O[535], e.data), e;
      }, function (e) {
        return e;
      });
    }, mpOrder: function (t) {
      var n = this;return Pb(d({ method: O[539], url: O[556] }, t)).then(function (e) {
      ...
      return new Promise(function (t, n) {
        wx.requestPayment(d({}, e, { success: function (e) {
            ...
            O[557] === e.errMsg && n({ msg: O[558] });
          } }));
      });
    }, mpPayQuery: function (e) {
      return Pb(d({ method: O[539], url: O[559] }, e));
    }, midasPayQuery: function (e) {
      return Pb(d({ url: O[560] }, e));
    }, checkPayInfo: function (a) {
      var o = this;return Pb(d({ url: O[561] }, a)).then(function (r) {
        return r.data.order_id = a.data[O[534]], new Promise(function (t, e) {
          r.data.image && wx.setStorageSync(O[562], r.data.image);var n = wx.getStorageSync(O[562]);r.data && 4 == +r.data.pay_type ? (wx.showModal({ title: O[563], content: O[564], success: function (e) {
              e.confirm && wx.openCustomerServiceConversation();
            } }), t(r)) : r.data && r.data.mp_id ? (wx.navigateToMiniProgram({ appId: r.data.mp_id, path: r.data.path }), t(r)) : n ? (a.canvas && a.offscreen && l.default.renderQRCode(a.canvas, a.offscreen, { image: n, intro: r.data.intro || O[565] }), r.data.image = n, t(r)) : o.checkQrcode(a).then(function (e) {
            e = e.data.poster_img;a.canvas && a.offscreen && l.default.renderQRCode(a.canvas, a.offscreen, { image: e, intro: r.data.intro || O[565] }), wx.setStorageSync(O[562], e), r.data.image = e, t(r);
          }, function (e) {
            t(r);
          });
        });
      ...
      return Pb(d({ method: O[539], url: O[566] }, e));
    }, checkOrder: function (t) {
      var n = this;return Pb(d({ method: O[539], url: O[567] }, t)).then(function (e) {
        return n.wxMpPay(JSON.parse(e.data.token), t);
      });
    }, checkQrcode: function (e) {
      return e.data && (e.data.is_last = 2), Pb(d({ url: O[568] }, e));
    }, reportAdClick: function (e) {
      return Pb(d({ url: O[569] }, e));
    }, removeOffScreen: function () {
      l.default.removeOffScreen();
    }, checkMsg: function (e) {
      return Pb(d({ method: O[539], url: O[570] }, e));
    }, gameMinicard: function (e) {
      return Pb(d({ method: O[539], url: O[571] }, e));
    }, userCheckpay: function (e) {
      return Pb(d({ method: O[539], url: O[572] }, e));
    } };e.exports = u;
}, function (e, t, n) {
  "use strict";
  ...
  function o(e, t) {
    ...
    var t,
        n,
        r = "";for (n = 0; n < e.length; n += 1) t = e.charCodeAt(n), r += O[573].charAt(t >>> 4 & 15) + O[573].charAt(15 & t);return r;
  }function h(e) {
