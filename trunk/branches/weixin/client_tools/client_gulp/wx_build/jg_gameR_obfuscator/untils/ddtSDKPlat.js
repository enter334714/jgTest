...
!function (t) {
  ...
  var o, r, i, a, s;o = n(2), r = n(1).utf8, i = n(3), a = n(1).bin, (s = function (t, e) {
    t.constructor == String ? t = (e && "binary" === e.encoding ? a : r).stringToBytes(t) : i(t) ? t = Array.prototype.slice.call(t, 0) : Array.isArray(t) || t.constructor === Uint8Array || (t = t.toString());for (var n = o.bytesToWords(t), l = (t = 8 * t.length, 1732584193), c = -271733879, u = -1732584194, d = 271733878, p = 0; p < n.length; p++) n[p] = 16711935 & (n[p] << 8 | n[p] >>> 24) | 4278255360 & (n[p] << 24 | n[p] >>> 8);n[t >>> 5] |= 128 << t % 32, n[14 + (64 + t >>> 9 << 4)] = t;var f = s._ff,
        g = s._gg,
        y = s._hh,
      ...
      var _ = l,
          m = c,
          S = u,
          P = d;l = f(l, c, u, d, n[p + 0], 7, -680876936), d = f(d, l, c, u, n[p + 1], 12, -389564586), u = f(u, d, l, c, n[p + 2], 17, 606105819), c = f(c, u, d, l, n[p + 3], 22, -1044525330);l = f(l, c, u, d, n[p + 4], 7, -176418897), d = f(d, l, c, u, n[p + 5], 12, 1200080426), u = f(u, d, l, c, n[p + 6], 17, -1473231341), c = f(c, u, d, l, n[p + 7], 22, -45705983), l = f(l, c, u, d, n[p + 8], 7, 1770035416), d = f(d, l, c, u, n[p + 9], 12, -1958414417), u = f(u, d, l, c, n[p + 10], 17, -42063), c = f(c, u, d, l, n[p + 11], 22, -1990404162), l = f(l, c, u, d, n[p + 12], 7, 1804603682), d = f(d, l, c, u, n[p + 13], 12, -40341101), u = f(u, d, l, c, n[p + 14], 17, -1502002290), l = g(l, c = f(c, u, d, l, n[p + 15], 22, 1236535329), u, d, n[p + 1], 5, -165796510), d = g(d, l, c, u, n[p + 6], 9, -1069501632), u = g(u, d, l, c, n[p + 11], 14, 643717713), c = g(c, u, d, l, n[p + 0], 20, -373897302), l = g(l, c, u, d, n[p + 5], 5, -701558691), d = g(d, l, c, u, n[p + 10], 9, 38016083), u = g(u, d, l, c, n[p + 15], 14, -660478335), c = g(c, u, d, l, n[p + 4], 20, -405537848), l = g(l, c, u, d, n[p + 9], 5, 568446438), d = g(d, l, c, u, n[p + 14], 9, -1019803690), u = g(u, d, l, c, n[p + 3], 14, -187363961), c = g(c, u, d, l, n[p + 8], 20, 1163531501), l = g(l, c, u, d, n[p + 13], 5, -1444681467), d = g(d, l, c, u, n[p + 2], 9, -51403784), u = g(u, d, l, c, n[p + 7], 14, 1735328473), l = y(l, c = g(c, u, d, l, n[p + 12], 20, -1926607734), u, d, n[p + 5], 4, -378558), d = y(d, l, c, u, n[p + 8], 11, -2022574463), u = y(u, d, l, c, n[p + 11], 16, 1839030562), c = y(c, u, d, l, n[p + 14], 23, -35309556), l = y(l, c, u, d, n[p + 1], 4, -1530992060), d = y(d, l, c, u, n[p + 4], 11, 1272893353), u = y(u, d, l, c, n[p + 7], 16, -155497632), c = y(c, u, d, l, n[p + 10], 23, -1094730640), l = y(l, c, u, d, n[p + 13], 4, 681279174), d = y(d, l, c, u, n[p + 0], 11, -358537222), u = y(u, d, l, c, n[p + 3], 16, -722521979), c = y(c, u, d, l, n[p + 6], 23, 76029189), l = y(l, c, u, d, n[p + 9], 4, -640364487), d = y(d, l, c, u, n[p + 12], 11, -421815835), u = y(u, d, l, c, n[p + 15], 16, 530742520), l = h(l, c = y(c, u, d, l, n[p + 2], 23, -995338651), u, d, n[p + 0], 6, -198630844), d = h(d, l, c, u, n[p + 7], 10, 1126891415), u = h(u, d, l, c, n[p + 14], 15, -1416354905), c = h(c, u, d, l, n[p + 5], 21, -57434055), l = h(l, c, u, d, n[p + 12], 6, 1700485571), d = h(d, l, c, u, n[p + 3], 10, -1894986606), u = h(u, d, l, c, n[p + 10], 15, -1051523), c = h(c, u, d, l, n[p + 1], 21, -2054922799), l = h(l, c, u, d, n[p + 8], 6, 1873313359), d = h(d, l, c, u, n[p + 15], 10, -30611744), u = h(u, d, l, c, n[p + 6], 15, -1560198380), c = h(c, u, d, l, n[p + 13], 21, 1309151649), l = h(l, c, u, d, n[p + 4], 6, -145523070), d = h(d, l, c, u, n[p + 11], 10, -1120210379), u = h(u, d, l, c, n[p + 2], 15, 718787259), c = h(c, u, d, l, n[p + 9], 21, -343485551), l = l + _ >>> 0, c = c + m >>> 0, u = u + S >>> 0, d = d + P >>> 0;
    }return o.endian([l, c, u, d]);
  ...
  var o, r, i;n.r(e), (e = o = o || {})[e.WXMG = 1e3] = "WXMG", e[e.OPPO = 1001] = "OPPO", e[e.VIVO = 1002] = "VIVO", (e = {})[e.TEST = 0] = "TEST", e[e.DEV = 1] = "DEV", e[e.ONLINE = 2] = "ONLINE", (e = r = r || {}).createRole = "createRole", e.upRoleLevel = "upRoleLevel", e.enterGame = "enterGame", e.enterServer = "enterServer", (e = i = i || {}).INIT_SUCCESS = "init_success", e.INIT_FAIL = "init_fail", e.LOGIN_SUCCESS = "login_success", e.LOGIN_FAIL = "login_fail", e.PAY_SUCCESS = "pay_success", e.PAY_FAIL = "pay_fail", e.PAY_CANCEL = "pay_cancel", e.PAY_TYPE = "pay_type", e.CHECK_INFO = "check_info";var a = (s.track_url = "https://api.mengxuanwl.com/Api/MiniGame/sdkTrack", s.sdk_base_url = "https://api.mengxuanwl.com", s.sdk_config_url = "/Api/MiniGame/init", s.sdk_device_url = "", s.data_up_url = "", s.gameToken = "", s.login_url = "", s.place_order_url = "", s.reply_order_url = "", s.checkExtInfo_url = "", s.plat_extend_info = [], s.userInfo = {}, s.curApiParams = {}, s.platExtInfo = {}, s.switchZFlag = !1, s.system = "", s);function s() {}var l = (Object.defineProperty(c, "inst", { get: function () {
  ...
  }, d);function d() {}e = n(0);var p = n.n(e),
      f = (g.postData = function (t, e, n, o) {
    var r = null;r = (o = void 0 !== o && o) ? { time: Math.round(Date.now() / 1e3), stamp: a.curFlag } : { gameToken: a.gameToken, time: Math.round(Date.now() / 1e3) }, r = Object.assign({}, a.initOps, e, r);a.curApiParams = r;r = u.objKeySort(r), r = u.procRequestParams(r), r = (r = decodeURIComponent(r)) + "&sign=" + p()(r);var i = new XMLHttpRequest(),
    ...
    var e = this,
        ...
        o = u.objKeySort(n);o = u.procRequestParams(o), o = decodeURIComponent(o);n.sign = p()(o), wx.request({ url: a.reply_order_url, data: n, method: "POST", header: { "Content-Type": "application/x-www-form-urlencoded;" }, success: function (n) {
    ...
    return (O = Object.assign || function (t) {
      ...
      b = (e(k, v = n), k.prototype.init = function () {
    ...
    t = O(O({}, t), { token: this.login_token, appVersion: a.gameVersion, engineVersion: this.engineVersion }), v.prototype.createOrder.call(this, t);
    ...
    var t = this,
        ...
        var o = n.data ? n.data.token : "unkown";a.platExtInfo = { token: o, pkgName: a.pkgName }, e.login_token = o, l.inst.log("ddtSDKPlat ==== oppo登录成功", n), v.prototype.login.call(t);
      }, fail: function (t) {
    ...
    var t = a.curApiParams;console.log(t);var e,
        n = { adver: "", channelVer: "", code: "", gameId: "", gameToken: "", gdt_vid: "", mode: "", platId: "", time: "", weixinadinfo: "", sign: "", uid: "" },
        o = {};for (e in t) for (var r in n) e == r && (o[r] = t[r]);var i = u.objKeySort(o);i = u.procRequestParams(i), i = (i = decodeURIComponent(i)) + "&sign=" + p()(i);wx.openCustomerServiceConversation({ sendMessagePath: i, sessionFrom: "turngame", showMessageCard: !0 });
