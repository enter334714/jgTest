console.info("0 \u8fdb\u5165\u6e38\u620f\u5305"), window.lastError, wx.onError(function (o) {
  if (o) {
    if (o.message) {
      var n = window.config.game_ver.replace(new RegExp(/\./, "g"), "_");var e = o.message;var i = e.match(/(Zqy10Zqy10Zqy10Zqy10Zqy10\/Zqy102GZqy10MEZqy102.js:)[0-9]{1,60}(:)/g);if (i) for (var w = 0; w < i.length; w++) {
        var r;i[w] && 0 < i[w].length && (r = parseInt(i[w].replace("Zqy10Zqy10Zqy10Zqy10Zqy10/Zqy102GZqy10MEZqy102.js:", "").replace(":", "")), e = e.replace(i[w], i[w].replace(":" + r + ":", ":" + (r - 2) + ":")));
      }e = (e = e.replace(new RegExp("Zqy10Zqy10Zqy10Zqy10Zqy10/Zqy102GZqy10MEZqy102.js", "g"), "Zqy10Zqy10Zqy10Zqy10Zqy10/main__" + n + ".min.js")).replace(new RegExp("Zqy10Zqy10Zqy10Zqy10Zqy10/Zqy102MZqy10IZqy102.js", "g"), "Zqy10Zqy10Zqy10Zqy10Zqy10/main__" + n + ".min.js"), o.message = e;
  ...
  if (!o || !n) return 0;o = o.split("."), n = n.split(".");var e = Math.max(o.length, n.length);for (; o.length < e;) o.push("0");for (; n.length < e;) n.push("0");for (var i = 0; i < e; i++) {
    var w = parseInt(o[i]),
        r = parseInt(n[i]);if (r < w) return 1;if (w < r) return -1;
  }return 0;
  ...
  console.log("protobuf \u5206\u5305\u52a0\u8f7d");var o = wx.loadSubpackage({ name: "Zqy102pftZqy102", success: function (o) {
  ...
  console.log("Main \u5206\u5305\u52a0\u8f7d");var o = wx.loadSubpackage({ name: "Zqy10Zqy10Zqy10Zqy10Zqy10", success: function (o) {
