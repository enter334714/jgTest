...
function console_log(e, n, t, o) {
  ...
  var n = [];n.push({ key: e.key, value: e.val }), $KFDBGQ(wx.getSystemInfoSync().SDKVersion, "1.9.92") >= 0 && wx.setUserCloudStorage({ KVDataList: n, success: function (e) {
  ...
  $KFDBGQ(wx.getSystemInfoSync().SDKVersion, "2.0.6") >= 0 ? (userinfoBtn = wx.createUserInfoButton({ type: "image", image: e.imageUrl, lang: "zh_CN", style: { left: e.left, top: e.top, width: e.width, height: e.height } }), userinfoBtn.onTap(function (t) {
  ...
  e = e.split("."), n = n.split(".");for (var t = Math.max(e.length, n.length); e.length < t;) e.push("0");for (; n.length < t;) n.push("0");for (var o = 0; o < t; o++) {
    var a = parseInt(e[o]),
        i = parseInt(n[o]);if (a > i) return 1;if (a < i) return -1;
  }return 0;
}function sha1(e, n) {
  var t = sort(e),
      o = "";for (var a in t) "sign" != a && (o += a + "=" + t[a] + "&");if (o = o.substring(0, o.length - 1), o = o.replace(/\s+/g, "") + n, "sha1" == _signType) var i = CryptoJS.SHA1(o);else var i = CryptoJS.MD5(o);var r = i.toString();return console_log("加密", "原串str:" + o + "\n 加密sign=" + r), r;
}function sort(e) {
  var n = [];for (var t in e) n.push(t);n.sort();var o = [];for (var a in n) o[n[a]] = e[n[a]];return o;
  ...
  return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e;
    ...
    var t = { _identify: hd_config.pro.identify, _gameAppid: hd_config.pro.appid, _secret: hd_config.pro.secret_key, channel_id: hd_config.pro.channel_id, sub_channel_id: hd_config.pro.sub_channel_id },
        ...
        a = "https://cps.fjbgwl.com/api",
        i = sha1(o, t._secret);wx.request({ url: a + "/wxgame_create", method: "POST", header: { "content-type": "application/x-www-form-urlencoded" }, data: { identify: t._identify, client_id: t._gameAppid, extra_info: e.extra_info, goods_count: e.goods_count, goods_des: e.goods_des, goods_identifier: e.goods_identifier, goods_name: e.goods_name, pay_amount: e.pay_amount, openid: e.openid, redirect_uri: e.redirect_uri, role_id: e.role_id, role_name: e.role_name, server_id: e.server_id, server_name: e.server_name, channel_id: t.channel_id, sub_channel_id: t.sub_channel_id, order_sn: e.order_sn, sign: i }, success: function (o) {
        var i = o.data.data.result.signParam;if (console_log("submitOrder signParam", i, 1, a), void 0 == i) n(falseReturn);else if (0 == i.code) n(trueReturn);else if (1 == i.code) {
          var r = i.data,
              s = o.data.data.result;wx.requestMidasPayment({ mode: "game", env: i.env, currencyType: "CNY", platform: "android", offerId: r.offerId, buyQuantity: r.buyQuantity, zoneId: 1, success: function (o) {
              var i = { order_sn: s.order_sn, pay_amount: s.pay_amount, openid: e.openid, identify: t._identify },
                  d = sha1(i, t._secret);console_log("支付成功", o), wx.request({ url: a + "/hmwxgame", method: "POST", header: { "content-type": "application/x-www-form-urlencoded" }, data: { order_sn: s.order_sn, pay_amount: s.pay_amount, openid: e.openid, identify: t._identify, scale: r.scale, sign: d }, success: function (e) {
              ...
              console_log("支付失败", o, 1, a), falseReturn.result = o, n(falseReturn);var i = { order_sn: s.order_sn, pay_amount: s.pay_amount, openid: e.openid, identify: t._identify },
                  d = sha1(i, t._secret);wx.request({ url: a + "/fail", method: "POST", header: { "content-type": "application/x-www-form-urlencoded" }, data: { order_sn: s.order_sn, pay_amount: s.pay_amount, openid: e.openid, identify: t._identify, scale: r.scale, sign: d }, success: function (e) {
                  "SUCCESS" == e.data ? (falseReturn.err_msg = "支付成功", n(falseReturn)) : (falseReturn.err_msg = "支付失败", n(falseReturn));
                }, fail: function (e) {
                  falseReturn.err_msg = "支付失败", n(falseReturn);
                } });
            }, complete: function (e) {
              console_log("支付结束", e, 1, a);
            } });
        }
      } });
  }, shanwan_pay: function (e, n) {
    var t = { _identify: hd_config.pro.identify, _gameAppid: hd_config.pro.appid, _secret: hd_config.pro.secret_key, channel_id: hd_config.pro.channel_id, sub_channel_id: hd_config.pro.sub_channel_id },
        o = "https://cps.fjbgwl.com/api";wx.request({ url: o + "/get_ios_info", data: { system: _system, client_id: t._gameAppid }, method: "post", header: { "content-type": "application/x-www-form-urlencoded" }, success: function (a) {
        shanwan_envVersion = a.data.data.envVersion, shanwan_appid = a.data.data.appid, shanwan_path = a.data.data.path, is_open = a.data.data.is_open, console_log("ios信息", a, 1, o), wx.navigateToMiniProgram({ appId: shanwan_appid, path: shanwan_path, extraData: { identify: t._identify, client_id: t._gameAppid, extra_info: e.extra_info, goods_count: e.goods_count, goods_des: e.goods_des, goods_identifier: e.goods_identifier, goods_name: e.goods_name, pay_amount: e.pay_amount, openid: e.openid, redirect_uri: e.redirect_uri, role_id: e.role_id, role_name: e.role_name, server_id: e.server_id, server_name: e.server_name, channel_id: t.channel_id, sub_channel_id: t.sub_channel_id, order_sn: e.order_sn, type: "to_pay" }, envVersion: shanwan_envVersion, success: function (e) {
    ...
    var t = { openid: e.openid, game_appid: _gameAppid, channel_id: channel_id, sub_channel_id: sub_channel_id, timing: e.timing, create_time: Math.floor(new Date().getTime() / 1e3) },
        ...
        console_log("timing result", e, 1), n(e.data);
      }, fail: function (e) {
        console_log("timing fail", e, 1);
      } });
    ...
    var t = e.template_id;return e.openid && t ? "[object Array]" != Object.prototype.toString.call(t) ? void console_log("template_id不是有效的数组") : t.length < 1 || t.length > 3 ? void console_log("template_id支持的消息个数为1~3") : wx.requestSubscribeMessage ? void wx.requestSubscribeMessage({ tmplIds: t, success: function (o) {
        console_log("subscribe success", o), wx.getSetting({ withSubscriptions: !0, success: function (a) {
            console_log("res.subscriptionsSetting", a.subscriptionsSetting);var i = { game_appid: _gameAppid, create_time: Math.floor(new Date().getTime() / 1e3), template_id: t.join(","), openid: e.openid, always: a.subscriptionsSetting.itemSettings && a.subscriptionsSetting.itemSettings[t[0]] ? 1 : 0, action: o[t[0]] },
                r = JSON.parse(JSON.stringify(i));i.sign = sha1(r, _secret), i.sign_type = _signType, console_log("subscribe 参数", i), wx.request({ url: _FyhdUrl + "/subscribe/index", data: i, method: "post", header: { "content-type": "application/x-www-form-urlencoded" }, complete: function (e) {
    ...
    var t = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "sha1",
        o = Fyhd.sdk_sort(e),
        a = "";for (var i in o) "sign" != i && (a += i + "=" + o[i] + "&");if (a = a.substring(0, a.length - 1), a = a.replace(/\s+/g, "") + n, "sha1" == t) var r = CryptoJS.SHA1(a);else var r = CryptoJS.MD5(a);var s = r.toString();return console_log("加密", "原串str:" + a + "\n 加密sign=" + s), s;
  }, sdk_sort: function (e) {
    var n = [];for (var t in e) n.push(t);n.sort();var o = [];for (var a in n) o[n[a]] = e[n[a]];return o;
