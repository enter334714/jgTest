import AKSDK from "../gggsdk/gggsdk.js";window.versions = { wxVersion: window.config.game_ver }, window.DEBUG = !1, window.PLATFORM = 1, window.ENV = 1, window.PACK = !0, window.WSS = !0, window.workerJsURL = "", window.PF_INFO = { base_cdn: "https://cdn-gz-jg.sh9130.com/weixin_0/", cdn: "https://cdn-gz-jg.sh9130.com/weixin_0/" }, PF_INFO.pay_infos = {}, PF_INFO.package = "0", PF_INFO.version = window.versions.wxVersion, PF_INFO.mac = "", PF_INFO.os = "1", PF_INFO.sdk_name = "9130", PF_INFO.apiurl = "https://api-tjqytest.shzbkj.com", PF_INFO.logurl = "https://log-tjqytest.shzbkj.com", PF_INFO.payurl = "https://pay-tjqytest.shzbkj.com", PF_INFO.apikey = "MQx0mYlUWO5XYKvgAIPKWgK1w722GKih", PF_INFO.partnerId = "1", PF_INFO.pkgName = "", PF_INFO.device_id = "", PF_INFO.from_scene = 0, PF_INFO.serverList = {}, PF_INFO.channelNum = parseInt(PF_INFO.partnerId), PF_INFO.channel = PF_INFO.partnerId, PF_INFO.selectedServer = {}, PF_INFO.clientlog = "https://jgcenter.sh9130.com/clientlog/", PF_INFO.showLogo = !1, PF_INFO.debugUsers = "39927500|58163716|74597555", PF_INFO.tick = Date.now(), PF_INFO.configType = "_weixin", PF_INFO.exposeType = "_a", PF_INFO.loadingType = 2, PF_INFO.lastVersion = 1985, PF_INFO.wxVersion = window.versions.wxVersion, PF_INFO.wxShield = !1, PF_INFO.wxIOS = !1, PF_INFO.wxAndroid = !1, PF_INFO.wxPC = !1, window.apiRetryAmount = 5, window.isCheckBan = !1, window.loadProbPkg = !1, window.loadMainPkg = !1, window.loadServerRes = !1, window.loadLoadingRes = !1, window.loadVersion = !1, window.loadOption = !1, window.loadServer = !1, window.bEnterGame = !1, window.sdk_info = {}, window.alert = function (e) {
  ...
  sendApi(PF_INFO.apiurl, "User.getCdnVersion", { game_pkg: PF_INFO.pkgName, version_name: PF_INFO.version_name }, function (e) {
    e ? "success" == e.state ? e.data && e.data.version ? (PF_INFO.base_cdn = e.data.cdn_url && e.data.cdn_url.length ? e.data.cdn_url : PF_INFO.base_cdn, PF_INFO.cdn = e.data.cdn_url && e.data.cdn_url.length ? e.data.cdn_url : PF_INFO.cdn, PF_INFO.lastVersion = e.data.version || PF_INFO.lastVersion, console.info("\u8d44\u6e90\u7248\u672c\u53f7\uff1a" + PF_INFO.lastVersion), window.loadVersion = !0, window.initMain(), window.enterToGame()) : window.loginAlert("User.getCdnVersion failed: version=" + (e.data && e.data.version)) : window.loginAlert("User.getCdnVersion failed: state=" + e.state) : window.loginAlert("User.getCdnVersion failed");
  });
  ...
  PF_INFO.roleId = e, PF_INFO.roleName = n, PF_INFO.roleLevel = o, AKSDK.logEnterGame(PF_INFO.selectedServer.server_id, PF_INFO.selectedServer.server_name || PF_INFO.selectedServer.server_id, e, n, o, t, { rolepower: a }), sendApi(PF_INFO.apiurl, "User.update_role", { game_pkg: PF_INFO.pkgName, server_id: PF_INFO.selectedServer.server_id, role_id: e, uid: PF_INFO.account, role_name: n, role_type: i, level: o, evolution: r });
  ...
  var n;"success" === e.state && e.data ? ((n = PF_INFO.selectedServer).channel_num = PF_INFO.channelNum, n.sign = String(e.data.login_sign), n.tick = parseInt(e.data.time), e.data.server_num ? n.server_num = parseInt(e.data.server_num) : n.server_num = parseInt(e.data.server_id), n.is_domain = 0, n.cdn = PF_INFO.base_cdn, n.resver = e.data.cdn_version, n.server_options = e.data.server_options, console.log("server_options\uff1a" + JSON.stringify(n.server_options)), 1 == PF_INFO.newRegister && n.server_options && 1 == n.server_options.show_btn && (PF_INFO.showGetBtn = 1, window.ServerLoading.instance.setShowBtn()), checkBanSuccess()) : sendApi(PF_INFO.apiurl, "User.login", { platform: PF_INFO.sdk_name, partner_id: PF_INFO.partnerId, token: PF_INFO.sdk_token, game_pkg: PF_INFO.pkgName, deviceId: PF_INFO.device_id, scene: "WX_" + PF_INFO.from_scene }, function (e) {
