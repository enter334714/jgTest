var z1 = wx.Z$;
import 's8b15a/funjp.js';console.info("1 \u521d\u59cb\u5316");
...
var image = new Image();
image.src = "wxlogin_atlas/al.png";
...
render();
window._sDW5OQ = setInterval(function () {
  render();
}, 16);
wx.showLoading({ title: "\u6b63\u5728\u52a0\u8f7d" });
wx.y$ = [];var fs = wx.getFileSystemManager();wx.getFileSystemManager().unzip({
  zipFilePath: "/sytn/su3cq.zip", targetPath: wx.env.USER_DATA_PATH + "/f/", success: r => {
...
wx.onShow(function (res) {
  window._sQW = res;
  if (window._sOWQ && window._sQW) {
    console.info("小游戏切前台事件，场景值：" + window._sQW.scene);
    window._sOWQ(window._sQW);
    window._sQW = null;
  }
});