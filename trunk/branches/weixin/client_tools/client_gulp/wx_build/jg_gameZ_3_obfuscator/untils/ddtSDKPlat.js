...
!function (t) {
  ...
  var o, r, a, i, s;o = n(2), r = n(1).utf8, a = n(3), i = n(1).bin, (s = function (t, e) {
    ...
    if (null == t) throw new Error("Illegal argument " + t);return t = o.wordsToBytes(s(t, e)), e && e.asBytes ? t : e && e.asString ? i.bytesToString(t) : o.bytesToHex(t);
  };
}, function (t, e) {
  ...
  var n, o;n = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", o = { rotl: function (t, e) {
      ...
      for (var e = [], o = 0; o < t.length; o += 3) for (var r = t[o] << 16 | t[o + 1] << 8 | t[o + 2], a = 0; a < 4; a++) 8 * o + 6 * a <= 8 * t.length ? e.push(n.charAt(r >>> 6 * (3 - a) & 63)) : e.push("=");return e.join("");
  ...
  var o, r, a;n.r(e), (e = o = o || {})[e.WXMG = 1e3] = "WXMG", e[e.OPPO = 1001] = "OPPO", e[e.VIVO = 1002] = "VIVO", (e = {})[e.TEST = 0] = "TEST", e[e.DEV = 1] = "DEV", e[e.ONLINE = 2] = "ONLINE", (e = r = r || {}).createRole = "createRole", e.upRoleLevel = "upRoleLevel", e.enterGame = "enterGame", e.enterServer = "enterServer", (e = a = a || {}).INIT_SUCCESS = "init_success", e.INIT_FAIL = "init_fail", e.LOGIN_SUCCESS = "login_success", e.LOGIN_FAIL = "login_fail", e.PAY_SUCCESS = "pay_success", e.PAY_FAIL = "pay_fail", e.PAY_CANCEL = "pay_cancel", e.PAY_TYPE = "pay_type", e.CHECK_INFO = "check_info";var i = (s.track_url = "https://api.mengxuanwl.com/Api/MiniGame/sdkTrack", s.sdk_base_url = "https://api.mengxuanwl.com", s.sdk_config_url = "/Api/MiniGame/init", s.sdk_device_url = "", s.data_up_url = "", s.gameToken = "", s.login_url = "", s.place_order_url = "", s.reply_order_url = "", s.checkExtInfo_url = "", s.plat_extend_info = [], s.userInfo = {}, s.curApiParams = {}, s.platExtInfo = {}, s.switchZFlag = !1, s.system = "", s);function s() {}var l = (Object.defineProperty(c, "inst", { get: function () {
    ...
    var r = null;r = (o = void 0 !== o && o) ? { time: Math.round(Date.now() / 1e3), stamp: i.curFlag } : { gameToken: i.gameToken, time: Math.round(Date.now() / 1e3) }, r = Object.assign({}, i.initOps, e, r);i.curApiParams = r;r = u.objKeySort(r), r = u.procRequestParams(r), r = (r = decodeURIComponent(r)) + "&sign=" + d()(r);var a = new XMLHttpRequest(),
        s = u.isHasVer("jzxjz");s && (a.responseType = "text"), a.open("POST", t, !0), a.setRequestHeader("Content-Type", "application/x-www-form-urlencoded;"), a.onreadystatechange = function () {
      4 != a.readyState || 200 != a.status && 304 != a.status || (s ? n.call(this, a.response) : n.call(this, JSON.parse(a.responseText)));
    }, a.send(r);
    ...
    var t = this;f.postData(i.track_url, { flag: "开始初始化sdk" }, function () {}, !0);var e = { device: u.judgeClient() };f.postData(i.sdk_base_url + i.sdk_config_url, e, function (e) {
      if (!e.result) return l.inst.error("ddtSDKPlat ====== 获取配置信息失败", e), i.callback(a.INIT_FAIL, "初始化失败"), void f.postData(i.track_url, { url: i.sdk_base_url + i.sdk_config_url, data: JSON.stringify(i.curApiParams), msg: JSON.stringify(e), flag: "初始化接口失败" }, function () {}, !0);l.inst.log("ddtSDKPlat ====== 获取配置信息成功", e), f.postData(i.track_url, { url: i.sdk_base_url + i.sdk_config_url, data: JSON.stringify(i.curApiParams), msg: JSON.stringify(e), flag: "初始化接口成功" }, function () {}, !0), e = e.data, i.data_up_url = e.dataUpUrl, i.gameToken = e.gameToken, i.login_url = e.loginUrl, i.place_order_url = e.placeOrderUrl, i.reply_order_url = e.replyOrderUrl, i.sdk_device_url = e.deviceUrl, i.plat_extend_info = e.platExtInfo, i.switchZFlag = e.is_change, i.checkExtInfo_url = e.checkExtInfo, i.callback(a.PAY_TYPE, e.is_change), i.callback(a.INIT_SUCCESS, "初始化成功"), t.login();
    });
  }, h.prototype.login = function () {
    var t = this;f.postData(i.track_url, { flag: "开始加载登录接口" }, function () {}, !0), f.postData(i.login_url, i.platExtInfo, function (e) {
      if (!e.result) return l.inst.error("ddtSDKPlat ====== 查询登录失败", e), i.callback(a.LOGIN_FAIL, "登录失败"), void f.postData(i.track_url, { url: i.login_url, data: JSON.stringify(i.curApiParams), msg: JSON.stringify(e), flag: "登录接口失败" }, function () {}, !0);l.inst.log("ddtSDKPlat ====== 查询登录成功", e), i.userInfo = e.data, f.postData(i.track_url, { url: i.login_url, data: JSON.stringify(i.curApiParams), msg: JSON.stringify(e), flag: "登录接口成功" }, function () {}, !0), e = e.data, i.uid = e.uid, i.gameToken = e.gameToken, i.ddtPlatExtInfo = e.ddtPlatExtInfo, e = { uid: e.uid, gameToken: e.gameToken, time: e.time, sign: e.sign }, i.callback(a.LOGIN_SUCCESS, e), t.checkExtInfo();
    });
  }, h.prototype.submitData = function (t, e) {
    e = y({ sceneId: t, uid: i.uid }, e), f.postData(i.data_up_url, e, function (e) {
      e.result ? l.inst.log("ddtSDKPlat ====== 数据上报成功，类型：" + t, e) : l.inst.error("ddtSDKPlat ====== 数据上报失败，类型：" + t, e);
    });
  }, h.prototype.createOrder = function (t) {
    var e = this;t = y(y(y({ uid: i.uid }, t), i.platExtInfo), { device: u.judgeClient() });f.postData(i.place_order_url, t, function (t) {
      return t.result ? (l.inst.log("ddtSDKPlat ====== 预下单成功", t), i.ddtPlatPayInfo = t.data, void e.pay()) : (l.inst.error("ddtSDKPlat ====== 预下单失败", t), void (1e3 === i.initOps.platId && wx.showToast({ title: t.data.msg, icon: "none" })));
    });
    ...
    f.postData(i.checkExtInfo_url, { uid: i.uid, device: u.judgeClient() }, function (t) {
      t.result ? (l.inst.log("ddtSDKPlat ====== 获取扩展信息成功"), i.callback(a.CHECK_INFO, t.data)) : l.inst.error("ddtSDKPlat ====== 获取扩展信息错误");
    });
  }, n = h;function h() {}var m,
      _,
      S = ((m = function (t, e) {
  ...
  })(P, _ = n), P.prototype.createSole = function () {
    var t = i.initOps.gameId.toString(),
        e = i.initOps.channelVer.toString();this.soleKey = d()(t + e + this.RANDOM_STR);
  }, P.prototype.getADParams = function () {
    var t = wx.getLaunchOptionsSync();wx.onShow(function (e) {
      t = e;
    });var e = (o = t.query).adver,
        n = o.gdt_vid,
        o = o.weixinadinfo;e ? (this.adver = e, wx.setStorageSync(this.soleKey, e)) : this.adver = wx.getStorageSync(this.soleKey) || "", this.gdt_vid = n, this.weixinadinfo = o, o = { gdt_vid: this.gdt_vid, weixinadinfo: this.weixinadinfo, adver: this.adver }, Object.assign(i.platExtInfo, o);
    ...
    _.prototype.pay.call(this), "ios" === u.judgeClient() && i.switchZFlag ? this.otherPay() : this.platPay();
    ...
    var t = this;wx.requestMidasPayment({ mode: "game", env: i.ddtPlatPayInfo.env, offerId: i.ddtPlatPayInfo.offer, platform: "android", currencyType: "CNY", buyQuantity: i.ddtPlatPayInfo.count, zoneId: "1", success: function () {
        i.callback(a.PAY_SUCCESS, "支付成功");var e = i.ddtPlatPayInfo.orderId;t.replyOrder(e);
      }, fail: function (t) {
        l.inst.log("ddtSDKPlat ===== wx支付失败", t), i.callback(a.PAY_FAIL, "支付失败");
      } });
  }, P.prototype.getWxSystemInfo = function () {
    wx.getSystemInfo({ success: function (t) {
        t = { channelVer: i.initOps.channelVer, platId: i.initOps.platId, gameId: i.initOps.gameId, mode: t.model, brand: t.brand, language: t.language, platform: t.platform, system: t.system, version: t.version }, f.postData(i.sdk_device_url, t, function (t) {
    ...
    var t = this;wx.login({ success: function (e) {
        var n = { code: e.code };Object.assign(i.platExtInfo, n), l.inst.log("ddtSDKPlat ==== 微信授权登录成功", e), _.prototype.login.call(t);
      }, fail: function (t) {
        l.inst.log("ddtSDKPlat ==== 微信授权登录失败", t);
      } });
  }, P.prototype.replyOrder = function (t) {
    var e = this,
        n = { channelVer: i.initOps.channelVer, platId: i.initOps.platId, gameId: i.initOps.gameId, uid: i.uid, orderId: t, session: i.ddtPlatExtInfo.session, gameToken: i.gameToken },
        o = u.objKeySort(n);o = u.procRequestParams(o), o = decodeURIComponent(o);n.sign = d()(o), wx.request({ url: i.reply_order_url, data: n, method: "POST", header: { "Content-Type": "application/x-www-form-urlencoded;" }, success: function (n) {
    ...
    return (O = Object.assign || function (t) {
      ...
      b = (e(w, v = n), w.prototype.init = function () {
    ...
    t = O(O({}, t), { token: this.login_token, appVersion: i.gameVersion, engineVersion: this.engineVersion }), v.prototype.createOrder.call(this, t);
    ...
    qg.pay({ appId: i.ddtPlatPayInfo.appId, token: this.login_token, timestamp: i.ddtPlatPayInfo.timestamp, paySign: i.ddtPlatPayInfo.paySign, orderNo: i.ddtPlatPayInfo.orderId, success: function (t) {
        i.callback(a.PAY_SUCCESS, "支付成功"), l.inst.log("ddtSDKPlat ===== oppo支付成功", t);
      }, fail: function (t) {
        l.inst.error("ddtSDKPlat ===== oppo支付失败", t), i.callback(a.PAY_FAIL, "支付失败");
      } });
  }, w.prototype._getSystemInfo = function () {
    var t,
        e = qg.getSystemInfoSync();e && (t = { channelVer: i.initOps.channelVer, platId: i.initOps.platId, gameId: i.initOps.gameId, version: e.COREVersion, brand: e.brand, model: e.model, language: e.language, platform: e.platform, platformVersion: e.platformVersion, system: e.system }, this.engineVersion = e.platformVersion, f.postData(i.sdk_device_url, t, function (t) {
      t.result ? l.inst.log("ddtSDKPlat ====== 设备收集上报成功", t) : l.inst.error("ddtSDKPlat ====== 设备收集上报失败", t);
    }));
  }, w.prototype.loginAuth = function () {
    var t = this,
        e = this;qg.login({ success: function (n) {
        var o = n.data ? n.data.token : "unkown";i.platExtInfo = { token: o, pkgName: i.pkgName }, e.login_token = o, l.inst.log("ddtSDKPlat ==== oppo登录成功", n), v.prototype.login.call(t);
      }, fail: function (t) {
    ...
    switch (t) {case r.createRole:
        i.mPlat.submitData(r.createRole, e);break;case r.upRoleLevel:
        i.mPlat.submitData(r.upRoleLevel, e);break;case r.enterGame:
        i.mPlat.submitData(r.enterGame, e);break;case r.enterServer:
        i.mPlat.submitData(r.enterServer, e);break;default:
        l.inst.log("ddtSDKPlat ===== 没有该数据上报类型", t);}
  }, T);function T() {}function A() {
    this._version = "1.1.9";
  }A.prototype.init = function (t, e, n) {
    void 0 === n && (n = !1), i.curFlag = d()(t.gameId + t.channelVer + Math.round(Date.now() / 1e3)), i.initOps = t, i.callback = e, i.pkgName = t.pkgName, i.gameVersion = t.gameVersion, l.inst.init(n), i.mPlat = V.dispatchPlatform(t.platId), i.mPlat.init();
    ...
    var t = i.curApiParams;console.log(t);var e,
        ...
        o = {};for (e in t) for (var r in n) e == r && (o[r] = t[r]);var a = u.objKeySort(o);a = u.procRequestParams(a), a = (a = decodeURIComponent(a)) + "&sign=" + d()(a);wx.openCustomerServiceConversation({ sendMessagePath: a, sessionFrom: "turngame", showMessageCard: !0 });
