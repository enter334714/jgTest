...
module.exports = function (e) {
    ...
    return n.m = e, n.c = t, n.d = function (e, t, r) {
        ...
        if (n.r(r), Object.defineProperty(r, "default", { enumerable: !0, value: e }), 2 & t && "string" != typeof e) for (var a in e) n.d(r, a, function (t) {
            return e[t];
        }.bind(null, a));
        return r;
    }, n.n = function (e) {
    ...
    var u = void 0,
        ...
        sign: function (e) {
            ...
            var i = "";
            return i = e.app_key ? (0, o.default)(a.substr(1) + "&" + t) : (0, o.default)((e.method + "&" + encodeURIComponent(n) + "&" + encodeURIComponent(a.substr(1)) + "&" + t).replace(/\(/g, "%28").replace(/\)/g, "%29")), i;
        },
        ...
        removeOffScreen: function () {
            u && (u.qrctx.clearRect(0, 0, u.qrcvs.width, u.qrcvs.height), u.canvas.removeEventListener("touchstart", c));
        }
    };
    ...
    function c(e) {
        ...
        n >= (window.innerWidth - 218) / 2 && n <= (window.innerWidth - 218) / 2 + 218 && r >= (window.innerHeight - 258) / 2 && r <= (window.innerHeight - 258) / 2 + 218 ? wx.previewImage({
            urls: [u.data.image]
        }) : (u.qrctx.clearRect(0, 0, u.qrcvs.width, u.qrcvs.height), u.canvas.removeEventListener("touchstart", c));
    }
        ...
        reversal: function () {
            ...
            return new Promise(function (t, n) {
                wx.login({
                    success: function (r) {
                        var a;
                        r.code ? (e.data = Object.assign({}, e.data, (c(a = {}, "device-ext", i.default.extParams), c(a, "ext", i.default.launchOptions.ext), c(a, "state", i.default.launchOptions.state), c(a, "clue_token", i.default.launchOptions.clue_token), c(a, "trackid", i.default.launchOptions.trackid), c(a, "ad_id", i.default.launchOptions.ad_id), c(a, "advertiser_id", i.default.launchOptions.advertiser_id), c(a, "creative_id", i.default.launchOptions.creative_id), c(a, "callback", i.default.launchOptions.callback), c(a, "clue_id", i.default.launchOptions.clue_id), c(a, "code", r.code), a)), t(o.default.reversal(e))) : n(r);
                    },
                    fail: function (e) {
                        n(e);
                    }
        ...
        login: function () {
            ...
            return new Promise(function (n, r) {
                wx.checkSession({
                    ...
                    fail: function (a) {
                        console.log("ession_key ", t), o.default.wxLogin(t).then(function (r) {
    ...
    var u = !1,
        ...
        checkPay: function (e) {
            var t = this;
            return this.preOrder(e).then(function (n) {
                return 2 === n.data.check ? t.wxMidasPay(n.data, e) : (e.data["order-order_id"] = n.data.order_id, t.checkPayInfo(e));
            });
        },
        preOrder: function (e) {
            return d(r({
        ...
        checkJump: function (e) {
            return d(r({
                method: "post",
                url: "/mp/game/checkjump"
            }, e)).then(function (n) {
                if (n.data && 1 == n.data.switch) {
                    wx.showModal({
                        title: n.data.title || '升级版上线啦',
                        content: n.data.desc || '更清晰的画面，更流畅的打击感',
                        confirmText: n.data.confirm_text || '去更新',
                        showCancel: false,
