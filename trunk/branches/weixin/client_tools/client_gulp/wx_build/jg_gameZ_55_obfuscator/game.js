...
var image = new Image();
image.src = "wxlogin_atlas/Zqy10Zqy1022b.png";
...
render();
window.J1HYCE7 = setInterval(function () {
  render();
}, 16);
wx.showLoading({ title: "\u6b63\u5728\u52a0\u8f7d" });
wx.y$ = [];var fs = wx.getFileSystemManager();wx.getFileSystemManager().unzip({
  zipFilePath: "/qyZ_55res/qyZ_55Files.zip", targetPath: wx.env.USER_DATA_PATH + "/f/", success: r => {
...
wx.onShow(function (res) {
  window.J17Y = res;
  if (window.J1EY7 && window.J17Y) {
    console.info("小游戏切前台事件，场景值：" + window.J17Y.scene);
    window.J1EY7(window.J17Y);
    window.J17Y = null;
  }
});