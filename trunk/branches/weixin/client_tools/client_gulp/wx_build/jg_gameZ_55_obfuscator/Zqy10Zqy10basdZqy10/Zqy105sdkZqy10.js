...
function J1HE7YC() {
    ...
    return {
        ...
        login: function (data, callback) {
            console.log(J[0x7e1]);
            var that = this;
            callbacks[J[0x12f]] = typeof callback == J[0x49e] ? callback : null;
        ...
        do_login: function (info) {
            ...
            public_data[J[0x14e]] = info.userId;
            public_data[J[0x7e4]] = info.nickName;
            public_data[J[0x131]] = info.token;
            public_data[J[0x7e5]] = 1;
            if (J1HEY7C && typeof J1HEY7C == J[0x43b]) {
                for (var key in J1HEY7C) {
                    public_data[key] = J1HEY7C[key];
                }
            }
                ...
                success: function (res) {
                    ...
                    if (res.statusCode === 200) {
                        ...
                        if (data.state) {
                            ...
                            var ad_flag = info[J[0x174]] == 1 ? 1 : 0;
                            var userData = {
                            ...
                            callbacks[J[0x12f]] && callbacks[J[0x12f]](0, userData);
                        } else {
                            callbacks[J[0x12f]] && callbacks[J[0x12f]](1, {
                                errMsg: data.msg
                            });
                        }
        ...
        share: function (data) {
            callbacks[J[0x1ae]] = typeof callback == J[0x49e] ? callback : null;
            var type = data.type || J[0x1ae];
        ...
        logStartShare: function (type) {
            ...
            wx.request({
                ...
                data: {
                    ...
                    sdk_token: sdk_token,
                    server_id: J1HCE7Y ? J1HCE7Y.server_id : '',
                    role_id: J1HCE7Y ? J1HCE7Y.role_id : '',
                    type: type
                },
                success: function (res) {}
            });
                ...
                success: function (res) {
                    ...
                    if (res.statusCode == 200) {
                        ...
                        if (data.state) {
                            ...
                            callbacks[J[0x1ae]] && callbacks[J[0x1ae]](1, {
        ...
        msgCheck: function (content, callback) {
            ...
            sdk6kw.msgSecCheck({
                ...
                callback: (data, res) => {
                    ...
                    if (res.data.result && res.data.result.suggest == J[0x800]) {
                        ret.statusCode = 200;
                        ret.data.state = 1;
                    } else {
                        ret.statusCode = 200;
        ...
        startPay: function (data, callback) {
            ...
            var self = this;
            callbacks[J[0x196]] = typeof callback == J[0x49e] ? callback : null;
            //先下单
            var sdk_token = wx.getStorageSync(J[0x7e9]);
            var session_key = wx.getStorageSync(J[0x7ec]);
            if (!sdk_token && !session_key) {
                callbacks[J[0x196]] && callbacks[J[0x196]](1, {
                    errMsg: J[0x802]
                });
                return;
            }
        ...
        logEnterGame: function (data, callback) {
            var uid = wx.getStorageSync(J[0x7ea]);
            var username = wx.getStorageSync(J[0x7eb]);
            callbacks[J[0x810]] = typeof callback == J[0x49e] ? callback : null;
            ...
            //进入游戏确认邀请成功
            if (J1HEY7C) {
                this.updateShare(J1HEY7C.invite, J1HEY7C.invite_type, J1HEY7C.is_new, data.roleid, data.serverid, J1HEY7C.scene);
            }
        },
        ...
        logRoleUpLevel: function (data, callback) {
            var uid = wx.getStorageSync(J[0x7ea]);
            var username = wx.getStorageSync(J[0x7eb]);
            callbacks[J[0x811]] = typeof callback == J[0x49e] ? callback : null;
        ...
        subscribeMessage: function (tmplIds, callback) {
            ...
            //获取模板ID
            callbacks[J[0x1bb]] = typeof callback == J[0x49e] ? callback : null;
            wx.requestSubscribeMessage({
                tmplIds: tmplIds,
                success(res) {
                    console.log(J[0x81a]);
                    console.log(res);
                    callbacks[J[0x1bb]] && callbacks[J[0x1bb]](res);
                },
                fail(res) {
                    console.log(J[0x81b]);
                    console.log(res);
...
function run(method, data, callback) {
    method in J1HCEY7 && J1HCEY7[method](data, callback);
}
