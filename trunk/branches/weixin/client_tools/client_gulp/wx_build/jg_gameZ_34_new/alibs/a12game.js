...
wx.onError(function (error) {
  if (error) {
    if (error.message) {
      ...
      var arr = message.match(/(a2a3a1\/a12game.js:)[0-9]{1,60}(:)/g);
      if (arr) {
        for (var i = 0; i < arr.length; i++) {
          //行数减2
          if (arr[i] && arr[i].length > 0) {
            var line = parseInt(arr[i].replace("a2a3a1/a12game.js:", "").replace(":", ""));
            message = message.replace(arr[i], arr[i].replace(":" + line + ":", ":" + (line - 2) + ":"));
          }
        }
      }
      message = message.replace(new RegExp("a2a3a1/a12game.js", "g"), "a2a3a1/main__" + gamever + ".min.js");
      message = message.replace(new RegExp("a2a3a1/amain.js", "g"), "a2a3a1/main__" + gamever + ".min.js");
...
import "a1md5min.js";
import "ea1zlibs.js";
window["Parser"] = require("a1domparser.js");
import "a1index.js";
import "a1ibsmin.js";
import "a1wxmini.js";
import "a1initmin.js";
