...
window.boot = function () {
  ...
  var onStart = function onStart() {
    ...
    cc.director.loadScene(launchScene, null, function () {
      ...
      console.log(H[3079] + launchScene);
    });
  }; // jsList


  var jsList = settings.jsList;
  var bundledScript = settings.debug ? H[3080] : H[3081];
