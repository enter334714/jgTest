...
var config = {
    game_id: 256,
    game_pkg: 'tjqy_tjqyyssm_OH', //热游-曜石神魔录
    partner_label: 'reyouxyx',
    partner_id: '544',
    game_ver: '43.0.1',
    is_auth: false, //授权登录
    partner_game_id:"176",
    ...
    return {
        ...
        login: function (data,callback) {
            ...
            dfSDK.login(function (result) {
                ...
                if (result.status == 1) {//登录成功
                    console.log("user_name:" + result.data.user_name);
                    console.log("user_id:" + result.data.user_id);
                    console.log("open_id：" + result.data.open_id);
                        ...
                        if (data.state) {
                            if(data.data.ext == ''){
                                dfSDK.pay(data.data.pay_data, function (result) {
                                    //请求回调结果
                                    console.log("渠道下单"+JSON.stringify(result));
                                  });
                            }else{
        ...
        logCreateRole: function (data) {
            ...
            dfSDK.submitData({
                ...
                console.log("创角上报结果"+JSON.stringify(result));
            });
        },
        ...
        logEnterGame: function (data) {
            ...
            dfSDK.submitData({
                ...
                console.log("进入游戏上报结果"+JSON.stringify(result));
            });
        },
        ...
        logRoleUpLevel: function (data) {
            ...
            dfSDK.submitData({
                ...
                console.log("角色升级上报结果"+JSON.stringify(result));
            });
        },
