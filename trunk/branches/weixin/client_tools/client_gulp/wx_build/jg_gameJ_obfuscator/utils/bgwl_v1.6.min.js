...
function console_log(e, n, t, o) {
  ...
  var n = [];n.push({ key: e.key, value: e.val }), $j$H14V(wx.getSystemInfoSync().SDKVersion, "1.9.92") >= 0 && wx.setUserCloudStorage({ KVDataList: n, success: function (e) {
  ...
  $j$H14V(wx.getSystemInfoSync().SDKVersion, "2.0.6") >= 0 ? (userinfoBtn = wx.createUserInfoButton({ type: "image", image: e.imageUrl, lang: "zh_CN", style: { left: e.left, top: e.top, width: e.width, height: e.height } }), userinfoBtn.onTap(function (t) {
