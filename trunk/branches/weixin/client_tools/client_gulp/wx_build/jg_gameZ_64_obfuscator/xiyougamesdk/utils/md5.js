...
function hex_md5(n) {
  ...
  return d ^ (n | ~r);
}function FF(n, d, r, e, t, o, i) {
  return n = AddUnsigned(n, AddUnsigned(AddUnsigned(F(d, r, e), t), i)), AddUnsigned(RotateLeft(n, o), d);
}function GG(n, d, r, e, t, o, i) {
  return n = AddUnsigned(n, AddUnsigned(AddUnsigned(G(d, r, e), t), i)), AddUnsigned(RotateLeft(n, o), d);
}function HH(n, d, r, e, t, o, i) {
  return n = AddUnsigned(n, AddUnsigned(AddUnsigned(H(d, r, e), t), i)), AddUnsigned(RotateLeft(n, o), d);
}function II(n, d, r, e, t, o, i) {
  return n = AddUnsigned(n, AddUnsigned(AddUnsigned(I(d, r, e), t), i)), AddUnsigned(RotateLeft(n, o), d);
}function ConvertToWordArray(n) {
  for (var d, r = n.length, e = r + 8, e = 16 * (1 + (e - e % 64) / 64), t = Array(e - 1), o = 0, i = 0; i < r;) o = i % 4 * 8, t[d = (i - i % 4) / 4] = t[d] | n.charCodeAt(i) << o, i++;return t[d = (i - i % 4) / 4] = t[d] | 128 << (o = i % 4 * 8), t[e - 2] = r << 3, t[e - 1] = r >>> 29, t;
}function WordToHex(n) {
  for (var d = "", r = "", e = 0; e <= 3; e++) d += (r = "0" + (n >>> 8 * e & 255).toString(16)).substr(r.length - 2, 2);return d;
}function Utf8Encode(n) {
  for (var d = "", r = 0; r < n.length; r++) {
    var e = n.charCodeAt(r);e < 128 ? d += String.fromCharCode(e) : d = 127 < e && e < 2048 ? (d += String.fromCharCode(e >> 6 | 192)) + String.fromCharCode(63 & e | 128) : (d = (d += String.fromCharCode(e >> 12 | 224)) + String.fromCharCode(e >> 6 & 63 | 128)) + String.fromCharCode(63 & e | 128);
  }return d;
