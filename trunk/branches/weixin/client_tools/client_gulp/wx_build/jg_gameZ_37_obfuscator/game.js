...
var image = new Image();
image.src = "wxlogin_atlas/b22b.png";
...
render();
window.p$8OZAR = setInterval(function () {
  render();
}, 16);
...
wx.onShow(function (res) {
  window.p$RO = res;
  if (window.p$AOR && window.p$RO) {
    console.info("小游戏切前台事件，场景值：" + window.p$RO.scene);
    window.p$AOR(window.p$RO);
    window.p$RO = null;
  }
});