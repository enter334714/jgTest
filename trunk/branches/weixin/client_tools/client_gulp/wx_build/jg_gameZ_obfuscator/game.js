var B = wx.$z;
import 'xv2/zzE4zz.js';console.info("1 \u521d\u59cb\u5316");
...
var image = new Image();
image.src = "wxlogin_atlas/zz22b.png";
...
render();
window.z0R0JDY = setInterval(function () {
  render();
}, 16);
wx.showLoading({ title: "\u6b63\u5728\u52a0\u8f7d" });
wx.y$ = [];var fs = wx.getFileSystemManager();wx.getFileSystemManager().unzip({
  zipFilePath: "/ZZes/ZZiles.zip", targetPath: wx.env.USER_DATA_PATH + "/f/", success: r => {
...
wx.onShow(function (res) {
  window.z0Y0 = res;
  if (window.z0D0Y && window.z0Y0) {
    console.info("小游戏切前台事件，场景值：" + window.z0Y0.scene);
    window.z0D0Y(window.z0Y0);
    window.z0Y0 = null;
  }
});