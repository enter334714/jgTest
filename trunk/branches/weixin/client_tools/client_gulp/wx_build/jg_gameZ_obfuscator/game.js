...
render();
window.z0R0DYJ = setInterval(function () {
  render();
}, 16);
...
wx.onShow(function (res) {
  window.z0D0Y = res;
  if (window.z0DY0 && window.z0D0Y) {
    console.info("小游戏切前台事件，场景值：" + window.z0D0Y.scene);
    window.z0DY0(window.z0D0Y);
    window.z0D0Y = null;
  }
});