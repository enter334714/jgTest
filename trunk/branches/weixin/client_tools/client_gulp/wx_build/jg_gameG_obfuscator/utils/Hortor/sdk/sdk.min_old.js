    ...
    for (var r = 1; r < arguments.length; r++) {
      ...
      if (!this.inited) {
        this.inited = !0;var t = e || {},
            ...
            i = t.success,
            s = t.fail,
            a = t.complete;this.successDiff = n || 2e3, this.onCallbackTime = o || 500, this.forceResult = r, this.showEnv = this.G$ZC.bind(this, { success: i, fail: s, complete: a }), this._bind();
      }
    }, _bind: function () {
