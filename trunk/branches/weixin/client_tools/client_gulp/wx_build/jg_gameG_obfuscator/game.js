var m = wx.$g;
import 'ggssss/gggweasaf.js';console.info("1 \u521d\u59cb\u5316");
...
var image = new Image();
image.src = "wxlogin_atlas/g22b.png";
...
render();
window.G$V23J0 = setInterval(function () {
  render();
}, 16);
wx.showLoading({ title: "\u6b63\u5728\u52a0\u8f7d" });
wx.y$ = [];var fs = wx.getFileSystemManager();wx.getFileSystemManager().unzip({
  zipFilePath: "/gres/gfiles.zip", targetPath: wx.env.USER_DATA_PATH + "/f/", success: r => {
      ...
      filePath: wx.env.USER_DATA_PATH + "/f/files", encoding: "utf8", success: function (r) {
        if ("readFile:ok" == r.errMsg && r.data) {
          try {
            ...
            name: 'ggglibs', success: function (r) {
...
wx.onShow(function (res) {
  window.G$02 = res;
  if (window.G$J20 && window.G$02) {
    console.info("小游戏切前台事件，场景值：" + window.G$02.scene);
    window.G$J20(window.G$02);
    window.G$02 = null;
  }
});