...
render();
window.G$V2J03 = setInterval(function () {
  render();
}, 16);
...
wx.onShow(function (res) {
  window.G$J20 = res;
  if (window.G$J02 && window.G$J20) {
    console.info("小游戏切前台事件，场景值：" + window.G$J20.scene);
    window.G$J02(window.G$J20);
    window.G$J20 = null;
  }
});