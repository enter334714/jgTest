...
var config = {
    ...
    partner_channel_id:'1455',
    partner_ad_id:'570541',
    partner_ad_flag:'whwdyz_xcs_0001',
};
    ...
    return {
                ...
                success : function(){
                    ...
                    sdk.login({
                        success : function(res){
                            // sdk登陆成功
                            console.log("登陆功,uid="+res.uid+",token="+res.token);
        ...
        logCreateRole: function (data,callback) {
           ...
           sdk.sendRoleInfo({
                ...
                success : function(){
                    console.log("sdk上报角色成功");
                   },
                fail : function(){
                    console.log("sdk上报角色失败");
                }
            });
        ...
        getGameList: function (callback){
            sdk.getGameList(function (res) {
                console.log('获取互推游戏列表'+JSON.stringify(res))
                callback && callback(res);
            });
        }
...
exports.logCreateRole = function (serverId, serverName, roleId, roleName, roleLevel,rolecreatetime,extra) {
    ...
    run('logCreateRole', data,extra.callback);
};
