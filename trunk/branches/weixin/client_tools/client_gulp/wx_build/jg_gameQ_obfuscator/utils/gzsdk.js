...
export default class Gzsdk {
    constructor() {
        ...
        wx.onError(function (res) {
            ...
            onErrorNum = onErrorNum + 1;
            console.log('错误上报');
            wx.request({
                url: 'https://api.v2.guoziyx.com/report/Index/XyxBugLog',
                data: { 'error': res.message, 'errorNum': onErrorNum },
                method: 'POST',
                success(_res) {},
                fail(_res) {},
                complete(_res) {}
    ...
    serverRequest(_url, _data, _callback) {
        ...
        this.clog(_url);
        var that = this;
        _data['launchData'] = that.launchData;
        this.clog(_data);
        wx.request({
            url: _url,
            data: _data,
