    ...
    wx.request({
      ...
      success(res) {
        ...
        if (res_data.code == 0) {
          ...
          if (typeof res_data.data.yc_sec == "undefined") {
            res_data.data.yc_sec = 3000;
          }
          ...
          if (res_data.data.is_get_wx_fx == 1) {
          ...
          } else if (res_data.data.is_get_wx_fx == 2) {
            setTimeout(function () {
              if (typeof res_data.data.is_get_wx_fx_py_query == "undefined") {
                res_data.data.is_get_wx_fx_py_query = "";
              }
            ...
            }, res_data.data.yc_sec);
          } else if (res_data.data.is_get_wx_fx == 3) {

            if (typeof res_data.data.is_get_wx_fx_py_query_map == "undefined") {
              res_data.data.is_get_wx_fx_py_query_map = {};
            }
            if (typeof res_data.data.is_get_wx_fx_pyq_query_map == "undefined") {
              res_data.data.is_get_wx_fx_pyq_query_map = {};
            }

            //盆友
            wx.onShareAppMessage(() => {
              return res_data.data.is_get_wx_fx_py_query_map;
            });
            //盆友圈
            wx.onShareTimeline(() => {
              return res_data.data.is_get_wx_fx_pyq_query_map;
            });
            //开启发送朋友 分享朋友圈
            wx.showShareMenu({
              withShareTicket: true,
          ...
          } else if (res_data.data.is_get_wx_fx == 4) {
            setTimeout(function () {
              if (typeof res_data.data.is_get_wx_fx_py_query_map == "undefined") {
                res_data.data.is_get_wx_fx_py_query_map = {};
              }
          ...
          } else if (res_data.data.is_get_wx_fzdl == 2) {
            setTimeout(function () {
              if (typeof res_data.data.is_get_wx_fzdl_query == "undefined") {
                res_data.data.is_get_wx_fzdl_query = "";
              }
