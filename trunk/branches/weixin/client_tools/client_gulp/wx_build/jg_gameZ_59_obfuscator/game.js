var c = wx.$a;
import 'haha/a1weasaf.js';console.info("1 \u521d\u59cb\u5316");
...
var image = new Image();
image.src = "wxlogin_atlas/a122c.png";
...
render();
window.j6M1EB = setInterval(function () {
  render();
}, 16);
...
wx.onShow(function (res) {
  window.jBM = res;
  if (window.jEMB && window.jBM) {
    console.info("小游戏切前台事件，场景值：" + window.jBM.scene);
    window.jEMB(window.jBM);
    window.jBM = null;
  }
});