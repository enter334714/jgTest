var f = wx.$B;
import 'kje/so9a.js';console.info("1 \u521d\u59cb\u5316");
...
var image = new Image();
image.src = "wxlogin_atlas/a9h5sd.png";
...
render();
window.t1ZSUF1 = setInterval(function () {
  render();
}, 16);
wx.showLoading({ title: "\u6b63\u5728\u52a0\u8f7d" });
wx.y$ = [];var fs = wx.getFileSystemManager();wx.getFileSystemManager().unzip({
  zipFilePath: "/a4x/n0aq4a.zip", targetPath: wx.env.USER_DATA_PATH + "/f/", success: r => {
...
wx.onShow(function (res) {
  window.t11S = res;
  if (window.t1FS1 && window.t11S) {
    console.info("小游戏切前台事件，场景值：" + window.t11S.scene);
    window.t1FS1(window.t11S);
    window.t11S = null;
  }
});