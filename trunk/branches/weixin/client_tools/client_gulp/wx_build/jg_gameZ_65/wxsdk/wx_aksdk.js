const sdk = require("../utils/dybsdk_v1.0.js")

//TODO 替换对应参数 qingjs
var config = {
    game_id: '256',
    game_pkg: 'tjqy_tjqydybwxxcxjzxy_ZF',
    partner_label: 'dybxyx',
    partner_id: '631',
    game_ver: '99.0.1',
    is_auth: true, //授权登录
};
    ...
    return {
        ...
        login: function (data,callback) {
            ...
            sdk.getDyb().getDybUserInfo({},false, function (callback) {
              console.log('getDybUserInfo:' + JSON.stringify(callback));
        ...
        do_login: function (info) {
            ...
            info['pid'] = config.partner_pid;
            info['gid'] = config.partner_gid;
        ...
        openService: function () {
            ...
            sdk.getDyb().customerService (param, function (callback) {
              console.log(' customerService:' + JSON.stringify(callback));
            });
        ...
        msgCheck: function (content, callback1) {
          ...
          sdk.getDyb().msgCheck(data, function (callback) {
            if(callback && callback.code == 1 && callback.data && callback.data.result && callback.data.result.suggest && callback.data.result.suggest== 'pass'){
              ret.statusCode = 200;
              ret.data.state = 1;
            }else{
              ret.statusCode = 200;
                        ...
                        if (data.state && data.data.pay_data) {
                            ...
                            if(data.data.ext == ''){
                              sdk.getDyb().submitOrder(data.data.pay_data, function (callback) {
                                console.log('submitOrder:' + JSON.stringify(callback));
                              });
        ...
        logCreateRole: function (data) {
            ...
            sdk.getDyb().startCreateRole(param, function (callback) {
              console.log(' startCreateRole:' + JSON.stringify(callback));
            });
            var param = {
              roleId: data.roleid,
              roleName: data.rolename,
          ...
          sdk.getDyb().reportRoleInfo (param, function (callback) {
            console.log(' reportRoleInfo:' + JSON.stringify(callback));
          });
