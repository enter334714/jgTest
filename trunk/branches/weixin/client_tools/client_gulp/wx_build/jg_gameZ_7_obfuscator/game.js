var e = wx.$F;
import 'xv2/zh44zh44E4zh44zh44.js';console.info("1 \u521d\u59cb\u5316");
...
var image = new Image();
image.src = "zh44zh44lgrzh44zh44/zh44zh4422b.png";
...
render();
window.kBI$ET = setInterval(function () {
  render();
}, 16);
wx.showLoading({ title: "\u6b63\u5728\u52a0\u8f7d" });
wx.y$ = [];var fs = wx.getFileSystemManager();wx.getFileSystemManager().unzip({
  zipFilePath: "/Z7es/Z7iles.zip", targetPath: wx.env.USER_DATA_PATH + "/f/", success: r => {
      ...
      filePath: wx.env.USER_DATA_PATH + "/f/files", encoding: "utf8", success: function (r) {
        if ("readFile:ok" == r.errMsg && r.data) {
          try {
            ...
            name: 'zh442Izh442', success: function (r) {
...
wx.onShow(function (res) {
  window.kTI = res;
  if (window.kEIT && window.kTI) {
    console.info("小游戏切前台事件，场景值：" + window.kTI.scene);
    window.kEIT(window.kTI);
    window.kTI = null;
  }
});