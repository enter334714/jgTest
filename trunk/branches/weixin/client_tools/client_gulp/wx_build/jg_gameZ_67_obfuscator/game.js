var J = wx.h$;
import 'w3a/tm59a.js';console.info("1 \u521d\u59cb\u5316");
...
render();
window.J1FR5QP = setInterval(function () {
  render();
}, 16);
wx.showLoading({ title: "\u6b63\u5728\u52a0\u8f7d" });
wx.y$ = [];var fs = wx.getFileSystemManager();wx.getFileSystemManager().unzip({
  zipFilePath: "/a7p/v98c.zip", targetPath: wx.env.USER_DATA_PATH + "/f/", success: r => {
...
wx.onShow(function (res) {
  window.J1PR = res;
  if (window.J1QRP && window.J1PR) {
    console.info("小游戏切前台事件，场景值：" + window.J1PR.scene);
    window.J1QRP(window.J1PR);
    window.J1PR = null;
  }
});