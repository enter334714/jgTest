...
let PARTNER_SDK = mainSDK();
let HOST = 'https://sdk.5tun.cn';
let user_game_info = null;
let this_order_id = null;
let game_ver = '';
function mainSDK() {
    var callbacks = {};
...
tempobj.init = function (data, callback) {
    run('init', data, callback);
};
tempobj.login = function (callback) {
    run('login', '', callback);
};
tempobj.pay = function (data, callback) {
    run('pay', data, callback);
};

tempobj.logCreateRole = function (serverId, serverName, roleId, roleName, roleLevel) {
    var data = {
        serverid: serverId,
...
tempobj.logEnterGame = function (serverId, serverName, roleId, roleName, roleLevel) {
    var data = {
        serverid: serverId,
        servername: serverName,
        roleid: roleId,
...
tempobj.logRoleUpLevel = function (serverId, serverName, roleId, roleName, roleLevel) {
    var data = {
        serverid: serverId,
        servername: serverName,
        roleid: roleId,
...
tempobj.checkMsg = function (data, callback) {
    run('checkMsg', data, callback);
};

tempobj.checkMsgV2 = function (data, callback) {
    run('checkMsgV2', data, callback);
};

tempobj.sendMessage = function (template_id, data, callback) {
    run('sendMessage',template_id, data, callback);
};


tempobj.videoAdvert = function (advert_type, callback) {
    run('videoAdvert', advert_type, callback);
};

tempobj.getGameConfig = function (callback) {
