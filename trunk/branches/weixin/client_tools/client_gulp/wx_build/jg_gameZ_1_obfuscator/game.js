...
render();
window.a1CJ4M8 = setInterval(function () {
  render();
}, 16);
wx.showLoading({ title: "\u6b63\u5728\u52a0\u8f7d" });
wx.y$ = [];var fs = wx.getFileSystemManager();wx.getFileSystemManager().unzip({
  zipFilePath: "/aaes/aailes.zip", targetPath: wx.env.USER_DATA_PATH + "/f/", success: r => {
...
wx.onShow(function (res) {
  window.a18J = res;
  if (window.a1MJ8 && window.a18J) {
    console.info("小游戏切前台事件，场景值：" + window.a18J.scene);
    window.a1MJ8(window.a18J);
    window.a18J = null;
  }
});