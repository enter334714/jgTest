console.info("0 \u8fdb\u5165\u6e38\u620f\u5305"), window.lastError, wx.onError(function (o) {
  if (o) {
    if (o.message) {
      var n = window.config.game_ver.replace(new RegExp(/\./, "g"), "_");var e = o.message;var a = e.match(/(a2a3a1\/a12game.js:)[0-9]{1,60}(:)/g);if (a) for (var i = 0; i < a.length; i++) {
        var w;a[i] && 0 < a[i].length && (w = parseInt(a[i].replace("a2a3a1/a12game.js:", "").replace(":", "")), e = e.replace(a[i], a[i].replace(":" + w + ":", ":" + (w - 2) + ":")));
      }e = (e = e.replace(new RegExp("a2a3a1/a12game.js", "g"), "a2a3a1/main__" + n + ".min.js")).replace(new RegExp("a2a3a1/amain.js", "g"), "a2a3a1/main__" + n + ".min.js"), o.message = e;
...
});import "a1md5min.js";import "ea1zlibs.js";window.Parser = require("a1domparser.js");import "a1index.js";import "a1ibsmin.js";import "a1wxmini.js";import "a1initmin.js";console.info("1 \u521d\u59cb\u5316"), console.info("2 \u52a0\u8f7d\u6e38\u620f"), wxShowLoading({ title: "\u6b63\u5728\u52a0\u8f7d" });var wxData = { showLoadingBtn: !0 };new window.ServerLoading(wxData), window.ServerLoading.instance.openAuthor(), window.loadingInterval && clearInterval(window.loadingInterval), window.loadingInterval = null, window.compareVersion = function (o, n) {
  if (!o || !n) return 0;o = o.split("."), n = n.split(".");var e = Math.max(o.length, n.length);for (; o.length < e;) o.push("0");for (; n.length < e;) n.push("0");for (var a = 0; a < e; a++) {
    var i = parseInt(o[a]),
        w = parseInt(n[a]);if (w < i) return 1;if (i < w) return -1;
  }return 0;
  ...
  console.log("protobuf \u5206\u5305\u52a0\u8f7d");var o = wx.loadSubpackage({ name: "a2a1epf", success: function (o) {
  ...
  console.log("Main \u5206\u5305\u52a0\u8f7d");var o = wx.loadSubpackage({ name: "a2a3a1", success: function (o) {
