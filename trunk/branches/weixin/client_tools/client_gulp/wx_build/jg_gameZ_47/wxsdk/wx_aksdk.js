const JmCore = require('../utils/jm-core');

//TODO 替换对应参数
var config = {
    game_id: 256,
    game_pkg: 'tjqy_tjqycywxxcx2jtfssy_WU',
    partner_label: 'cyxyx',
    partner_id: '591',
    game_ver: '79.0.1',
    is_auth: false, //授权登录
    ...
    return {
        ...
        msgCheck: function (content, callback) {
            ...
            JmCore.msgCheck(content,1,function(res){
              console.log('渠道敏感词检测返回',res);
              if(res && res.suggest=='pass'){
                    ...
                    if (res.statusCode == 200) {
                        ...
                        if (data.state) {
                          ...
                          if(data.data.ext == ''){
                                ...
                                payData['openid'] = partner_user_info.openid;

                                JmCore.createOrder(payData,'',function(res){
                                      console.log('渠道下单返回',res);
                                });
