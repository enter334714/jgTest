console.info("0 \u8fdb\u5165\u6e38\u620f\u5305"), window.lastError, wx.onError(function (o) {
  if (o) {
    if (o.message) {
      var n = window.config.game_ver.replace(new RegExp(/\./, "g"), "_");var e = o.message;var i = e.match(/(ffffffff\/fffgame.js:)[0-9]{1,60}(:)/g);if (i) for (var w = 0; w < i.length; w++) {
        var r;i[w] && 0 < i[w].length && (r = parseInt(i[w].replace("ffffffff/fffgame.js:", "").replace(":", "")), e = e.replace(i[w], i[w].replace(":" + r + ":", ":" + (r - 2) + ":")));
      }e = (e = e.replace(new RegExp("ffffffff/fffgame.js", "g"), "ffffffff/main__" + n + ".min.js")).replace(new RegExp("ffffffff/fffmain.js", "g"), "ffffffff/main__" + n + ".min.js"), o.message = e;
  ...
  console.log("protobuf \u5206\u5305\u52a0\u8f7d");var o = wx.loadSubpackage({ name: "ffffffpf", success: function (o) {
  ...
  console.log("Main \u5206\u5305\u52a0\u8f7d");var o = wx.loadSubpackage({ name: "ffffffff", success: function (o) {
