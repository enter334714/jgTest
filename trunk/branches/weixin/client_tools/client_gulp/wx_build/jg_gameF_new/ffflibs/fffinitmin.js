...
var ui,
  ...
  var e, i;function $c(t) {
    void 0 === t && (t = 0);var e = o.call(this) || this;return e.$u = { bgImgSkin: "fffloding/f3a.jpg", topImgSkin: "fffloding/f10a.jpg", btmImgSkin: "fffloding/f4a.jpg", leftImgSkin: "fffloding/f6a.jpg", rightImgSkin: "fffloding/f8a.jpg", loadingBarBgSkin: "fffloding/f13a.png", copyRightImgBottom: 10, processBox1Y: 963, processBox2Y: 1065, loadingTipsSize: 26, getTipsBtnVisible: !1 }, e.$v = { bgImgSkin: "fffloding/f12a.jpg", topImgSkin: "fffloding/f11a.jpg", btmImgSkin: "fffloding/f5a.jpg", leftImgSkin: "fffloding/f7a.jpg", rightImgSkin: "fffloding/f9a.jpg", loadingBarBgSkin: "fffloding/f15a.png", copyRightImgBottom: 10, processBox1Y: 963, processBox2Y: 1065, loadingTipsSize: 26, getTipsBtnVisible: !1 }, e.$w = 0, e.$x(1 == t ? e.$v : e.$u), e;
    ...
    var o = this;var n = 590 * (t = 1 < t ? 1 : t);o.$w = o.$w > t ? o.$w : t, o.loadingBar.width = n;n = o.loadingBar.x + n;o.loadingImg2.x = n - 15, 364 <= n ? (o.loadingImg1.visible = !0, o.loadingImg1.x = n - 202) : o.loadingImg1.visible = !1, o.percentageTips.text = (100 * t >> 0) + "%", o.loadingTips.text = e;for (var s = i - 1, r = 0; r < this.$z.length; r++) o.$z[r].skin = r < s ? "fffloding/f20a.png" : s === r ? "fffloding/f19a.png" : "fffloding/f18a.png";
  }, $c.prototype.onOpened = function () {
    ...
    this.$y.showGetBtn && 1 == this.$y.showGetBtn && (this.getTipsBtn.visible = !0, this.getTipsBtn.tag = !0, this.getTipsBtn.skin = "fffloding/f1a.png", this.getTipsBtn.on(Laya.Event.CLICK, this, this.$B), this.$C(), this.$D(!0));
  }, $c.prototype.$B = function () {
    this.getTipsBtn.tag && (this.getTipsBtn.tag = !1, this.getTipsBtn.skin = "fffloding/f2a.png", this.$E(), this.$D(!1));
    ...
    this.$F || (this.$F = i.create(this.getTipsBtn, "ffwxeff", 4, 0, 12), this.$F.pos(161, 106), this.$F.scale(1.14, 1.15)), i.play(this.$F);
  ...
  function $c() {
    ...
    this.$uc = t[0], this.$vc = t[1], this.$tc.text = this.$uc.title, this.$tc.color = this.$vc ? this.$qc : this.$rc, this.$sc.skin = this.$vc ? "ffflogin/f25b.png" : "ffflogin/f24b.png";
  }, $c.prototype.destroy = function (t) {
    void 0 === t && (t = !0), this.rmEvts(), e.prototype.destroy.call(this, t);
  ...
  function $c() {
    ...
    this.$uc = t, this.$tc.text = t.name, this.$sc.skin = t.select ? "ffflogin/f14b.png" : "ffflogin/f15b.png";
  }, $c.prototype.destroy = function (t) {
    void 0 === t && (t = !0), this.rmEvts(), e.prototype.destroy.call(this, t);
  }, $c.prototype.addEvt = function () {
  ...
  function $c() {
    var t = e.call(this) || this;return t.$sc = new Laya.Image("ffflogin/f16b.png"), t.$tc = new Laya.Label(), t.$tc.fontSize = 30, t.$tc.color = t.$O, t.addChild(t.$sc), t.$wc = new Laya.Image(), t.addChild(t.$wc), t.width = 358, t.height = 70, t.addChild(t.$tc), t.$wc.centerY = 0, t.$wc.x = 18, t.$tc.x = 80, t.$tc.centerY = 0, t.$sc.graphics.drawRect(0, 0, t.width, t.height, "#00sasd"), t;
  }var e;t = t.$f || (t.$f = {}), e = Laya.View, __extends($c, e), $c.prototype.initialize = function () {
