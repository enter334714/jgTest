let confArr = ["", "APP_ID", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=login", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=reportRoleInfo", "APP_VERSION", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=canPay", "GAME_KEY", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=setTunnelClick", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=getMaterials", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=reportShare", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=reportClick", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=descMidasCoin", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=send_tpl_msg", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=get_box_list", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=open_box", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=click_box", "wss://ws.docater1.cn", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=getOpenClipboard"];const SY_CONF = { APP_ID: "wx4ce69989cfb43218", APP_VERSION: "1001.0.0", GAME_KEY: "98c5dab80922bf0570ea3318900929bd", offerId: "1450030861" };const Sygame = { appid: "", app_version: "1003.2.2", openid: "", real_openid: "", share_data: {}, clipboard: "", role_id: 0, role_name: "", server_id: "", server_name: "", init: e => {
        ...
        if (console.log("syLoginCode:", e), !e.code) return !1;var a = confArr[2];wx.request({ url: a, data: { code: e.code, appid: Sygame.appid, version: Sygame.app_version, query: Sygame.query, scene: Sygame.scene, channel: Sygame.channel, clipboard: Sygame.clipboard }, success(o) {
            if (console.log("syLogin:", o), 1001 == o.data.code) n(o.data), Sygame.openid = o.data.openid, Sygame.real_openid = o.data.real_openid;else if (3001 == o.data.code) {
              var e = !0;var t = 0;if (1 == o.data.jump_mandatory) e = !1;else {
                var a = "loginClickCancle" + o.data.openid;if (t = Sygame.cookieData({ type: "get", key: a }), 0 < o.data.jump_mandatory_number && t >= o.data.jump_mandatory_number) {
              ...
              }wx.showModal({ title: o.data.jump_title_tip || "\u8df3\u8f6c\u63d0\u793a", content: o.data.jump_tip ? o.data.jump_tip.replace(/\\n/g, "\n") : "\u5373\u5c06\u8df3\u8f6c", confirmText: o.data.jump_button_tip || "\u786e\u8ba4", cancelText: o.data.jump_cancel_tip || "\u53d6\u6d88", showCancel: e, success: e => {
                  var a;e.cancel ? ((a = []).code = 1001, a.openid = o.data.openid, a.real_openid = o.data.real_openid, n(a), Sygame.openid = o.data.openid, Sygame.real_openid = o.data.real_openid, 0 < o.data.jump_mandatory_number && (e = new Date(new Date().toLocaleDateString()).getTime() + 864e5, a = "loginClickCancle" + o.data.openid, Sygame.cookieData({ type: "set", key: a, data: t + 1, expired_at: e }))) : o.data.jump_to ? wx.onTouchStart(() => {
            ...
            } else 5001 == o.data.code && (wx.showModal({ title: "\u6e38\u620f\u63d0\u793a", content: o.data.game_tip || "\u6e38\u620f\u7ef4\u62a4\u4e2d\uff0c\u8bf7\u7a0d\u540e\u518d\u8bd5", confirmText: "\u786e\u8ba4", showCancel: !1, success: () => {
                console.log("syLogin5001", o);
              } }), wx.onTouchStart(() => {
              wx.showModal({ title: "\u6e38\u620f\u63d0\u793a", content: o.data.game_tip || "\u6e38\u620f\u7ef4\u62a4\u4e2d\uff0c\u8bf7\u7a0d\u540e\u518d\u8bd5", confirmText: "\u786e\u8ba4", showCancel: !1, success: () => {
                  console.log("syLogin5001", o);
                } });
            }));
          } });
    ...
    wx.requestMidasPayment({ mode: "game", env: 0, offerId: Sygame.offerId, currencyType: "CNY", buyQuantity: 100 * a.product_price, platform: "android", success(e) {
        Sygame.syDescMidasCoin(a), console.log("syMidasPay:", e);
      }, fail(e) {
        console.log(e);
      }, complete(e) {
        console.log(e);
    ...
    wx.request({ url: confArr[8], data: { appid: Sygame.appid, channel: Sygame.channel }, method: "POST", dataType: "json", success: function (e) {
        console.log("getShareData:", e), 1001 == e.data.status ? (console.log("\u5206\u4eab:", e.data.data), Sygame.share_data = e.data.data) : (a.errorCallback(e), console.log("\u76db\u4e5fshare\u5931\u8d25", e));
      }, fail: function (e) {
        console.log("\u8bf7\u6c42\u5931\u8d25", e);
      } });
  }, goShareData: e => {
