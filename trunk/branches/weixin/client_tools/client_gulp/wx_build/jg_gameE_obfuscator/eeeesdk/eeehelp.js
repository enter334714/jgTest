...
const Tools = {
  ...
  buildCheckMsg(params) {
    ...
    signString = signString + commonParams.gameKey;
    params[b[51277]] = md5(signString).toLowerCase();
    return params;
  },
  ...
  buildRedParams: params => {
    ...
    params[b[51277]] = md5(stringParams);
    return params;
  },
  initLock: locks => {
