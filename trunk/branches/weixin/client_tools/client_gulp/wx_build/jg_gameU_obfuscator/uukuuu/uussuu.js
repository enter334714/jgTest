...
module.exports = function (e) {
    ...
    return n.m = e, n.c = t, n.d = function (e, t, r) {
        ...
        o[340009] != typeof Symbol && Symbol.toStringTag && Object.defineProperty(e, Symbol.toStringTag, {
            value: o[340011]
        }), Object.defineProperty(e, o[340012], {
            value: !0
        });
    }, n.t = function (e, t) {
        if (1 & t && (e = n(e)), 8 & t) return e;
        if (4 & t && o[340013] == typeof e && e && e.__esModule) return e;
        var r = Object.create(null);
        if (n.r(r), Object.defineProperty(r, o[340015], {
            enumerable: !0,
            value: e
        }), 2 & t && o[340016] != typeof e) for (var a in e) n.d(r, a, function (t) {
            return e[t];
        }.bind(null, a));
        return r;
    }, n.n = function (e) {
    ...
    try {
        r.gameParams[o[341733]] = wx.canIUse ? "" : o[341734], wx.getSystemInfo({
            success: function (e) {
                r.deviceParams[o[341735]] = encodeURIComponent(e.brand), r.deviceParams[o[341736]] = encodeURIComponent(e.model), r.deviceParams[o[341737]] = encodeURIComponent(e.screenWidth + "x" + e.screenHeight), r.deviceParams[o[341738]] = o[341111] === e.platform ? o[340998] : encodeURIComponent(e.platform), r.deviceParams[o[341739]] = encodeURIComponent(e.system), r.extParams.brand = e.brand, r.extParams.model = e.model, r.extParams.pixelRatio = e.pixelRatio, r.extParams.windowWidth = e.windowWidth, r.extParams.windowHeight = e.windowHeight, r.extParams.statusBarHeight = e.statusBarHeight, r.extParams.language = e.language, r.extParams.version = e.version, r.extParams.system = e.system, r.extParams.platform = e.platform, r.extParams.fontSizeSetting = e.fontSizeSetting, r.extParams.SDKVersion = e.SDKVersion, r.extParams.benchmarkLevel = e.benchmarkLevel, r.extParams[o[341740]] = e.albumAuthorized, r.extParams.cameraAuthorized = e.cameraAuthorized, r.extParams.locationAuthorized = e.locationAuthorized, r.extParams.microphoneAuthorized = e.microphoneAuthorized, r.extParams.notificationAuthorized = e.notificationAuthorized, r.extParams.notificationAlertAuthorized = e.notificationAlertAuthorized, r.extParams.notificationBadgeAuthorized = e.notificationBadgeAuthorized, r.extParams.notificationSoundAuthorized = e.notificationSoundAuthorized, r.extParams.bluetoothEnabled = e.bluetoothEnabled, r.extParams.locationEnabled = e.locationEnabled, r.extParams.wifiEnabled = e.wifiEnabled, r.extParams.safeArea = e.safeArea;
            }
        }), r.extParams.userua = window.navigator.userAgent, wx.getNetworkType({
            success: function (e) {
                r.deviceParams[o[341741]] = encodeURIComponent(e.networkType), r.extParams.net = e.networkType;
            }
        }), wx.getScreenBrightness({
            success: function (e) {
                r.deviceParams[o[341742]] = encodeURIComponent(parseInt(100 * e.value)), r.extParams.screen_luminance = parseInt(100 * e.value);
            }
        });
    } catch (e) {}
    e.exports = r;
    ...
    var u = void 0,
        ...
        params: function (e) {
            if (e.method = (e.method || o[340158]).toUpperCase(), o[341114] !== e.method || e.header || (e.header = {
                "Content-Type": o[341254]
            }), !e.private) {
                var t = wx.getStorageSync(o[341743]);
        ...
        sign: function (e) {
            var t = "";
            t = e.data.channel_id ? o[341744] : o[341745], e.app_key && (t = o[341746] + e.app_key);
            ...
            var i = "";
            return i = e.app_key ? (0, o.default)(a.substr(1) + "&" + t) : (0, o.default)((e.method + "&" + encodeURIComponent(n) + "&" + encodeURIComponent(a.substr(1)) + "&" + t).replace(/\(/g, o[341747]).replace(/\)/g, o[341748])), i;
        },
        renderQRCode: function (e, t, n) {
            var r = t.getContext("2d"),
                a = wx.createImage();
            a.src = n.image, a.onload = function () {
                r.lineJoin = o[340461], r.lineWidth = 30, r.strokeStyle = o[341411], r.strokeRect((window.innerWidth - 240) / 2, (window.innerHeight - 264) / 2, 240, 264), r.fillStyle = o[341411], r.fillRect((window.innerWidth - 220) / 2, (window.innerHeight - 244) / 2, 220, 244), r.fillStyle = o[341749], r.font = o[341750], r.textAlign = o[341359], r.fillText(n.intro, window.innerWidth / 2, (window.innerHeight - 258) / 2 + 218 + 30, 250), r.drawImage(a, (window.innerWidth - 218) / 2, (window.innerHeight - 258) / 2, 218, 218);
            }, u = {
                canvas: e,
                qrcvs: t,
                qrctx: r,
                data: n
            }, e.addEventListener(o[341751], c);
        },
        removeOffScreen: function () {
            u && (u.qrctx.clearRect(0, 0, u.qrcvs.width, u.qrcvs.height), u.canvas.removeEventListener(o[341751], c));
        }
    };
    function c(e) {
        e.preventDefault();
        ...
        n >= (window.innerWidth - 218) / 2 && n <= (window.innerWidth - 218) / 2 + 218 && r >= (window.innerHeight - 258) / 2 && r <= (window.innerHeight - 258) / 2 + 218 ? wx.previewImage({
            urls: [u.data.image]
        }) : (u.qrctx.clearRect(0, 0, u.qrcvs.width, u.qrcvs.height), u.canvas.removeEventListener(o[341751], c));
    }
    e.exports = d;
}, function (e, t, n) {
    "use strict";
    ...
    var s = {
        init: function () {
            var e = this,
                ...
                n = [o[341753], o[341754], o[341082], o[341755], o[341756], o[341757], o[341758]];
            return n.map(function (e) {
                void 0 !== t[e] && (o[341753] === e ? i.default.baseParams[e] = t.app_id : o[341754] === e ? i.default.gameParams[o[341759]] = t.mp_id : o[341758] === e ? i.default.debug = t.debug : i.default.setting[e] = t[e]);
        ...
        reversal: function () {
            ...
            return new Promise(function (t, n) {
                wx.login({
                    success: function (r) {
                        var a;
                        r.code ? (e.data = Object.assign({}, e.data, (c(a = {}, o[341762], i.default.extParams), c(a, o[341763], i.default.launchOptions.ext), c(a, o[341084], i.default.launchOptions.state), c(a, o[341764], r.code), a)), t(o.default.reversal(e))) : n(r);
                    },
                    fail: function (e) {
                        n(e);
                    }
        ...
        login: function () {
            ...
            return new Promise(function (n, r) {
                wx.checkSession({
                    ...
                    fail: function (a) {
                        console.log(o[341766], t), o.default.wxLogin(t).then(function (r) {
        ...
        mpPayQuery: function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            if (!e.data || void 0 === e.data[o[341767]]) {
                var t = wx.getStorageSync(o[341768]);
                e.data = a({}, e.data, {
        ...
        checkImg: function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                ...
                token: wx.getStorageSync(o[341743]).user_token,
                ts: new Date().getTime()
            });
            return t.sign = u.default.sign({
                ...
                wx.uploadFile({
                    url: i.default.baseUrl + o[341769],
    ...
    var u = !1,
        ...
        return new Promise(function (r, o) {
            a.default.ajax(e).then(function (e) {
                ...
                if (e.data && 1002 === e.data.code) {
                    ...
                    msg: e.data ? e.data.msg || o[341771] : e.errMsg
                });
            });
        });
    },
        ...
        login: function (e) {
            return o.default.launchOptions.ext ? e.data = Object.assign({}, e.data, r({
                ...
                return e && wx.setStorageSync(o[341743], e.data), e;
            });
        },
        wxLogin: function (e) {
            var t = this;
        ...
        setUserInfo: function (e) {
            return d(r({
                ...
                return wx.setStorageSync(o[341743], e.data), e;
            });
        },
        ...
        wxMidasPay: function (e, t) {
            ...
            return new Promise(function (r, o) {
                ...
                wx.requestMidasPayment({
                    ...
                    zoneId: l,
                    success: function (a) {
                        t.data[o[341767]] = e.order_id, t.conf = {
                            showLoading: !1,
                            showToast: !1
                    ...
                    fail: function (e) {
                        if (e.errMsg) if (o[341786] === e.errMsg) {
                            var n = wx.getStorageSync(o[341743]);
                            e.msg = n && n.ios_text || o[341787], e.duration = 3e3;
                        } else e.msg = e.errMsg;
        ...
        checkPay: function (e) {
            var t = this;
            return this.preOrder(e).then(function (n) {
                return 2 === n.data.check ? t.wxMidasPay(n.data, e) : (e.data[o[341767]] = n.data.order_id, t.checkPayInfo(e));
            });
        },
        preOrder: function (e) {
            return d(r({
                ...
                return wx.setStorageSync(o[341768], e.data), e;
            }, function (e) {
                return e;
            });
        },
        ...
        checkPayInfo: function (e) {
            ...
            return d(r({
                ...
                return n.data.order_id = e.data[o[341767]], new Promise(function (r, o) {
                    n.data.image && wx.setStorageSync(o[341795], n.data.image);
                    var i = wx.getStorageSync(o[341795]);
                    n.data && 4 == +n.data.pay_type ? (wx.showModal({
                        ...
                        e.canvas && e.offscreen && a.default.renderQRCode(e.canvas, e.offscreen, {
                            image: o,
                            intro: n.data.intro || o[341798]
                        }), wx.setStorageSync(o[341795], o), n.data.image = o, r(n);
                    }, function (e) {
                        r(n);
                    });
                });
    ...
    var r;
    o[340130] == typeof Symbol && Symbol.iterator;
    !function (a) {
        function o(e, t) {
        ...
        function g(e) {
            var t,
                n,
                r = "";
            for (n = 0; n < e.length; n += 1) t = e.charCodeAt(n), r += o[341806].charAt(t >>> 4 & 15) + o[341806].charAt(15 & t);
            return r;
        }
        function h(e) {
