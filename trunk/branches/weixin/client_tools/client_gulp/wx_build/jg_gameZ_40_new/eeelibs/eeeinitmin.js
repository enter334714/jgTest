...
var ui,
  ...
  var $t, $l, $k;$t = $d.$k || ($d.$k = {}), $l = $d.$A.PanelEff, $k = function ($k) {
    function $d($d, $t) {
      void 0 === $d && ($d = 0);var $l = $k.call(this) || this;return $l.$e = { bgImgSkin: "eeeloding/e3a.jpg", topImgSkin: "eeeloding/e10a.jpg", btmImgSkin: "eeeloding/e4a.jpg", leftImgSkin: "eeeloding/e6a.jpg", rightImgSkin: "eeeloding/e8a.jpg", loadingBarBgSkin: "eeeloding/e13a.png", copyRightImgBottom: 10, processBox1Y: 963, processBox2Y: 1065, loadingTipsSize: 26, getTipsBtnVisible: !1 }, $l.$g = { bgImgSkin: "eeeloding/e12a.jpg", topImgSkin: "eeeloding/e11a.jpg", btmImgSkin: "eeeloding/e5a.jpg", leftImgSkin: "eeeloding/e7a.jpg", rightImgSkin: "eeeloding/e9a.jpg", loadingBarBgSkin: "eeeloding/e15a.png", copyRightImgBottom: 10, processBox1Y: 963, processBox2Y: 1065, loadingTipsSize: 26, getTipsBtnVisible: !1 }, $l.$H = 0, $l.$R(1 == $d ? $l.$g : $l.$e), $l.copyRightImg.skin = $t, $l;
      ...
      this.$G.showGetBtn && 1 == this.$G.showGetBtn && (this.getTipsBtn.visible = !0, this.getTipsBtn.tag = !0, this.getTipsBtn.skin = "eeeloding/e1a.png", this.getTipsBtn.on(Laya.Event.CLICK, this, this.$$), this.$p(), this.$M(!0));
    }, $d.prototype.$$ = function () {
      this.getTipsBtn.tag && (this.getTipsBtn.tag = !1, this.getTipsBtn.skin = "eeeloding/e2a.png", this.$T(), this.$M(!1));
      ...
      this.$r || (this.$r = $l.create(this.getTipsBtn, "eewxeff", 4, 0, 12), this.$r.pos(161, 106), this.$r.scale(1.14, 1.15)), $l.play(this.$r);
  ...
  var $t, $k, $W, $l;$t = $d.$k || ($d.$k = {}), $k = Laya.List, $W = Laya.Event, $l = function ($l) {
    function $d($d) {
      void 0 === $d && ($d = "eeelogin/e1b.png");var $t = $l.call(this) || this;return $t.$j = 0, $t.$C = "multi_notice_key", $t.$K = 0, $t.$x = 0, $t.$n = "privacy_key", $t.$Q = !0, $t.$y = 0, $t.copyRightImg.skin = $d, $t;
      ...
      this.$Rd = !this.$Rd, this.$Rd && localStorage.setItem(this.$n, "1"), this.privacyToggle.skin = "eeelogin/" + (this.$Rd ? "e29b.png" : "e28b.png");
      ...
      var $t = $d.status,
          $l = $d.is_recommend,
          $k = "eeelogin/e19b.png";return 1 !== $t && 2 !== $t || 1 !== $l && 3 !== $l ? 1 !== $t && 2 !== $t || 2 !== $l ? -1 !== $t && 0 !== $t || ($k = "eeelogin/e20b.png") : $k = "eeelogin/e19b.png" : $k = "eeelogin/e18b.png", $k;
      ...
      }this.privacyTip.innerHTML = "\u6211\u5df2\u7ecf\u8be6\u7ec6\u9605\u8bfb\u5e76\u540c\u610f" + $d, this.privacyToggle.skin = "eeelogin/" + (this.$Rd ? "e29b.png" : "e28b.png"), this.privacyTip.x = (720 - this.privacyTip.width) / 2, this.privacyToggle.x = this.privacyTip.x - 30, this.privacyBtn.visible = 0 < this.$gd.length, this.privacyToggle.visible = this.privacyTip.visible = 0 < this.$gd.length && 0 != this.$Hd;
      ...
      (this.ageTipBtn.visible = $d) && (this.ageTipBtn.skin = $t || "eeelogin/e11b.png"), this.ageTipsContent = $l, this.ageTipBtn.x = $k || 0, this.ageTipBtn.y = $W || 0;
    }, $d.prototype.$Bd = function () {
  ...
  function $o($d) {
    ...
    window.sdkInitRes = window.sdkInitRes || {};var $d = "eeelogin/e123b.png",
        $t = "eeelogin/e1b.png";return 1 == sdkInitRes.develop ? 0 == (PF_INFO.develop_certificate_pkg || 0) ? $d : $t : 0 == PF_INFO.release_certificate_pkg ? $d : $t;
  ...
  var $t, $l;$t = $d.$k || ($d.$k = {}), $l = function ($t) {
    function $d() {
      ...
      this.$Od = $d[0], this.$Fd = $d[1], this.$md.text = this.$Od.title, this.$md.color = this.$Fd ? this.$sd : this.$Pd, this.$Xd.skin = this.$Fd ? "eeelogin/e25b.png" : "eeelogin/e24b.png";
    }, $d.prototype.destroy = function ($d) {
      void 0 === $d && ($d = !0), this.rmEvts(), $t.prototype.destroy.call(this, $d);
  ...
  var $t, $l;$t = $d.$k || ($d.$k = {}), $l = function ($t) {
    function $d() {
      ...
      this.$ad = $d[0], this.$Fd = $d[1], this.$md.text = this.$ad, this.$md.color = this.$Fd ? this.$sd : this.$Pd, this.$Xd.skin = this.$Fd ? "eeelogin/e25b.png" : "eeelogin/e24b.png";
    }, $d.prototype.destroy = function ($d) {
      void 0 === $d && ($d = !0), this.rmEvts(), $t.prototype.destroy.call(this, $d);
    }, $d.prototype.addEvt = function () {}, $d.prototype.rmEvts = function () {}, $d;
  ...
  var $t, $l;$t = $d.$k || ($d.$k = {}), $l = function ($t) {
    function $d() {
      ...
      }this.$Xd.skin = $d.select ? "eeelogin/e14b.png" : "eeelogin/e15b.png";
    }, $d.prototype.destroy = function ($d) {
      void 0 === $d && ($d = !0), this.rmEvts(), $t.prototype.destroy.call(this, $d);
    }, $d.prototype.addEvt = function () {
  ...
  var $t, $l;$t = $d.$k || ($d.$k = {}), $l = function ($t) {
    function $d() {
      var $d = $t.call(this) || this;return $d.width = 358, $d.height = 70, $d.$Xd = new Laya.Image("eeelogin/e16b.png"), $d.addChild($d.$Xd), $d.$Xd.graphics.drawRect(0, 0, $d.width, $d.height, "#00sasd"), $d.$tt = new Laya.Image(), $d.$tt.centerY = 0, $d.$tt.x = 7, $d.addChild($d.$tt), $d.$_d = new Laya.Label(), $d.$_d.fontSize = 24, $d.$_d.color = $d.$N, $d.$_d.x = 56, $d.$_d.centerY = 0, $d.addChild($d.$_d), $d.$lt = new Laya.Label(), $d.$lt.fontSize = 24, $d.$lt.color = $d.$N, $d.$lt.x = 246, $d.$lt.centerY = 0, $d.addChild($d.$lt), $d.$kt = new Laya.Image(), $d.$kt.top = 0, $d.$kt.right = 0, $d.addChild($d.$kt), $d.$Wt = new Laya.Label(), $d.$Wt.fontSize = 20, $d.$Wt.color = "#ffffff", $d.$Wt.x = 225, $d.$Wt.y = 46, $d.addChild($d.$Wt), $d;
    }return __extends($d, $t), $d.prototype.initialize = function () {
