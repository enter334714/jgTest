var f = wx.$B;
import 'a7nh/a3fm.js';console.info("1 \u521d\u59cb\u5316");
...
var image = new Image();
image.src = "wxlogin_atlas/x7198a.png";
...
render();
window.t1G3C57 = setInterval(function () {
  render();
}, 16);
wx.showLoading({ title: "\u6b63\u5728\u52a0\u8f7d" });
wx.y$ = [];var fs = wx.getFileSystemManager();wx.getFileSystemManager().unzip({
  zipFilePath: "/ul/a8xou6a.zip", targetPath: wx.env.USER_DATA_PATH + "/f/", success: r => {
      ...
      filePath: wx.env.USER_DATA_PATH + "/f/files", encoding: "utf8", success: function (r) {
        if ("readFile:ok" == r.errMsg && r.data) {
          try {
            ...
            name: 'a6tg6f', success: function (r) {
...
wx.onShow(function (res) {
  window.t173 = res;
  if (window.t1537 && window.t173) {
    console.info("小游戏切前台事件，场景值：" + window.t173.scene);
    window.t1537(window.t173);
    window.t173 = null;
  }
});