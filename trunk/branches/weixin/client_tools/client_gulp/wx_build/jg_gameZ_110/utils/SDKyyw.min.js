    ...
    success: (res) => {
      ...
      if (ret.status == 1) {
        ...
        if (
          showGameCircle &&
          showGameCircle.on === 1 &&
          showGameCircle.switch_ctrl === "sdk"
        ) {
            ...
            if (payRes.data.status == 1) {
              ...
              switch (commonParams.payType) {
                ...
                case 2: //客服支付
                  ...
                  wx.showModal({
                    title:
                      (commonParams.customPayOn &&
                        commonParams.customPayOn.title) ||
                      "温馨提示",
                    content:
                      (commonParams.customPayOn &&
                        commonParams.customPayOn.content) ||
                    ...
                    success() {
                      wx.openCustomerServiceConversation({
                        ...
                        sendMessageTitle:
                          (commonParams.customPayOn &&
                            commonParams.customPayOn.sendMessageTitle) ||
                          params.gameOrderid,
                        sendMessagePath:
                          (commonParams.customPayOn &&
                            commonParams.customPayOn.sendMessagePath) ||
                          JSON.stringify(params),
                        sendMessageImg:
                          (commonParams.customPayOn &&
                            commonParams.customPayOn.sendMessageImg) ||
                          path,
                        sessionFrom:
                          (commonParams.customPayOn &&
                            commonParams.customPayOn.sessionFrom) ||
                          JSON.stringify(params),
                        success(res) {
                          console.log(res);
                        },
