...
var config = {
    game_id: 256,
    game_pkg: 'tjqy_tjqydjsn2bgwxxcx_XP',
    partner_label: 'bgxyx',
    partner_id: '389',
    game_ver: '83.0.3',
    is_auth: false, //授权登录
    partner_app_id:37, // 渠道游戏的标识ID
    partner_mp_id:'wx557f052b42d7bde7' // 小程序ID，来自微信官方平台
};
    ...
    return {
        ...
        msgCheck: function (content, callback) {
            ...
            sdk.checkMsg({
                ...
                console.log('文本检测结果'+JSON.stringify(res))
                if(res.msg == 'success'){
                    ret.statusCode = 200;
                    ret.data.state = 1;
                }else{
                    ...
                    if (res.statusCode == 200) {
                        ...
                        if (data.state) {
                            ...
                            sdk.checkPay({
                                ...
                                console.log('渠道支付结果res=='+JSON.stringify(res));
                            });
