...
function bannerAdHide() {
  wx_bannerAD.hide()
}
export

function customADShow() {
...
function customADHide() {
  wx_CustomAD.hide()
}
export

function customADOnclose(e) {
...
function getTempLateIDs() {
  ...
  let t = newSignGetType(e);
  e.sign = hex_md5(t);
  print("订阅推送消息请求参数 ", e);
  let a = `${sdklogData.platform_url}/oauth/getWxSubscriptionId`;
  let i = "GET";
  let n = e => {
...
function gotoCustomerServiceConversation(e) {
...
function creatorlabel(e = "", t = "", a, i = 0, n = 0, o = "", r) {
  let s = new cc.Node(e);
