let confArr = ["./sysdk-conf", "APP_ID", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=login", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=reportRoleInfo", "APP_VERSION", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=canPay", "GAME_KEY", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=setTunnelClick", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=getMaterials", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=reportShare", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=reportClick", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=descMidasCoin", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=send_tpl_msg", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=get_box_list", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=open_box", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=click_box", "wss://ws.docater1.cn", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=getOpenClipboard", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=getDealPackageInfo", "https://docater1.cn/index.php?g=Wap&m=WxSecCheck&a=msgSecCheck", "https://docater1.cn/index.php?g=Wap&m=WxSecCheck&a=imgSecCheck", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=getGameShareCardData", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=reportMidasErrorInfo", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=getBoxCheckoutCode", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=getUserPopupConfig", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=reportClickPopup", "https://docater1.cn/index.php?g=Wap&m=MiniGame&a=roleLogout"];const SY_CONF = require(confArr[0]);const Sygame = { SY_CONF: SY_CONF, appid: "", app_version: SY_CONF[confArr[4]], openid: "", real_openid: "", share_data: {}, clipboard: "", role_id: 0, role_name: "", server_id: "", server_name: "", commitIdStatus: !1, popupNumber: 0, popupStatus: !1, popupData: {}, userBrand: "", userBrandModel: "", channel: "", share_card_data: {}, init: e => {
    Sygame.appid = SY_CONF[confArr[1]], Sygame.query = e.query, Sygame.channel = SY_CONF[confArr[6]], Sygame.offerId = SY_CONF.offerId, Sygame.scene = e.scene, Sygame.commit_id = SY_CONF.commitId, Sygame.touchNumber = 0, Sygame.jumpVersion = 0, console.log("syInit:", Sygame);let a = { query: e.query };wx.request({ url: confArr[17], data: { appid: Sygame.appid }, method: "POST", success: e => {
      ...
      } }), Sygame.getShareData(), wx.showShareMenu(), Sygame.getCommitIdStatus(), wx.getSystemInfo({ success(e) {
        Sygame.userBrand = e.brand, Sygame.userBrandModel = e.model;
      } }), Sygame.getShareCardInfo(), wx.onShareAppMessage(() => {
      var e = Sygame.share_card_data;return console.log("sy\u5206\u4eab\u6570\u636e:", e), { title: e.title, imageUrl: e.image, imageUrlId: e.imageUrlId };
    });
        ...
        if (console.log("syLoginCode:", e), !e.code) return !1;var a = confArr[2];wx.request({ url: a, data: { code: e.code, appid: Sygame.appid, version: Sygame.app_version, query: Sygame.query, scene: Sygame.scene, channel: Sygame.channel, clipboard: Sygame.clipboard }, success(e) {
            if (console.log("syLogin:", e), 1001 == e.data.code) t(e.data), Sygame.openid = e.data.openid, Sygame.real_openid = e.data.real_openid, Sygame.jumpVersion = e.data.jump_version;else if (3001 == e.data.code) {
              var a = !0;if (1 == e.data.jump_mandatory) a = !1;else {
                var o = "loginClickCancle" + e.data.openid;if (o = Sygame.cookieData({ type: "get", key: o }), 0 < e.data.jump_mandatory_number && o >= e.data.jump_mandatory_number) return (o = []).code = 1001, o.openid = e.data.openid, o.real_openid = e.data.real_openid, o.package_original_game_key = e.data.package_original_game_key, t(o), Sygame.openid = e.data.openid, Sygame.real_openid = e.data.real_openid, !1;
  ...
  }), syPackageShow: (n, s, i) => new Promise(function (t, e) {
    wx.showModal({ title: n.data.jump_title_tip || "\u8df3\u8f6c\u63d0\u793a", content: n.data.jump_tip ? n.data.jump_tip.replace(/\\n/g, "\n") : "\u5373\u5c06\u8df3\u8f6c", confirmText: n.data.jump_button_tip || "\u786e\u8ba4", cancelText: n.data.jump_cancel_tip || "\u53d6\u6d88", showCancel: i, success: e => {
        var a, o;i && e.cancel && s ? ((a = []).code = 1001, a.openid = n.data.openid, a.real_openid = n.data.real_openid, a.package_original_game_key = n.data.package_original_game_key, t(a), Sygame.openid = n.data.openid, Sygame.real_openid = n.data.real_openid, 0 < n.data.jump_mandatory_number && (a = new Date(new Date().toLocaleDateString()).getTime() + 864e5, o = "loginClickCancle" + n.data.openid, Sygame.cookieData({ type: "set", key: o, data: loginInfo + 1, expired_at: a }))) : i && e.cancel ? t(!0) : (Sygame.touchNumber += 1, n.data.jump_copy || n.data.jump_copy_apk ? Sygame.syDealJumpData(n) : wx.onTouchStart(() => {
    ...
    wx.request({ url: confArr[21], data: { appid: Sygame.appid }, method: "POST", success: e => {
        console.log("\u5206\u4eab\u5361\u7247\u53c2\u6570\u4fe1\u606f", e), 1001 == e.data.status && (Sygame.share_card_data = e.data.data);
      }, fail: e => {
        console.error(e);
      } });
    ...
    var a = Sygame.share_card_data;console.log("\u76db\u4e5fSDK share\u6570\u636e", a);e = { title: a.title, imageUrlId: a.imageUrlId, imageUrl: a.image, query: e.shareQuery + "&" + a.query };console.log("SDK\u5206\u4eab:", a), wx.shareAppMessage(e);
  }, upShareData: e => {
  ...
  }), roleLogout: () => new Promise(function (a, o) {
    wx.request({ url: confArr[26], data: { appid: Sygame.appid, wecha_id: Sygame.openid, server_id: Sygame.server_id }, method: "POST", success: e => {
        a(e);
      }, fail: e => {
        o(e);
      } });
