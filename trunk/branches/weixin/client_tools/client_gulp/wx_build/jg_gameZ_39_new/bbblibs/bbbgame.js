console.info("0 \u8fdb\u5165\u6e38\u620f\u5305"), window.lastError, wx.onError(function (o) {
  if (o) {
    if (o.message) {
      var n = window.config.game_ver.replace(new RegExp(/\./, "g"), "_");var e = o.message;var i = e.match(/(bbbbbbbbb\/bbbgame.js:)[0-9]{1,60}(:)/g);if (i) for (var w = 0; w < i.length; w++) {
        var a;i[w] && 0 < i[w].length && (a = parseInt(i[w].replace("bbbbbbbbb/bbbgame.js:", "").replace(":", "")), e = e.replace(i[w], i[w].replace(":" + a + ":", ":" + (a - 2) + ":")));
      }e = (e = e.replace(new RegExp("bbbbbbbbb/bbbgame.js", "g"), "bbbbbbbbb/main__" + n + ".min.js")).replace(new RegExp("bbbbbbbbb/lsjdflaamain.js", "g"), "bbbbbbbbb/main__" + n + ".min.js"), o.message = e;
  ...
  if (!o || !n) return 0;o = o.split("."), n = n.split(".");var e = Math.max(o.length, n.length);for (; o.length < e;) o.push("0");for (; n.length < e;) n.push("0");for (var i = 0; i < e; i++) {
    var w = parseInt(o[i]),
        a = parseInt(n[i]);if (a < w) return 1;if (w < a) return -1;
  }return 0;
