import AKSDK from "../bbbk/bbbsdk.js";window.versions = { wxVersion: window.config.game_ver }, window.DEBUG = !1, window.PLATFORM = 1, window.ENV = 1, window.PACK = !0, window.WSS = !0, window.workerJsURL = "", window.isWaiFangWx = !1, window.PF_INFO = { base_cdn: "https://cdn-tjqy.shzbkj.com/weixin_0/", cdn: "https://cdn-tjqy.shzbkj.com/weixin_0/" }, PF_INFO.pay_infos = {}, PF_INFO.package = "0", PF_INFO.version = window.versions.wxVersion, PF_INFO.mac = "", PF_INFO.os = "1", PF_INFO.sdk_name = "9130", PF_INFO.apiurl = "https://api-tjqytest.shzbkj.com", PF_INFO.logurl = "https://log-tjqytest.shzbkj.com", PF_INFO.payurl = "https://pay-tjqytest.shzbkj.com", PF_INFO.apikey = "MQx0mYlUWO5XYKvgAIPKWgK1w722GKih", PF_INFO.partnerId = "1", PF_INFO.pkgName = "", PF_INFO.device_id = "", PF_INFO.from_scene = 0, PF_INFO.serverList = {}, PF_INFO.channelNum = parseInt(PF_INFO.partnerId), PF_INFO.channel = PF_INFO.partnerId, PF_INFO.selectedServer = {}, PF_INFO.clientlog = "https://jgcenter.sh9130.com/clientlog/", PF_INFO.showLogo = !1, PF_INFO.debugUsers = "39927500|58163716|74597555", PF_INFO.tick = Date.now(), PF_INFO.configType = "_weixin", PF_INFO.exposeType = "_a", PF_INFO.loadingType = 2, PF_INFO.lastVersion = 1985, PF_INFO.wxVersion = window.versions.wxVersion, PF_INFO.wxShield = !1, PF_INFO.wxIOS = !1, PF_INFO.wxAndroid = !1, PF_INFO.wxPC = !1, window.apiRetryAmount = 5, window.isCheckBan = !1, window.loadProbPkg = !1, window.loadMainPkg = !1, window.loadServerRes = !1, window.loadLoadingRes = !1, window.loadVersion = !1, window.loadOption = !1, window.loadServer = !1, window.bEnterGame = !1, window.sdkInitRes = null, window.alert = function (e) {
...
}, window.toAllProgress = function (e) {}, window.toProgress = function (e, n, r) {}, window.toEnterGame = function (e) {
  ...
  var n = e.develop;sdkInitRes = e, console.log("#\u521d\u59cb\u5316\u6210\u529f   \u63d0\u5ba1\u72b6\u6001:" + n + "   \u662f\u5426\u63d0\u5ba1:" + (1 == n) + "   \u63d0\u5ba1\u7248\u672c\u53f7:" + e.game_ver + "   \u5f53\u524d\u7248\u672c\u53f7:" + window.versions.wxVersion, "version_name:" + e.version_name), !e.game_ver || window.compareVersion(window.versions.wxVersion, e.game_ver) < 0 ? (console.log("#\u6b63\u5f0f\u7248============================="), PF_INFO.apiurl = "https://api-tjqy.shzbkj.com", PF_INFO.logurl = "https://log-tjqy.shzbkj.com", PF_INFO.payurl = "https://pay-tjqy.shzbkj.com", PF_INFO.cdn = "https://cdn-tjqy-fx.shzbkj.com/weixin_1/", PF_INFO.spareCdn = "https://cdn-tjqy-ali.shzbkj.com/weixin_1/", PF_INFO.version_name = e.version_name, PF_INFO.wxShield = !1) : 0 == window.compareVersion(window.versions.wxVersion, e.game_ver) ? (console.log("#\u5ba1\u6838\u7248============================="), PF_INFO.apiurl = "https://api-tjqytest.shzbkj.com", PF_INFO.logurl = "https://log-tjqytest.shzbkj.com", PF_INFO.payurl = "https://pay-tjqytest.shzbkj.com", PF_INFO.cdn = "https://cdn-tjqy-fx.shzbkj.com/weixin_0/", PF_INFO.spareCdn = "https://cdn-tjqy-ali.shzbkj.com/weixin_1/", PF_INFO.version_name = "weixin", PF_INFO.wxShield = !0) : (console.log("#\u5f00\u53d1\u7248============================="), PF_INFO.apiurl = "https://api-tjqytest.shzbkj.com", PF_INFO.logurl = "https://log-tjqytest.shzbkj.com", PF_INFO.payurl = "https://pay-tjqytest.shzbkj.com", PF_INFO.cdn = "https://cdn-tjqy-fx.shzbkj.com/weixin_0/", PF_INFO.spareCdn = "https://cdn-tjqy-ali.shzbkj.com/weixin_1/", PF_INFO.version_name = "weixin", PF_INFO.wxShield = !1), PF_INFO.from_scene = config.from || 0, this.loadVersionConfig(), this.reqPkgOptions(), window.sdkLoginRetry = 5, wxShowLoading({ title: "\u6b63\u5728\u767b\u5f55\u8d26\u53f7" }), AKSDK.login(this.sdkOnLogin.bind(this));
}, window.sdkLoginRetry = 5, window.sdkOnLogin = function (e, n) {
  0 == e && n && n.token ? (PF_INFO.sdk_token = n.token, wxShowLoading({ title: "\u6b63\u5728\u9a8c\u8bc1\u8d26\u53f7" }), sendApi(PF_INFO.apiurl, "User.login", { platform: PF_INFO.sdk_name, partner_id: PF_INFO.partnerId, token: n.token, game_pkg: PF_INFO.pkgName, deviceId: PF_INFO.device_id, scene: "WX_" + PF_INFO.from_scene }, this.onUserLogin.bind(this), apiRetryAmount, onApiError)) : n && n.errMsg && 0 < window.sdkLoginRetry && (-1 != n.errMsg.indexOf("fail interrupted") || -1 != n.errMsg.indexOf("network api interrupted") || -1 != n.errMsg.indexOf("Network Error") || -1 != n.errMsg.indexOf("ERR_TIMED_OUT") || -1 != n.errMsg.indexOf("ERR_CONNECTION_ABORTED") || -1 != n.errMsg.indexOf("ERR_CONNECTION_RESET")) ? (window.sdkLoginRetry--, AKSDK.login(this.sdkOnLogin.bind(this))) : (window.toErrorAlarm(1, "AKSDK.login fail: status=" + e + ",errMsg=" + (n ? n.errMsg : "")), window.reqRecordInfo("sdkOnLoginError", JSON.stringify({ status: e, data: n })), window.loginAlert("\u767b\u5f55/\u6ce8\u518c\u5931\u8d25" + (n && n.errMsg ? "\uff0c" + n.errMsg : "")));
}, window.onUserLogin = function (e) {
  if (!e) return window.toErrorAlarm(2, "User.login fail: response is null"), window.reqRecordInfo("userLoginError", "response is null"), void window.loginAlert("User.login failed");if ("success" != e.state) return window.toErrorAlarm(2, "User.login fail: state=" + e.state), window.reqRecordInfo("userLoginError", JSON.stringify(e)), void window.loginAlert("User.login failed: " + e.state);PF_INFO.userId = String(e.account), PF_INFO.account = String(e.account), PF_INFO.platform = String(e.platform), PF_INFO.channel = String(e.platform), PF_INFO.platform_uid = String(e.platform_uid), PF_INFO.php_sign = String(e.sign), PF_INFO.php_signtime = String(e.time), PF_INFO.sign = "";wxShowLoading({ title: "\u8bf7\u6c42\u670d\u52a1\u5668" });e = localStorage.getItem("LastSer_" + PF_INFO.pkgName + PF_INFO.account);e && "" != e ? (e = Number(e), this.getCheckServers(e)) : this.getDefaultServers();
  ...
  return e ? "success" != e.state ? (window.toErrorAlarm(3, "Server.defaultServer failed: " + e.state), void window.loginAlert("Server.defaultServer failed: " + e.state)) : e.data && 0 != e.data.length ? void this.updCurServer(e) : (window.toErrorAlarm(3, "Server.defaultServer failed: data null"), void window.loginAlert("\u670d\u52a1\u5668\u5c1a\u672a\u5f00\u542f")) : (window.toErrorAlarm(3, "Server.defaultServer failed"), void window.loginAlert("Server.defaultServer failed"));
  ...
  return e ? "success" != e.state ? (window.toErrorAlarm(4, "Server.check_server failed: " + e.state), void this.getDefaultServers()) : e.data && 0 != e.data.length ? (this.updCurServer(e), void (window.ServerLoading && window.ServerLoading.instance.openJumpTipsBtn && window.ServerLoading.instance.openJumpTipsBtn(sdkInitRes.isShowSdkAge, sdkInitRes.sdk_age_adaptation_icon, sdkInitRes.sdk_age_adaptation_content, sdkInitRes.coordinate_x, sdkInitRes.coordinate_y))) : (window.toErrorAlarm(4, "Server.check_server failed: data null"), void this.getDefaultServers()) : (window.toErrorAlarm(4, "Server.check_server failed"), void this.getDefaultServers());
}, window.updCurServer = function (e) {
  PF_INFO.newRegister = null != e.is_new ? e.is_new : 0, PF_INFO.selectedServer = { server_id: String(e.data[0].server_id), server_name: String(e.data[0].server_name), entry_ip: e.data[0].entry_ip, entry_port: parseInt(e.data[0].entry_port), status: get_status(e.data[0]), start_time: e.data[0].start_time, maintain_time: e.data[0].maintain_time || "", cdn: PF_INFO.cdn }, this.initComplete();
}, window.initComplete = function () {
  if (1 == PF_INFO.newRegister) {
    var e = PF_INFO.selectedServer.status;if (-1 === e || 0 === e) return window.toErrorAlarm(15, "new register selectedServer status error: id=" + PF_INFO.selectedServer.id + ",status=" + PF_INFO.selectedServer.status), void window.loginAlert(-1 === e ? "\u5f53\u524d\u670d\u52a1\u5668\u5728\u7ef4\u62a4\u4e2d" : "\u5f53\u524d\u670d\u52a1\u5668\u5c1a\u672a\u5f00\u542f\uff0c\u656c\u8bf7\u671f\u5f85");req_server_check_ban(0, PF_INFO.selectedServer.server_id), window.ServerLoading.instance.openLoading(PF_INFO.newRegister);
  ...
  return e ? "success" != e.state ? (window.toErrorAlarm(5, "User.getCdnVersion failed: state=" + e.state), void window.loginAlert("User.getCdnVersion failed: state=" + e.state)) : e.data && e.data.version ? (e.data.cdn_url && 10 < e.data.cdn_url.length && (PF_INFO.base_cdn = e.data.cdn_url, PF_INFO.cdn = e.data.cdn_url), e.data.version && (PF_INFO.lastVersion = e.data.version), console.info("lastVersion:" + PF_INFO.lastVersion + ", version_name:" + PF_INFO.version_name), window.loadVersion = !0, window.initMain(), void window.enterToGame()) : (window.toErrorAlarm(5, "User.getCdnVersion failed: version=" + (e.data && e.data.version)), void window.loginAlert("User.getCdnVersion failed: version=" + (e.data && e.data.version))) : (window.toErrorAlarm(5, "User.getCdnVersion failed"), void window.loginAlert("User.getCdnVersion failed"));
  ...
  if (e && "success" === e.state && e.data) for (var n in window.pkgOptions = e.data, e.data) PF_INFO[n] = e.data[n];else window.toErrorAlarm(11, "Common.get_option_pkg failed"), console.info("reqPkgOptionsCallBack " + e.state);window.loadOption = !0, window.enterToGame();
}, window.toPay = function (e, n, r, o, i, t, a, d, s, w) {
  i = String(i);PF_INFO.pay_infos[i] = { productid: i, productname: a, productdesc: d, roleid: e, rolename: n, rolelevel: r, price: t, callback: s }, sendApi(PF_INFO.payurl, "Order.order", { game_pkg: PF_INFO.pkgName, server_id: PF_INFO.selectedServer.server_id, server_name: PF_INFO.selectedServer.server_name, level: r, uid: PF_INFO.account, role_id: e, role_name: n, product_id: i, product_name: a, product_desc: d, money: t, partner_id: PF_INFO.partnerId }, toPayCallBack, apiRetryAmount, onApiError);
}, window.toPayCallBack = function (r) {
  var e, o;!r || 200 !== r.errCode && "success" != r.state ? (e = r ? "errCode=" + r.errCode + ",state=" + r.state + ",info=" + r.info : "\u83b7\u53d6\u8ba2\u5355\u5931\u8d25", window.toErrorAlarm(13, "Order.order fail: " + e), alert(e)) : ((o = PF_INFO.pay_infos[String(r.product_id)]).callback && o.callback(r.product_id, r.cp_order_id, -1), AKSDK.pay({ cpbill: r.cp_order_id, productid: r.product_id, productname: o.productname, productdesc: o.productdesc, serverid: PF_INFO.selectedServer.server_id, servername: PF_INFO.selectedServer.server_name, roleid: o.roleid, rolename: o.rolename, rolelevel: o.rolelevel, price: o.price, extension: JSON.stringify({ cp_order_id: r.cp_order_id }) }, function (e, n) {
    o.callback && 0 == e && o.callback(r.product_id, r.cp_order_id, e), console.info(JSON.stringify({ type: "paycallback", status: e, data: r, role_name: o.rolename }));
  }));
}, window.loadCreateRole = function () {}, window.toCreate = function (e, n, r, o, i) {
  AKSDK.logCreateRole(PF_INFO.selectedServer.server_id, PF_INFO.selectedServer.server_name || PF_INFO.selectedServer.server_id, e, n, r), sendApi(PF_INFO.apiurl, "User.create_role", { game_pkg: PF_INFO.pkgName, server_id: PF_INFO.selectedServer.server_id, role_id: e, uid: PF_INFO.account, role_name: n, role_type: o, level: r });
}, window.toLogin = function (e, n, r, o, i, t, a, d, s, w) {
  PF_INFO.roleId = e, PF_INFO.roleName = n, PF_INFO.roleLevel = r, AKSDK.logEnterGame(PF_INFO.selectedServer.server_id, PF_INFO.selectedServer.server_name || PF_INFO.selectedServer.server_id, e, n, r), sendApi(PF_INFO.apiurl, "User.update_role", { game_pkg: PF_INFO.pkgName, server_id: PF_INFO.selectedServer.server_id, role_id: e, uid: PF_INFO.account, role_name: n, role_type: o, level: r, evolution: i });
}, window.toLevelUp = function (e, n, r, o, i, t, a, d, s, w) {
  PF_INFO.roleId = e, PF_INFO.roleName = n, PF_INFO.roleLevel = r, AKSDK.logRoleUpLevel(PF_INFO.selectedServer.server_id, PF_INFO.selectedServer.server_name || PF_INFO.selectedServer.server_id, e, n, r), sendApi(PF_INFO.apiurl, "User.update_role", { game_pkg: PF_INFO.pkgName, server_id: PF_INFO.selectedServer.server_id, role_id: e, uid: PF_INFO.account, role_name: n, role_type: o, level: r, evolution: i });
  ...
  AKSDK.weiduanHelper();
}, window.reqSMSCode = function (e, n, r, o, i, t, a, d) {
...
}, window.reqPlayerAskInfo = function (e, n, r, o) {
  window.send("https://sdk.sh9130.com/game/?ct=min&ac=getInviter", { game_pkg: window.PF_INFO.pkgName, role_id: n, server_id: r }, o);
}, window.openSubscribeMsg = function (i, d, s) {
  wx.onTouchEnd(function onTouchEnd(e) {
    var t = [];var n = [];var a = s || window.config.tmpId;for (var r in a) {
      var o = Number(r);i && i.length && -1 == i.indexOf(o) || (n.push(a[r]), t.push([o, 3]));
      ...
      if (console.log("\u8ba2\u9605\u56de\u8c03\uff1a"), console.log(e), e && "requestSubscribeMessage:ok" == e.errMsg) for (var n in a) if ("accept" == e[a[n]]) {
        var r = Number(n);for (var o = 0; o < t.length; o++) if (t[o][0] == r) {
          t[o][1] = 1;break;
        }
          ...
          var n = e.subscriptionsSetting.itemSettings;if (n) {
            for (var r in console.log("\u83b7\u5f97\u8ba2\u9605\u8bbe\u7f6e\uff1a"), console.log(n), a) if ("accept" == n[a[r]]) {
              var o = Number(r);for (var i = 0; i < t.length; i++) if (t[i][0] == o) {
                t[i][1] = 2;break;
              }
            }console.log(t), d && d(t);
...
}, window.batteryInfo = { isSuccess: !1, level: "100", isCharging: !1 }, window.getBatteryInfo = function (r) {
  wx.getBatteryInfo({ success: function (e) {
      var n = window.batteryInfo;n.isSuccess = !0, n.level = Number(e.level).toFixed(0), n.isCharging = e.isCharging, r && r(n.isSuccess, n.level, n.isCharging);
    }, fail: function (e) {
      console.log("\u8c03\u7528\u83b7\u53d6\u7535\u6c60\u4fe1\u606f\u5931\u8d25", e.errMsg);e = window.batteryInfo;r && r(e.isSuccess, e.level, e.isCharging);
    } });
...
}, window.send = function (r, o, i, t, a, d, e, n) {
  null == t && (t = 1), wx.request({ url: r, method: e || "GET", responseType: "text", data: o, header: { "content-type": n || "application/json" }, success: function (e) {
      var n;e && 200 == e.statusCode ? (n = e.data, !d || d(n) ? i && i(n) : window.sendFail(r, o, i, t, a, d, e)) : window.sendFail(r, o, i, t, a, d, e);
    }, fail: function (e) {
      window.sendFail(r, o, i, t, a, d, e);
    }, complete: function () {} });
}, window.sendFail = function (e, n, r, o, i, t, a) {
  0 < o - 1 ? setTimeout(function () {
    window.send(e, n, r, o - 1, i, t);
  }, 1e3) : i && i(JSON.stringify({ url: e, response: a }));
}, window.sendApi = function (e, n, r, o, i, l, c) {
  r = r || {};var t = Math.floor(Date.now() / 1e3);r.time = t, r.method = n;var a = Object.keys(r).sort();var d = "";var s = "";for (var w = 0; w < a.length; w++) d = d + (0 == w ? "" : "&") + a[w] + r[a[w]], s = s + (0 == w ? "" : "&") + a[w] + "=" + encodeURIComponent(r[a[w]]);d += PF_INFO.apikey;t = "sign=" + md5(d);send(e + "?" + s + ("" == s ? "" : "&") + t, null, o, i, l, c || function (e) {
    return "success" == e.state;
  }, null, "application/x-www-form-urlencoded");
}, window.onRoleRecordStep = function (e, n) {
  var r = 0;PF_INFO.selectedServer && (r = PF_INFO.selectedServer.server_id), sendApi(PF_INFO.logurl, "UserLog.reportUidStep", { partnerId: PF_INFO.partnerId, gamePkg: PF_INFO.pkgName, logTime: Math.floor(Date.now() / 1e3), platformUid: PF_INFO.platform_uid, type: e, serverId: r }, null, 2, null, function () {
    return !0;
  });
  ...
  e && "success" === e.state && e.data ? (e.data.unshift({ id: -2, name: "\u6700\u65b0\u670d" }), e.data.unshift({ id: -1, name: "\u5df2\u6709\u89d2\u8272" }), PF_INFO.groupList = e.data, window.initPanel && window.initPanel.showGroupList()) : (PF_INFO.hasGroupReq = !1, e = e ? e.state : "", window.toErrorAlarm(7, "Server.getServerGroup fail: " + e), window.loginAlert("reqServerGroupCallBack " + e));
  ...
  if (PF_INFO.hasServerReq = !1, e && "success" === e.state && e.data) {
    ...
    var r = e ? e.state : "";window.toErrorAlarm(8, "Server.getServerByUid fail: " + r), window.loginAlert("reqServerOwnerCallBack " + r);
  }
  ...
  if (PF_INFO.hasServerReq = !1, e && "success" === e.state && e.data && e.data.data) {
    var n = e.data.server_group_id;var r = [];for (var o = 0; o < e.data.data.length; o++) e.data.data[o].status = get_status(e.data.data[o]), 0 != r.length && 0 == e.data.data[o].status || (r[r.length] = e.data.data[o]);PF_INFO.serverList[n] = window.changeServerName(r), window.initPanel.showServerList(n);
  } else {
    n = e ? e.state : "";window.toErrorAlarm(9, "Server.getServerByGroup fail: " + n), window.loginAlert("reqServerListCallBack " + n);
  }
  ...
  if (PF_INFO.hasServerReq = !1, e && "success" === e.state && e.data) {
    ...
    var r = e ? e.state : "";window.toErrorAlarm(10, "Server.getRecommendServerList fail: " + r), alert("reqServerRecommendCallBack " + r);
  }
}, window.changeServerName = function (e) {
  return e;
...
}, window.req_multi_server_notice = function (e, n, r, o) {
  r = r || PF_INFO.selectedServer.server_id, sendApi(PF_INFO.apiurl, "Common.get_new_anno", { type: e, game_pkg: n, server_id: r }, o);
