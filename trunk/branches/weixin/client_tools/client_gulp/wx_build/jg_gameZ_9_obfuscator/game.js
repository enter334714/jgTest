var H = wx.$F;
import 'xv2/z999z999E4z999z999.js';console.info("1 \u521d\u59cb\u5316");
...
var image = new Image();
image.src = "z999z999lgrz999z999/z999z99922b.png";
...
render();
window.f1KA$2I = setInterval(function () {
  render();
}, 16);
wx.showLoading({ title: "\u6b63\u5728\u52a0\u8f7d" });
wx.y$ = [];var fs = wx.getFileSystemManager();wx.getFileSystemManager().unzip({
  zipFilePath: "/Z91es/Z91iles.zip", targetPath: wx.env.USER_DATA_PATH + "/f/", success: r => {
      ...
      filePath: wx.env.USER_DATA_PATH + "/f/files", encoding: "utf8", success: function (r) {
        if ("readFile:ok" == r.errMsg && r.data) {
          try {
            ...
            name: 'z9992Iz9992', success: function (r) {
...
wx.onShow(function (res) {
  window.f1IA = res;
  if (window.f12AI && window.f1IA) {
    console.info("小游戏切前台事件，场景值：" + window.f1IA.scene);
    window.f12AI(window.f1IA);
    window.f1IA = null;
  }
});