var q1 = wx.f$;
import 'ucadr/a9yvv.js';console.info("1 \u521d\u59cb\u5316");
...
render();
window._lMIO16 = setInterval(function () {
  render();
}, 16);
wx.showLoading({ title: "\u6b63\u5728\u52a0\u8f7d" });
wx.y$ = [];var fs = wx.getFileSystemManager();wx.getFileSystemManager().unzip({
  zipFilePath: "/tq/vlc.zip", targetPath: wx.env.USER_DATA_PATH + "/f/", success: r => {
...
wx.onShow(function (res) {
  window._l6I = res;
  if (window._l1I6 && window._l6I) {
    console.info("小游戏切前台事件，场景值：" + window._l6I.scene);
    window._l1I6(window._l6I);
    window._l6I = null;
  }
});