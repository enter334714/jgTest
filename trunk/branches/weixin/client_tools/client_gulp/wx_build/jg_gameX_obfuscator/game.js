...
render();
window.x1T$9J6 = setInterval(function () {
  render();
}, 16);
...
wx.onShow(function (res) {
  window.x19$J = res;
  if (window.x19J$ && window.x19$J) {
    console.info("小游戏切前台事件，场景值：" + window.x19$J.scene);
    window.x19J$(window.x19$J);
    window.x19$J = null;
  }
});