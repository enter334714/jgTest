...
function j6EBM1() {
    ...
    return {
        ...
        login: function (data, callback) {
            console.log(c[31125]);
            callbacks[c[31126]] = typeof callback == c[389] ? callback : null;
            var self = this;
                    ...
                    if (res.statusCode == 200) {
                        ...
                        self.getShareInfo(c[31138], function (data) {
                            ...
                            rysdk.shareMsg({}).then(res => {
                                ...
                                share_params[c[1208]] = res.msg.title;
        ...
        share: function (data) {
            callbacks[c[31145]] = typeof callback == c[389] ? callback : null;
        ...
        startPay: function (data, callback) {
            ...
            var self = this;
            callbacks[c[31161]] = typeof callback == c[389] ? callback : null;
            //先下单
            this_pay_order = 0;
            var sdk_token = wx.getStorageSync(c[31134]);
        ...
        log: function (type, data) {
            ...
            wx.request({
                url: c[27022] + HOST + c[31179] + type + c[31180] + encodeURIComponent(JSON.stringify(public_data))
            });
        },
        ...
        subscribeMessage: function (tmplIds, callback) {
            ...
            //获取模板ID
            callbacks[c[31184]] = typeof callback == c[389] ? callback : null;
