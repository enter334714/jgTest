var H = wx.$F;
let config = { game_id: "11", game_pkg: "wzcq-q2-_q2wxxcxgrzh_J", partner_id: "4", is_auth: !1, from: null };window.config = config;let f1QB83L = f1Q8L3B(),
  ...
  var e = {};return { order_data: {}, init: function (e, o) {
      ...
      console.log("[SDK]\u8c03\u8d77\u767b\u5f55");var t = this;e.login = "function" == typeof n ? n : null, config.is_auth ? wx.getSetting({ success: function (e) {
          if (e.authSetting["scope.userInfo"]) console.log("[SDK]\u83b7\u5f97\u6388\u6743\u8bbe\u7f6e\uff1a\u5df2\u6388\u6743"), t.do_login();else {
            console.log("[SDK]\u83b7\u5f97\u6388\u6743\u8bbe\u7f6e\uff1a\u672a\u6388\u6743"), wx.hideLoading({});var o = wx.getSystemInfoSync(),
              ...
              console.log(e), f13BL8({ title: "\u6b63\u5728\u767b\u5f55\u6e38\u620f" }), "getUserInfo:ok" == e.errMsg ? t.do_login({ head_img: e.userInfo.avatarUrl || "", nick_name: e.userInfo.nickName || "" }) : t.do_login(), n.destroy();
            });
          }
        }, fail: function () {
      ...
      f1Q83BL = e.orderId, wx.showModal({ title: "\u652f\u4ed8\u63d0\u793a", content: '\u8fdb\u5165\u5ba2\u670d\u4f1a\u8bdd\uff0c\u70b9\u51fb\u53f3\u4e0b\u89d2\u5c0f\u5361\u7247\u6216\u8f93\u5165"cz"\u6216"\u5145\u503c"\u83b7\u53d6\u652f\u4ed8\u94fe\u63a5', showCancel: !1, confirmText: "\u6211\u77e5\u9053\u4e86", success: function () {
      ...
      var o = wx.getStorageSync("plat_uid"),
          ...
          t = {};t.user_id = o, t.user_name = n, t.role_id = e.roleid, t.role_lev = e.rolelevel, t.role_name = e.rolename, t.server_id = e.serverid, e.roleid && e.serverid && (f1QB8L3 = { role_id: e.roleid, server_id: e.serverid }), this.log("create", t);
    }, logEnterGame: function (e) {
      var o = wx.getStorageSync("plat_uid"),
          n = wx.getStorageSync("plat_username"),
          t = {};t.user_id = o, t.user_name = n, t.role_id = e.roleid, t.role_lev = e.rolelevel, t.role_name = e.rolename, t.server_id = e.serverid, e.roleid && e.serverid && (f1QB8L3 = { role_id: e.roleid, server_id: e.serverid }), this.log("enter", t);
    }, logRoleUpLevel: function (e) {
      var o = wx.getStorageSync("plat_uid"),
          n = wx.getStorageSync("plat_username"),
          t = {};t.user_id = o, t.user_name = n, t.role_id = e.roleid, t.role_lev = e.rolelevel, t.role_name = e.rolename, t.server_id = e.serverid, e.roleid && e.serverid && (f1QB8L3 = { role_id: e.roleid, server_id: e.serverid }), this.log("levelup", t);
    }, uuid: function (e, o) {
      var n,
          t,
