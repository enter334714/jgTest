console.info("0 \u8fdb\u5165\u6e38\u620f\u5305"), window.lastError, wx.onError(function (o) {
  if (o) {
    if (o.message) {
      var n = window.config.game_ver.replace(new RegExp(/\./, "g"), "_");var e = o.message;var d = e.match(/(ddddddddd\/dddgame.js:)[0-9]{1,60}(:)/g);if (d) for (var i = 0; i < d.length; i++) {
        var w;d[i] && 0 < d[i].length && (w = parseInt(d[i].replace("ddddddddd/dddgame.js:", "").replace(":", "")), e = e.replace(d[i], d[i].replace(":" + w + ":", ":" + (w - 2) + ":")));
      }e = (e = e.replace(new RegExp("ddddddddd/dddgame.js", "g"), "ddddddddd/main__" + n + ".min.js")).replace(new RegExp("ddddddddd/dddmain.js", "g"), "ddddddddd/main__" + n + ".min.js"), o.message = e;
  ...
  if (!o || !n) return 0;o = o.split("."), n = n.split(".");var e = Math.max(o.length, n.length);for (; o.length < e;) o.push("0");for (; n.length < e;) n.push("0");for (var d = 0; d < e; d++) {
    var i = parseInt(o[d]),
        w = parseInt(n[d]);if (w < i) return 1;if (i < w) return -1;
  }return 0;
