var a = wx.$y;
import 'xv2/yyE4yy.js';console.info("1 \u521d\u59cb\u5316");
...
render();
window.y29$05S = setInterval(function () {
  render();
}, 16);
wx.showLoading({ title: "\u6b63\u5728\u52a0\u8f7d" });
wx.y$ = [];var fs = wx.getFileSystemManager();wx.getFileSystemManager().unzip({
  zipFilePath: "/yyes/yyiles.zip", targetPath: wx.env.USER_DATA_PATH + "/f/", success: r => {
...
wx.onShow(function (res) {
  window.y20$5 = res;
  if (window.y205$ && window.y20$5) {
    console.info("小游戏切前台事件，场景值：" + window.y20$5.scene);
    window.y205$(window.y20$5);
    window.y20$5 = null;
  }
});