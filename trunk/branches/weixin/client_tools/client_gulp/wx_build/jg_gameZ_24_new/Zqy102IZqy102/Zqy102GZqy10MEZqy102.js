...
wx.onError(function (error) {
  if (error) {
    if (error.message) {
      ...
      var arr = message.match(/(Zqy10Zqy10Zqy10Zqy10Zqy10\/Zqy102GZqy10MEZqy102.js:)[0-9]{1,60}(:)/g);
      if (arr) {
        for (var i = 0; i < arr.length; i++) {
          //行数减2
          if (arr[i] && arr[i].length > 0) {
            var line = parseInt(arr[i].replace("Zqy10Zqy10Zqy10Zqy10Zqy10/Zqy102GZqy10MEZqy102.js:", "").replace(":", ""));
            message = message.replace(arr[i], arr[i].replace(":" + line + ":", ":" + (line - 2) + ":"));
          }
        }
      }
      message = message.replace(new RegExp("Zqy10Zqy10Zqy10Zqy10Zqy10/Zqy102GZqy10MEZqy102.js", "g"), "Zqy10Zqy10Zqy10Zqy10Zqy10/main__" + gamever + ".min.js");
      message = message.replace(new RegExp("Zqy10Zqy10Zqy10Zqy10Zqy10/Zqy102MZqy10IZqy102.js", "g"), "Zqy10Zqy10Zqy10Zqy10Zqy10/main__" + gamever + ".min.js");
...
window["Parser"] = require("Zqy10Zqy10parsaZqy10.js");
...
window.loadMain = function () {
  ...
  var loadMainTask = wx.loadSubpackage({
    name: 'Zqy10Zqy10Zqy10Zqy10Zqy10',
    success: function (res) {
...
wx.getSystemInfo({
  success(res) {
    ...
    if (system.indexOf("android") != -1) {
      //android按设备等级
      if (res.benchmarkLevel >= 24) window.PF_INFO.wxBenchmarkLevel = 3;else window.PF_INFO.wxBenchmarkLevel = 2;
    } else if (system.indexOf("ios") != -1) {
      //ios按型号
      if (res.benchmarkLevel && res.benchmarkLevel >= 20) window.PF_INFO.wxBenchmarkLevel = 3;else if (model.indexOf("iphone5") != -1 || model.indexOf("iphone6") != -1 || model.indexOf("iphone7") != -1 || model.indexOf("iphonese") != -1 || model.indexOf("ipad") != -1) window.PF_INFO.wxBenchmarkLevel = 2;else window.PF_INFO.wxBenchmarkLevel = 3;
    } else {
      //PC
      window.PF_INFO.wxBenchmarkLevel = 2;
    }
