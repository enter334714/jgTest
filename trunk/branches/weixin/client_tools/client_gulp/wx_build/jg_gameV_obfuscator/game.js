...
render();
window._vNQUCG = setInterval(function () {
  render();
}, 16);
...
wx.onShow(function (res) {
  window._vUQC = res;
  if (window._vUCQ && window._vUQC) {
    console.info("小游戏切前台事件，场景值：" + window._vUQC.scene);
    window._vUCQ(window._vUQC);
    window._vUQC = null;
  }
});