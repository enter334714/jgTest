...
wx.onError(function (error) {
  if (error) {
    if (error.message) {
      ...
      var arr = message.match(/(qmmmq\/qGAMEqq.js:)[0-9]{1,60}(:)/g);
      if (arr) {
        for (var i = 0; i < arr.length; i++) {
          //行数减2
          if (arr[i] && arr[i].length > 0) {
            var line = parseInt(arr[i].replace("qmmmq/qGAMEqq.js:", "").replace(":", ""));
            message = message.replace(arr[i], arr[i].replace(":" + line + ":", ":" + (line - 2) + ":"));
          }
        }
      }
      message = message.replace(new RegExp("qmmmq/qGAMEqq.js", "g"), "qmmmq/main__" + gamever + ".min.js");
      message = message.replace(new RegExp("qmmmq/qqMAINqq.js", "g"), "qmmmq/main__" + gamever + ".min.js");
...
import "qsfs32q.js";
import "qq12qq.js";
window["Parser"] = require("qqparseq.js");
import "qINDEXq.js";
import "qqLIB12q.js";
import "qWXMsadqq.js";
