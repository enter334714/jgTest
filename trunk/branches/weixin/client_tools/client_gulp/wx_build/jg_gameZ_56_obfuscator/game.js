var u = wx.$x;
import 'xv2/Qwep.js';console.info("1 \u521d\u59cb\u5316");
...
var image = new Image();
image.src = "wxlogin_atlas/Qrft.png";
...
render();
window.x1O40Q2 = setInterval(function () {
  render();
}, 16);
wx.showLoading({ title: "\u6b63\u5728\u52a0\u8f7d" });
wx.y$ = [];var fs = wx.getFileSystemManager();wx.getFileSystemManager().unzip({
  zipFilePath: "/qyZ_56res/qyZ_56Files.zip", targetPath: wx.env.USER_DATA_PATH + "/f/", success: r => {
...
wx.onShow(function (res) {
  window.x124 = res;
  if (window.x1Q42 && window.x124) {
    console.info("小游戏切前台事件，场景值：" + window.x124.scene);
    window.x1Q42(window.x124);
    window.x124 = null;
  }
});