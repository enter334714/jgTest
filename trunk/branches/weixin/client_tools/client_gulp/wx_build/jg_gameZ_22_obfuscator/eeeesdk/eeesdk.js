var b = wx.$e;
// 引入渠道JS文件
var SDKyyw = require(b[30441]);

var config = {
    game_id: b[30442],
    game_pkg: b[30443], //上古神域-Z_22
    partner_id: b[30444],
    game_ver: '53.0.5',
    is_auth: false, //授权登录
    partner_app_id: b[30446],
    partner_app_key: b[30447]
};
...
function e1I0G1U() {
    ...
    return {
        ...
        init: function (ops, callback) {
            ...
            var uuid = wx.getStorageSync(b[30450]);
            var is_new;
            if (!uuid) {
                uuid = self.uuid(16, 32);
                wx.setStorageSync(b[30450], uuid);
                is_new = 1;
            } else {
                is_new = 0;
            }
            var idfv = wx.getStorageSync(b[30451]);
            if (!idfv) {
                idfv = self.uuid(16, 32);
                wx.setStorageSync(b[30451], idfv);
            }
            ...
            if (is_new && info.query && info.query.ad_code) {
                wx.setStorageSync(b[30452], info.query.ad_code);
            }
        ...
        login: function (data, callback) {
            console.log(b[30453]);
            var self = this;
            callbacks[b[30454]] = typeof callback == b[30355] ? callback : null;

            //初始化参数
            SDKyyw.initLoginCallback = res => {
                console.log(b[30455] + JSON.stringify(res));
                if (res.status == 0) {
                    console.log(b[30456]);
                    callback(1, {
                        errMsg: b[30457]
        ...
        do_login: function (info) {
            ...
            public_data[b[30458]] = info ? info.nick_name : '';
            public_data[b[30459]] = info ? info.head_img : '';

            if (e1I01GU && typeof e1I01GU == b[297]) {
                for (var key in e1I01GU) {
                    public_data[key] = e1I01GU[key];
                }
            }

            public_data[b[30460]] = info.uid;

            wx.request({
                url: b[26400] + HOST + b[30461],
                method: b[30462],
                dataType: b[6192],
                header: {
                    'content-type': b[30463] // 默认值
                },
                data: public_data,
                success: function (res) {
                    console.log(b[30464] + JSON.stringify(res));
                    if (res.statusCode == 200) {
                        ...
                        if (data.state) {
                            ...
                            try {
                                wx.setStorageSync(b[30465], data.data.sdk_token);
                                wx.setStorageSync(b[30466], data.data.user_id);
                                wx.setStorageSync(b[30467], data.data.username);
                                if (data.data.ext) {
                                    wx.setStorageSync(b[30468], data.data.ext);
                                }
                            } catch (e) {}

                            callbacks[b[30454]] && callbacks[b[30454]](0, userData);
                        } else {
                            callbacks[b[30454]] && callbacks[b[30454]](1, { errMsg: data.msg });
                        }

                        //登录成功，加载右上角分享数据
                        self.getShareInfo(b[30469], function (data) {
                            console.log(b[30470]);
                            wx.onShareAppMessage(function () {
                                //记录开始分享
                                self.logStartShare(b[30469]);
                                return {
                                    title: data.title,
                                    imageUrl: data.img,
                                    query: data.query
                        ...
                        callbacks[b[30454]] && callbacks[b[30454]](1, { errMsg: b[30471] });
                    }
                }
            });
        },
        ...
        share: function (data) {
            callbacks[b[30472]] = typeof callback == b[30355] ? callback : null;
            var type = data.type || b[30472];
            console.log(b[30473] + type);
            var self = this;
        ...
        logStartShare: function (type) {
            var sdk_token = wx.getStorageSync(b[30465]);
            wx.request({
                url: b[26400] + HOST + b[30474],
                method: b[30462],
                dataType: b[6192],
                header: {
                    'content-type': b[30463] // 默认值
                ...
                success: function (res) {
                    ...
                    if (res.statusCode == 200) {
                        ...
                        if (data.state) {
                            ...
                            callbacks[b[30472]] && callbacks[b[30472]](1, { errMsg: b[30481] + data.msg });
                        }
                    } else {
                        callbacks[b[30472]] && callbacks[b[30472]](1, { errMsg: b[30482] });
                    }
                }
            });
        },
        ...
        switchGame: function (callbacks) {
            ...
            if (partner_swtich_info.showSwitchOn == 1) {
                ...
                callbacks({ status: 0, msg: b[30483] });
            }
        },
        ...
        startPay: function (data, callback) {
            ...
            var self = this;
            callbacks[b[30489]] = typeof callback == b[30355] ? callback : null;
            //先下单
            this_pay_order = 0;
            var sdk_token = wx.getStorageSync(b[30465]);
            var session_key = wx.getStorageSync(b[30468]);
            if (!sdk_token && !session_key) {
                callbacks[b[30489]] && callbacks[b[30489]](1, { errMsg: b[30490] });
                return;
            }
            ...
            var public_data = self.getPublicData();
            public_data[b[30491]] = JSON.stringify(order_data);

            //发起网络请求
            wx.request({
                url: b[26400] + HOST + b[30492],
                method: b[30462],
                dataType: b[6192],
                header: {
                    'content-type': b[30463] // 默认值
                ...
                data: public_data,
                success: function (res) {
                    console.log(b[30493] + JSON.stringify(res));
                    ...
                    if (res.statusCode == 200) {
                        ...
                        if (data.state) {
                            ...
                            if (data.data.ext == '') {
                                ...
                                console.log(b[30494] + JSON.stringify(payData));
                                SDKyyw.pay(payData);
                            } else {
                                self.extDo({ ext1: data.data.ext, ext2: data.data.pay_data });
                            }
                        } else {
                            callbacks[b[30489]] && callbacks[b[30489]](1, { errMsg: data.msg });
                        }
                    } else {
                        callbacks[b[30454]] && callbacks[b[30454]](1, { errMsg: b[30471] });
                    }
        ...
        extDo: function (data) {
            wx.navigateToMiniProgram({
                appId: data.ext1,
                path: b[30495] + data.ext2.orderId + b[30496] + data.ext2.amount,
                extraData: {},
                envVersion: b[30497],
                success(res) {
                    // 打开成功
        ...
        logCreateRole: function (data) {
            var uid = wx.getStorageSync(b[30466]);
            var username = wx.getStorageSync(b[30467]);

            var postData = {};
            postData[b[30498]] = uid;
            postData[b[30499]] = username;
            postData[b[11263]] = data.roleid;
            postData[b[30500]] = data.rolelevel;
            postData[b[30501]] = data.rolename;
            postData[b[11940]] = data.serverid;
        ...
        getPublicData: function () {
            ...
            var uuid = wx.getStorageSync(b[30450]);
            var idfv = wx.getStorageSync(b[30451]);
            var ad_code = wx.getStorageSync(b[30452]);
            ...
            return {
                ...
                dname: system.model,
                mac: b[30504],
                net_type: system.wifiSignal == 0 ? '4G' : b[30505],
                os_ver: system.system,
                sdk_ver: system.version, //存放的是微信版本号
                game_ver: config.game_ver, //存放的是SDK版本号
                device: system.platform == b[30506] ? 1 : 2
            };
        },
        ...
        log: function (type, data) {
            ...
            console.log(b[30507] + type);
            console.log(public_data);

            wx.request({
                url: b[26400] + HOST + b[30508] + type + b[30509] + encodeURIComponent(JSON.stringify(public_data))
            });
        },
        ...
        getLaunchOptionsSync: function (callback) {
            ...
            console.log(b[30510] + JSON.stringify(launchOptions));
        ...
        msgCheck: function (msg, callback) {
            SDKyyw.msgSecCheck(msg, function (res) {
                console.log(b[30511] + JSON.stringify(res));
                // 返回内容和微信返回内容一样
        ...
        sendCode: function (data, callback) {
            ...
            console.log(b[30512], data.phone);
        ...
        bindPhone: function (data, callback) {
            ...
            console.log(b[30513], data.phone, data.code);

            SDKyyw.bindTelephoneCallback = data => {
                console.log(b[30514], data);
                // 成功data = {status:"1", data: res, msg: success}
                // 失败data = {status:"0", data: fail, msg: fail}
                if (data.status == 1) {
                    callback && callback(0, data);
        ...
        subscribeMessage: function (tmplIds, callback) {
            console.log(b[30515] + tmplIds);
            //获取模板ID
            callbacks[b[30516]] = typeof callback == b[30355] ? callback : null;
            wx.requestSubscribeMessage({
                tmplIds: tmplIds,
                success(res) {
                    console.log(b[30517]);
                    console.log(res);
                    callbacks[b[30516]] && callbacks[b[30516]](res);
                },
                fail(res) {
                    console.log(b[30518]);
                    console.log(res);
...
exports.init = function (data, callback) {
    run(b[392], data, callback);
};

exports.login = function (callback) {
    run(b[30454], '', callback);
};
