function rotateLeft(a, b) {
  ...
  return new Promise(b => {
    ...
    let c = wx.getSystemInfoSync().SDKVersion;if (-1 == compareVersion(c, "2.10.3")) {
    ...
    let c = wx.getSystemInfoSync().SDKVersion;if (-1 == compareVersion(c, "2.0.4")) {
      return void b({ code: 1, state: "version", msg: "\u7248\u672C\u8FC7\u4F4E" });
    }if (bannerAd) {
      if ("hide" == a.state) {
    ...
    let c = wx.getSystemInfoSync().SDKVersion;if (-1 == compareVersion(c, "2.11.1")) {
      return void b({ code: 1, state: "version", msg: "\u7248\u672C\u8FC7\u4F4E" });
    ...
    let c = wx.getSystemInfoSync().SDKVersion;if (-1 == compareVersion(c, "2.9.2")) {
      return void b({ code: 1, state: "version", msg: "\u7248\u672C\u8FC7\u4F4E" });
    }if (gridAd) {
      if ("hide" == a.state) {
