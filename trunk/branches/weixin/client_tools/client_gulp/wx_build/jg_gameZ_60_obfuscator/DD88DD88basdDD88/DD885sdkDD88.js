    ...
    return {
        ...
        msgCheck: function (content, callback) {
            ...
            sdk.msgSecCheck({ scene: 1, content: content }, res => {
                console.log(G[582009], res);

                let ret = {
                    data: {}
                };

                if (res.statusCode == 0 && res.checkResult.result.suggest == G[582010]) {
                    ret.statusCode = 200;
                    ret.data.state = 1;
                } else {
        ...
        startPay: function (data, callback) {
            console.log(G[582011] + JSON.stringify(data));
            ...
            var public_data = self.getPublicData();
            public_data[G[582013]] = JSON.stringify(order_data);

            //发起网络请求
            wx.request({
                url: G[581984] + HOST + G[582014],
                method: G[580772],
                dataType: G[581396],
                header: {
                    'content-type': G[580963] // 默认值
                ...
                data: public_data,
                success: function (res) {
                    console.log(G[582015] + JSON.stringify(res));
                    if (res.statusCode == 200) {
                        var data = res.data;
                        if (data.state) {
                            if (data.data.ext == '') {
        ...
        extDo: function (data) {
            wx.navigateToMiniProgram({
                appId: data.ext1,
                path: G[582016] + data.ext2.cpOrderId + G[582017] + data.ext2.amount / 100,
                extraData: {},
                envVersion: G[582018],
                success(res) {
                    // 打开成功
        ...
        logCreateRole: function (data) {
            ...
            var postData = {};
            postData[G[582019]] = uid;
            postData[G[582020]] = username;
            postData[G[582021]] = data.roleid;
            postData[G[582022]] = data.rolelevel;
            postData[G[582023]] = data.rolename;
        ...
        getPublicData: function () {
            ...
            return {
                ...
                is_from_min: 1,
                dname: sysInfo.model,
                net_type: sysInfo.wifiSignal == 0 ? '4G' : G[582029],
        ...
        log: function (type, data) {
            ...
            console.log(G[582030] + type);
            console.log(public_data);

            wx.request({
                url: G[581984] + HOST + G[582031] + type + G[582032] + encodeURIComponent(JSON.stringify(public_data))
            });
        },
        ...
        sendCode: function (data, callback) {
            ...
            console.log(G[582038], data.phone);
            var params = {
                phone: data.phone
            };
        ...
        bindPhone: function (data, callback) {
            ...
            console.log(G[582039], data.phone, data.code);
            var params = {
                phone: data.phone,
                code: data.code
            };
