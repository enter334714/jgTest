function copy(e, t) {
  ...
  if (o) {
    if (!(e = o(e))) return;if ("string" == typeof e) return void t.push(e);
      ...
      var a = e.publicId,
          E = e.systemId;return t.push("<!DOCTYPE ", e.name), void (a ? (t.push(' PUBLIC "', a), E && "." != E && t.push('" "', E), t.push('">')) : E && "." != E ? t.push(' SYSTEM "', E, '">') : ((a = e.internalSubset) && t.push(" [", a, "]"), t.push(">")));case PROCESSING_INSTRUCTION_NODE:
