import hnsb from '../utils/hnsb.js'

//TODO 替换对应参数
var config = {
    game_id: 256,
    game_pkg: 'tjqy_tjqysbwxxcxyjly_YH',
    partner_label: 'lewanxyx',
    partner_id: '620',
    game_ver: '89.0.1',
    is_auth: false, //授权登录
};
...
function mainSDK() {
    ...
    return {
        ...
        login: function (data,callback) {
            ...
            hnsb.onLogin(function(res){
                console.log('hnsb.onLogin',res);
                if (res.code==0) {
                  partner_user_info = res.data;
                  self.do_login(partner_user_info);
                } else {
                  console.warn('渠道sdk登录失败，重试。');
                }
            })
        ...
        msgCheck: function (content, callback) {
            ...
            hnsb.checkMsgSec({content:content},(res)=>{
                console.log('hnsb.checkMsgSec success',res);
                ret.statusCode = 200;
                ret.data.state = 1;
               ...
               console.log('hnsb.checkMsgSec err',err);
                ret.statusCode = 200;
                ret.data.state = 0;
                    ...
                    if(res.statusCode == 200){
                        ...
                        if(data.state){
                            ...
                            if(data.data.ext == ''){
                                ...
                                hnsb.pay(data.data.pay_data,function(res){
                                    console.log('hnsb.pay',res);
                                },function(cancel){
                                  console.log('hnsb.pay cancel',cancel);
                                })
                            }else{
        ...
        logCreateRole: function (data) {
            ...
            hnsb.roleInfo({
              ...
              balance:0,
              viplevel:0,
              roleCtime:0,//Date.parse(new Date())/1000,
              charge:0,
              power:0,
            },function(res){
                console.log('hnsb.roleInfo',res);
            });
        },
        ...
        logEnterGame: function (data) {
           ...
           hnsb.roleInfo({
            ...
            power:0,
              ...
              console.log('hnsb.roleInfo enter',res);
          });
        },
        ...
        logRoleUpLevel: function (data) {
            ...
            hnsb.roleInfo({
              ...
              power:0,
                ...
                console.log('hnsb.roleInfo update',res);
            });
        },
