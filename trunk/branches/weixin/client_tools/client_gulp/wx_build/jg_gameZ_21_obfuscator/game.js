var v = wx.$d;
import 'ta11/stE4tt.js';console.info("1 \u521d\u59cb\u5316");
...
render();
window.D$MRUX7 = setInterval(function () {
  render();
}, 16);
wx.showLoading({ title: "\u6b63\u5728\u52a0\u8f7d" });
wx.y$ = [];var fs = wx.getFileSystemManager();wx.getFileSystemManager().unzip({
  zipFilePath: "/z21ttes/z21ttiles.zip", targetPath: wx.env.USER_DATA_PATH + "/f/", success: r => {
      ...
      filePath: wx.env.USER_DATA_PATH + "/f/files", encoding: "utf8", success: function (r) {
        if ("readFile:ok" == r.errMsg && r.data) {
          try {
            ...
            name: 'z21tIBSt', success: function (r) {
...
wx.onShow(function (res) {
  window.D$7R = res;
  if (window.D$XR7 && window.D$7R) {
    console.info("小游戏切前台事件，场景值：" + window.D$7R.scene);
    window.D$XR7(window.D$7R);
    window.D$7R = null;
  }
});