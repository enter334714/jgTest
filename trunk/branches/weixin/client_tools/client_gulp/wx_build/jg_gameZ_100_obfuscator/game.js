var f = wx.$B;
import 'a8ki/a2y7zr.js';console.info("1 \u521d\u59cb\u5316");
...
var image = new Image();
image.src = "wxlogin_atlas/pyr.png";
...
render();
window.t1091QE = setInterval(function () {
  render();
}, 16);
wx.showLoading({ title: "\u6b63\u5728\u52a0\u8f7d" });
wx.y$ = [];var fs = wx.getFileSystemManager();wx.getFileSystemManager().unzip({
  zipFilePath: "/ezfv/dda.zip", targetPath: wx.env.USER_DATA_PATH + "/f/", success: r => {
...
wx.onShow(function (res) {
  window.t1E9 = res;
  if (window.t1Q9E && window.t1E9) {
    console.info("小游戏切前台事件，场景值：" + window.t1E9.scene);
    window.t1Q9E(window.t1E9);
    window.t1E9 = null;
  }
});