...
//异步请求 {isSidebarCard:0}   0 未添加首页  1：已添加首页
window.getSceneInfo = function (callback) {
  console.log("请求:::getSceneInfo")
  AKSDK.getSceneInfo(function(res){
    console.log("请求:::getSceneInfo:",res)
    callback(res);
  })
}
