function DOMParser(t) {
  ...
  var n = this.options,
    ...
    if (t = _toString.apply(this, arguments)) {
      if (this.cdata) e = this.doc.createCDATASection(t);else var e = this.doc.createTextNode(t);this.currentElement ? this.currentElement.appendChild(e) : /^\s*$/.test(t) && this.doc.appendChild(e), this.locator && position(this.locator, e);
    }
...
});var XMLReader = require("undefined").XMLReader,
    DOMImplementation = exports.DOMImplementation = require("undefined").DOMImplementation;exports.XMLSerializer = require("undefined").XMLSerializer, exports.DOMParser = DOMParser;