function copy(e, t) {
  ...
  } else i = r = t;var a = n ? n.previousSibling : e.lastChild;i.previousSibling = a, r.nextSibling = n, a ? a.nextSibling = i : e.firstChild = i, null == n ? e.lastChild = r : n.previousSibling = r;do {
    i.parentNode = e;
  } while (i !== r && (i = i.nextSibling));return _onUpdateChild(e.ownerDocument || e, e), t.nodeType == DOCUMENT_FRAGMENT_NODE && (t.firstChild = t.lastChild = null), t;
}function _appendSingleChild(e, t) {
  var n = t.parentNode;if (n) {
    o = e.lastChild;n.removeChild(t);o = e.lastChild;
  ...
  var n = [],
    ...
    if (null == (i = o.lookupPrefix(r))) var a = [{ namespace: r, prefix: null }];
  ...
  if (o) {
    if (!(e = o(e))) return;if ("string" == typeof e) return void t.push(e);
      ...
      i || (i = []);var r = (i.length, e.attributes),
          a = r.length,
          s = e.firstChild,
          u = e.tagName;n = htmlns === e.namespaceURI || n, t.push("<", u);for (d = 0; a > d; d++) {
        "xmlns" == (c = r.item(d)).prefix ? i.push({ prefix: c.localName, namespace: c.value }) : "xmlns" == c.nodeName && i.push({ prefix: "", namespace: c.value });
      }for (var d = 0; a > d; d++) {
  ...
  return _updateLiveList(this), this[e];
    ...
    var t = new Element();t.ownerDocument = this, t.nodeName = e, t.tagName = e, t.childNodes = new NodeList();return (t.attributes = new NamedNodeMap())._ownerElement = t, t;
