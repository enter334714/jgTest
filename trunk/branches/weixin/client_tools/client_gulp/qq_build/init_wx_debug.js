    ...
    (function (n_selectServer) {
        ...
        var SelectServerPanel = (function (_super) {
            ...
            SelectServerPanel.prototype.initialize = function () {
                ...
                this.thml.color = "#3d4d78";
                this.thml.style.fontSize = 24;
                this.thml.style.lineHeight = 18;
                this.thml.style.align = "left";
            ...
            SelectServerPanel.prototype.addEvt = function () {
                ...
                this.cancelBtn.on(Laya.Event.CLICK, this, this.p_exitProgram);
                this.okBtn.on(Laya.Event.CLICK, this, this.p_enterGame);
                this.sbtn.on(Laya.Event.CLICK, this, this.p_setSel);
                ...
                this.thml.on(Laya.Event.LINK, this, this.p_clickLink);
            ...
            SelectServerPanel.prototype.rmEvts = function () {
                ...
                this.cancelBtn.off(Laya.Event.CLICK, this, this.p_exitProgram);
                this.okBtn.off(Laya.Event.CLICK, this, this.p_enterGame);
                this.sbtn.off(Laya.Event.CLICK, this, this.p_setSel);
                ...
                this.thml.off(Laya.Event.LINK, this, this.p_clickLink);
            ...
            SelectServerPanel.prototype.onOpened = function () {
                ...
                Laya.timer.frameOnce(1, this, function () {
                    _this.p_privacyData = _this.P_PFINFO.privacy_data && _this.P_PFINFO.privacy_data.list ? _this.P_PFINFO.privacy_data.list : [];
            ...
            SelectServerPanel.prototype.p_exitProgram = function () {
                if (ENV == 2) {
                    qq.exitMiniProgram({});
                }
                else {
                    this.p_showTip("同意协议后才可进入游戏");
                }
            };
            SelectServerPanel.prototype.p_setSel = function () {
                this.p_isApplyPrivacy2 = !this.p_isApplyPrivacy2;
                this.sbtn.skin = "wxlogin_atlas/" + (this.p_isApplyPrivacy2 ? "image_xuanfu_gx1.png" : "image_xuanfu_gx0.png");
            };
            SelectServerPanel.prototype.p_enterGame = function () {
                if (this.p_isApplyPrivacy2) {
            ...
            SelectServerPanel.prototype.p_clickEnter = function () {
                if (this.p_isApplyPrivacy) {
                    ...
                    if (this.P_PFINFO.privacy_alert_login_pkg) {
                        this.privacybgbox.visible = true;
                        if (!this.p_spr) {
                            this.p_spr = new Laya.Sprite();
                            this.privacybgbox.addChildAt(this.p_spr, 0);
                            this.p_spr.graphics.drawRect(0, 0, this.privacybgbox.width, this.privacybgbox.height, "#000000", 2);
                            this.p_spr.alpha = 0.3;
                        }
                    }
                    else {
                        this.p_showTip("您必须同意用户协议才可进入游戏");
            ...
            SelectServerPanel.prototype.p_onSelPrivacyItem = function () {
                ...
                var privacyData = this.p_privacyData[this.p_privacyList.selectedIndex];
            ...
            SelectServerPanel.prototype.p_updPrivacyUI = function () {
                ...
                this.thml.innerHTML = "\u6211\u5DF2\u7ECF\u8BE6\u7EC6\u9605\u8BFB\u5E76\u540C\u610F" + str;
                this.p_isApplyPrivacy2 = this.P_PFINFO.privacy_alert_login_pkg == 1;
                this.sbtn.skin = "wxlogin_atlas/" + (this.p_isApplyPrivacy2 ? "image_xuanfu_gx1.png" : "image_xuanfu_gx0.png");
            };
            SelectServerPanel.prototype.p_openPrivacyView = function (selIdx) {
                ...
                if (this.p_privacyData) {
                    ...
                    for (var i = 0; i < this.p_privacyData.length; i++) {
                        ...
                        var isSeled = i == this.p_privacyList.selectedIndex;
                        datas.push([title, isSeled]);
                    }
                    this.p_privacyList.dataSource = datas;
                    if (datas.length > 0) {
                        if (selIdx < 0)
                            selIdx = 0;
                        if (selIdx > datas.length - 1)
                            selIdx = 0;
            ...
            SelectServerPanel.prototype.openJumpView = function (title, content, btnTxt, showCloseBtn) {
                if (showCloseBtn === void 0) { showCloseBtn = false; }
                this.jumpTitle.text = title ? title : "暂无公告";
                this.jumpContent.innerHTML = content ? content : "";
                this.btnJump.label = btnTxt ? btnTxt : "确定";
                this.jumpContent.y = 0;
            ...
            SelectServerPanel.prototype.p_openAgeTipsPanel = function () {
                this.openJumpView("适龄公告", this.ageTipsContent, "确认", true);
            };
...
var ServerLoading = (function () {
    ...
    ServerLoading.prototype.p_addMserver = function () {
        if (!ServerLoading.instance.m_server)
            ServerLoading.instance.m_server = new SelectServerPanel(this.copyRightUrl);
        if (!ServerLoading.instance.m_server.parent) {
            ServerLoading.instance.m_layer.addChild(ServerLoading.instance.m_server);
        }
        ServerLoading.instance.p_resetWindow();
    };
    ServerLoading.prototype.openJumpView = function (title, content, btnTxt, showCloseBtn) {
        if (showCloseBtn === void 0) { showCloseBtn = false; }
        this.p_addMserver();
        ServerLoading.instance.m_server.openJumpView(title, content, btnTxt, showCloseBtn);
    };
    ServerLoading.prototype.openJumpTipsBtn = function (show, skinUrl, content, x, y) {
        this.p_addMserver();
        ServerLoading.instance.m_server.showAgeTipsBtn(show, skinUrl, content, x, y);
    };
    ...
    ;
    ServerLoading.prototype.openServer = function (cbk, context, copyRightUrl) {
        var self = this;
        this.copyRightUrl = copyRightUrl ? copyRightUrl : this.getCertificatePng();
