...
function qqmain() {
    return {
        ...
        getServers: function () {
            ...
            var lastSerStr = qq.getStorageSync("LastSer_" + PF_INFO.pkgName + PF_INFO.account)
           
            //var lastSerStr = localStorage ? localStorage.getItem("LastSer_" + PF_INFO.pkgName + PF_INFO.account) : "";
