(function (window, document, Laya) {
    ...
    var MiniSound = (function (_super) {
        ...
        __proto.onCanPlay = function () {         
            ...
            MiniSound._audioCache[_$this.url] = _$this;
        }
        ...
        __proto.load = function (url) {
            var _$this = this;
            // console.log("miniSound:播放音乐:", url)
            url = URL.formatURL(url);
            // console.log("miniSound  formatURL 播放音乐1:", url)
            this.url = url;
            ...
            if (ENV == 5) {
                ...
                console.log("播放网络音乐:", url)
                this._startPlay(url);

            }
        }

        __proto._startPlay = function (localUrl) {
            this._localUrl = localUrl;
            this._sound.onCanplay(this.onCanPlay.bind(this));
            this._sound.onError(this.onError.bind(this));
            // console.log("miniSound  formatURL 播放音乐2:", res.tempFilePath)
            this._sound.src = localUrl;
        }

        __proto._clearSound = function () {
            var _$this = this;
            if (MiniSound._null != undefined) {
                _$this._sound.onCanplay(MiniSound._null);
                _$this._sound.onError(MiniSound._null);
        ...
        __proto.onCanPlay = function () {
            ...
            this.loaded = true;
            this.event( /*laya.events.Event.COMPLETE*/ "complete");
            MiniSound._audioCache[this.url] = this;
        }

        __proto.onError = function (res) {
            console.error("errCode=" + res.errCode + "  errMsg=" + res.errMsg);
            _clearSound();
        ...
        __proto.play = function (startTime, loops) {
            ...
            tSound.src = this._localUrl;
            var channel = new MiniSoundChannel(tSound);
            channel.url = this._localUrl;
            channel.loops = loops;
