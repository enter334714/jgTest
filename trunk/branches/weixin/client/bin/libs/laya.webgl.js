    ...
    var Submit = (function () {
        ...
        __proto.renderSubmit = function () {
            ...
            if (_tex) {
                ...
                if(_tex.alphaTexture && _tex.alphaTexture.source){
                    this.shaderValue.texture1 = _tex.alphaTexture.source;
                }
            }
        ...
        DrawText._drawSlow = function (save, ctx, txt, words, curMat, font, textAlign, fillColor, borderColor, lineWidth, x, y, sx, sy, underLine) {
            ...
            if (words) {
                for (i = 0, n = chars.length; i < n; i++) {
                    oneChar = chars[i];
                    htmlWord = words[i];
                    if (oneChar && htmlWord && !oneChar.isSpace) {
...
//class laya.webgl.WebGL
    var WebGL = (function () {
        ...
        WebGL.enable = function () {
            ...
            WebGL.mainContext = WebGL.mainContext || RunDriver.getWebGLContext(Render._mainCanvas);
        ...
        WebGL.init = function (canvas, width, height) {
            ...
            WebGL.compressAstc = WebGL.compressAstc ? WebGL.compressAstc : {};
            WebGL.compressAtc = WebGL.compressAtc ? WebGL.compressAtc : {};
            WebGL.compressEtc = WebGL.compressEtc ? WebGL.compressEtc : {};
            WebGL.compressEtc1 = WebGL.compressEtc1 ? WebGL.compressEtc1 : {};
            WebGL.compressPvrtc = WebGL.compressPvrtc ? WebGL.compressPvrtc : {};
            WebGL.compressS3tc = WebGL.compressS3tc ? WebGL.compressS3tc : {};
            WebGL.compressS3tc_srgb = WebGL.compressS3tc_srgb ? WebGL.compressS3tc_srgb : {};
...
//class laya.webgl.canvas.WebGLContext2D extends laya.resource.Context
    var WebGLContext2D = (function (_super) {
        ...
        __proto.willDrawTexture = function (tex, alpha) {
            ...
            var same = (curShader.textureHost && (curShader.textureHost == tex && curShader.textureHost.alphaTexture == tex.alphaTexture));
            ...
            submit._preIsSameTextureShader = this._curSubmit._renderType === /*laya.webgl.submit.Submit.TYPE_TEXTURE*/10016 && shader.ALPHA === curShader.ALPHA && same;
            this._curSubmit = submit;
...
//class laya.webgl.shader.d2.value.Value2D extends laya.webgl.shader.ShaderValue
    var Value2D = (function (_super) {
        ...
        __proto.upload = function () {
            ...
            if (this.textureHost && this.textureHost.alphaTexture) {
                this.defines.add(/*laya.webgl.shader.d2.ShaderDefines2D.TXTALPHA*/0x800);
            } else {
                this.defines.remove(/*laya.webgl.shader.d2.ShaderDefines2D.TXTALPHA*/0x800);
            }
            if (this.textureHost && this.textureHost.bitmap && (this.textureHost.bitmap.format == 37815 || this.textureHost.bitmap.format == 37812 || this.textureHost.bitmap.format == 37821)) {
                this.defines.add(/*laya.webgl.shader.d2.ShaderDefines2D.TXTCOMPRESS*/0x1000);
            } else {
                this.defines.remove(/*laya.webgl.shader.d2.ShaderDefines2D.TXTCOMPRESS*/0x1000);
            }
...
//class laya.webgl.atlas.Atlaser extends laya.webgl.atlas.AtlasGrid
    var Atlaser = (function (_super) {
        function Atlaser(gridNumX, gridNumY, width, height, atlasID) {
            ...
            this._atlasCanvas.uri = "Atlaser.AtlasWebGLCanvas._atlasCanvas";
...
//class laya.webgl.shader.d2.ShaderDefines2D extends laya.webgl.shader.ShaderDefines
    var ShaderDefines2D = (function (_super) {
        ...
        ShaderDefines2D.__init__ = function () {
            ...
            ShaderDefines2D.reg("TXTALPHA", 0x800);
            ShaderDefines2D.reg("TXTCOMPRESS", 0x1000);
        }
        ...
        ShaderDefines2D.TXTALPHA = 0x800;
        ShaderDefines2D.TXTCOMPRESS = 0x1000;
    ...
    var SubmitTexture = (function (_super) {
        ...
        __proto.renderSubmit = function () {
            ...
            if (this._preIsSameTextureShader && BaseShader.activeShader && SubmitTexture._shaderSet){
                ...
                if(this.shaderValue.texture1) (BaseShader.activeShader).uploadTexture2D1(this.shaderValue.texture1);
            } else {
                this.shaderValue.upload();
            }
        ...
        __proto.recreateResource = function () {
            ...
            if (bIsConchApp) {
                ...
                if (this.underLine) {
                    ...
                    var ms = this._ctx.measureText(this.char);
                    if (!ms) ms = {width:16};
                    var nW = ms.width + 1;
...
//class laya.webgl.resource.WebGLRenderTarget extends laya.resource.Bitmap
    var WebGLRenderTarget = (function (_super) {
        function WebGLRenderTarget(width, height, surfaceFormat, surfaceType, depthStencilFormat, mipMap, repeat, minFifter, magFifter) {
            ...
            this.uri = "WebGLRenderTarget_"+this.id;
            this._w = width;
            this._h = height;
            this._surfaceFormat = surfaceFormat;
            this._surfaceType = surfaceType;
...
//class laya.webgl.shader.Shader extends laya.webgl.shader.BaseShader
    var Shader = (function (_super) {
        ...
        __proto._compile = function () {
            if (WebGL.mainContext.isContextLost() || !this._vs || !this._ps || this._params)
                return;
        ...
        __proto.uploadTexture2D1 = function (value) {
            Stat.shaderCall++;
            var gl = WebGL.mainContext;
            gl.activeTexture(/*laya.webgl.WebGLContext.TEXTURE1*/0x84C1);
            WebGLContext.bindTexture(gl, /*laya.webgl.WebGLContext.TEXTURE_2D*/0x0DE1, value);
        }
    ...
    var WebGLImage = (function (_super) {
        function WebGLImage(data, def, format, mipmap, width, height) {
            ...
            if ((typeof data == 'string')) {
                ...
                this._h = height;
                this._image = data;
                this._format = (format === 0 ? (((data.byteLength / (width * height)) == 4) ? 0x1908 : 0x1907) : format);
            } else {
                this._src = def;
                this._url = this._src;
        ...
        __proto._createWebGlTexture = function () {
            ...
            //             break;
            //         default:
            //             console.error("isConchWebGL纹理类型：", this._format);
            //     }
            // } else {
                gl.pixelStorei(/*laya.webgl.WebGLContext.UNPACK_PREMULTIPLY_ALPHA_WEBGL*/0x9241, true); 
                switch (this._format) {                    
                    ...
                    case /*laya.webgl.WebGLContext.RGBA*/0x1908:
                        ...
                        break;
                    //xmf:这里要增加几种新的提交类型
                    case /*laya.webgl.WebGLContext.ALPHA*/0x1906: // console.log("透明通道 , w,h:", w , h );  
                        _compressedTex = true;
                        gl.texImage2D(/*laya.webgl.WebGLContext.TEXTURE_2D*/0x0DE1, 0, this._format, this._w, this._h, 0, this._format, /*laya.webgl.WebGLContext.UNSIGNED_BYTE*/0x1401, this._image);
                        break;
                    case /*RGB_PVRTC_4BPPV1_Format*/35840:
                    case /*RGB_PVRTC_2BPPV1_Format*/35841:
                    case /*RGBA_PVRTC_4BPPV1_Format*/35842:
                    case /*RGBA_PVRTC_2BPPV1_Format*/35843:
                    case /*RGBA_S3TC_DXT5_Format*/33779:
                    case /*RGBA_ASTC_8x8_Format*/37815:
                    case /*RGBA_ASTC_6x6_Format*/37812:
                    case /*RGBA_ASTC_12x12_Format*/37821:
                    case WebGL.compressEtc1.COMPRESSED_RGB_ETC1_WEBGL:
                        _compressedTex = true;
                        gl.compressedTexImage2D(/*laya.webgl.WebGLContext.TEXTURE_2D*/0x0DE1, 0, this._format, this._w, this._h, 0, this._image);
                        break;
                    default:
                        console.error("收到其他的纹理类型：", this._format);
                }
                gl.pixelStorei(/*laya.webgl.WebGLContext.UNPACK_PREMULTIPLY_ALPHA_WEBGL*/0x9241, false);
            // }
            (preTarget && preTexture) && (WebGLContext.bindTexture(gl, preTarget, preTexture));
            if(!this.uri) this.uri = this._url;

            if(_compressedTex){
                this.memorySize = this._image.length;
            }else if (isPot && this.mipmap)
                this.memorySize = this._w * this._h * 4 * (1 + 1 / 3);
            else
                this.memorySize = this._w * this._h * 4;
        ...
        __proto.recreateResource = function () {
            var _$this = this;
            if (!this._image && (this._src == null || this._src === ""))
                return;
