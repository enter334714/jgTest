(function (window, document, Laya) {
    ...
    var Event = laya.events.Event, HTMLChar = laya.utils.HTMLChar, Loader = laya.net.Loader, Node = laya.display.Node,
        ...
        Layout._multiLineLayout = function (element) {
            ...
            for (i = 0; i < n; i++) {
                ...
                if ((oneLayout instanceof laya.html.dom.HTMLBrElement)) {
                    ...
                    htmlWord = oneLayout;
                    if (!htmlWord.isWord) {
                        w = htmlWord.width + htmlWord.style.letterSpacin;
            ...
            for (var i = 0, n = this.elements.length; i < n; i++) {
                ...
                switch (tCSSStyle._getValign()) {
                    case 0:
                        one.y = dy;
                        break;
                    case /*laya.display.css.CSSStyle.VALIGN_MIDDLE*/
                        1:
                        ;
                        ...
                        one.y = ddy;
                        break;
                    case /*laya.display.css.CSSStyle.VALIGN_BOTTOM*/
                        2:
        ...
        __proto._getWords = function () {
            ...
            for (var i = 0, n = txt.length; i < n; i++) {
                ...
                if (size) {
                    ...
                    console.warn("_getWords size is null" + txt.charAt(i), fontStr)
                }
            }
            return words;
        }
    ...
    var HTMLImageElement = (function (_super) {
        ...
        __proto.destroy = function () {
            if (this._tex != null) {
                ...
                Loader.clearCache(this, this._url);
                this._tex = null;
            }
            HTMLElement.prototype.destroy.call(this);
        }
        ...
        __proto.onloaded = function () {
            ...
            if (style && !style.widthed(this) && this._width != this._tex.width) {
                this.width = this._tex.width;
                this.parent && (this.parent)._layoutLater();
            }
            if (style && !style.heighted(this) && this._height != this._tex.height) {
            ...
            if (Render.isConchApp) {
                ...
                this._renderArgs[3] = this.width || this._tex.width;
                this._renderArgs[4] = this.height || this._tex.height;
                this.graphics.drawTexture(this._tex, 0, 0, this._renderArgs[3], this._renderArgs[4]);
            }
            this.repaint();
            this.parentRepaint();
        }
        ...
        __getset(0, __proto, 'src', null, function (url) {
            ...
            if (!tex) {
                // this._tex = tex = Laya.loader.create(url, null, null, Texture);
                window.imgMgrLoad(url, this._loadImageComplete.bind(this), 2, false);
            } else {
                Loader.keepCache(this, url);
                this.onloaded();
            }
