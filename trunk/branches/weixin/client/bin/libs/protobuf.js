...
Reader.prototype.uint64 = function read_uint64() {
    ...
    switch (t >> 4) {
        ...
        case 10:
            ...
            v = Math.floor( this.buf[this.pos+4] * 0x1000000
                + this.buf[this.pos+3] * 0x10000
                + this.buf[this.pos+2] * 0x100
                + this.buf[this.pos+1]);
            this.pos += 5;
            break;
        case 6:
        case 11:
            ...
            var lo = Math.floor( this.buf[this.pos+4] * 0x1000000
                + this.buf[this.pos+3] * 0x10000
                + this.buf[this.pos+2] * 0x100
                + this.buf[this.pos+1]);
            var hi = Math.floor( this.buf[this.pos+8] * 0x1000000
                + this.buf[this.pos+7] * 0x10000
                + this.buf[this.pos+6] * 0x100
                + this.buf[this.pos+5])
