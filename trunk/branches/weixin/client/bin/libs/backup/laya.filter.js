(function (window, document, Laya) {
    ...
    var ColorFilterActionGL = laya.filters.webgl.ColorFilterActionGL, Filter = laya.filters.Filter,
    ...
    var RenderTarget2D = laya.webgl.resource.RenderTarget2D, RunDriver = laya.utils.RunDriver,
            ...
            RunDriver.createFilterAction = function (type) {
                ...
                switch (type) {
                    ...
                    0x20:
                        ...
                        break;
                    case /*laya.filters.Filter.BLUR*/
                    0x10:
                        action = new BlurFilterActionGL();
                        break;
                    case /*laya.filters.Filter.GLOW*/
                    0x08:
