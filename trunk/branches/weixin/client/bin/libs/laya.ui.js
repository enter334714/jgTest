    ...
    var AutoBitmap = (function (_super) {
        ...
        AutoBitmap.getTexture = function (tex, x, y, width, height) {
            ...
            if (!texture || !texture.source) {
                ...
                if (texture) {
                    if (tex.alphaTexture) {
                        var s = tex.width / tex.alphaTexture.width;
                        texture.alphaTexture = Texture.createFromTexture(tex.alphaTexture, x/s, y/s, width/s, height/s);
                    }
...
//class laya.ui.Button extends laya.ui.Component
    var Button = (function (_super) {
        ...
        __proto.clearEvent = function () {
            if(this._skin){
                window.atalsNotify && window.atalsNotify.off(this._skin, this, this._setBtnSource);
            }          
        }
        ...
        __proto.changeClips = function () {
            ...
            if (!this._skin || this._skin=="") {
                console.warn("lose skin ", this._skin, this.name, this.__className);
                return;
            }
            Loader.clearObject(this, this._weakKey);
            ...
            if (clips) {
                ...
                if (this._stateNum === 1) {
                    ...
                    for (var i = 0; i < this._stateNum; i++) {
                        ...
                        if (img.alphaTexture) {
                            var s = img.width / img.alphaTexture.width;
                            texture.alphaTexture = Texture.createFromTexture(img.alphaTexture, 0/s, height * i/s, width/s, height/s);
                        }
                        // if (texture) {
        ...
        __getset(0, __proto, 'skin', function () {
            ...
            if (this._skin != value) {
                ...
                if(img){
                    ...
                    var sourceData = window.resAtalsObj && window.resAtalsObj[this._skin];                   
                    if (sourceData) {                              
                        // base.n_mesh.N_AtlasDataPool.instance.load(atalsUrl, this._setBtnSource.bind(this), 5);
                        window.atalsNotify && window.atalsNotify.once(this._skin, this, this._setBtnSource);  
                        if(this.width==0) this.width = sourceData.sourceW;
                        if(this.height==0) this.height = sourceData.sourceH / this._stateNum;     
                    } else{
                        console.warn("lose button skin ", this._skin, this.name, this.__className);
                    }
                }
        ...
        __proto._setBtnSource = function(url, img){  
...
//class laya.ui.Clip extends laya.ui.Component
    var Clip = (function (_super) {
        ...
        __proto.changeClip = function () {
            ...
            if (img) {
                ...
                if(sourceData){
                    ...
                    this.clearLoad();
                    this._complete = Handler.create(this, this.loadComplete, [this._skin]);
                    this._progress = null;
                    Laya.loader.load(this._skin, this._complete, this._progress);
                }                              
            }
        }
                ...
                if (clips) {
                    ...
                    for (var i = 0; i < this._clipY; i++) {
                        for (var j = 0; j < this._clipX; j++) {
                            ...
                            if (img.alphaTexture) {
                                var s = img.width / img.alphaTexture.width;
                                texture.alphaTexture = Texture.createFromTexture(img.alphaTexture, w * j/s, h * i/s, w/s, h/s);
                            }
                            // if (texture) {
                            //     texture.bitmap._addReference();
                            // }
        ...
        __proto.clearLoad = function () {
            if(this._skin){
                if (this._complete || this._progress) Laya.loader.cancel(this._skin, this._complete, this._progress);
                this._complete = this._progress = null;
            }          
        }
        ...
        __getset(0, __proto, 'skin', function () {
            ...
            if (this._skin != value) {
                ...
                if (value) {
                    ...
                    var souceData = window.resAtalsObj && window.resAtalsObj[this._skin];
                    if(!source && souceData){
                        window.atalsNotify && window.atalsNotify.once(this._skin, this, this._setBtnSource);  
                    }else{
...
//class laya.ui.Image extends laya.ui.Component
    var Image = (function (_super) {
        ...
        __proto.setSource = function (url, img) {           
            // DEBUG && console.warn("设置皮肤资源：",this._skin,url,img)
            if (url === this._skin && img) {
                this.source = img
                this.onCompResize();
                this.clearEvent();      
        ...
        __proto.clearEvent = function () {
            if(this._skin){
                window.atalsNotify && window.atalsNotify.off(this._skin, this, this.setSource);
            }          
        }
        __proto.clearLoad = function () {
            if(this._skin){
            ...
            if (this._skin != value) {
                ...
                if (value) {
                    ...
                    if (source) {
                        ...
                        // base.n_mesh.N_AtlasDataPool.instance.load(souceData.url, this.setSource1.bind(this), 5);                       
                        window.atalsNotify && window.atalsNotify.once(this._skin, this, this.setSource);                                                             
                        if(this.width==0) this.width = sourceData.sourceW;
                        if(this.height==0) this.height = sourceData.sourceH;                                     
                    }
                    else {
                        this._complete = Handler.create(this, this.setSource, [this._skin]);
                        this._progress = null;
                        Laya.loader.load(this._skin, this._complete, this._progress, /*laya.net.Loader.IMAGE*/"image", 1, true, this._group);
                    }
                } else {
                    this.source = null;
                }
