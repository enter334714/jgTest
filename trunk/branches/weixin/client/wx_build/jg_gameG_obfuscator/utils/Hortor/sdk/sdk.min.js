(window || global).regeneratorRuntime = void 0;var e = function (t, n) {
  ...
  var e = at(),
    ...
    var t = this;return new Promise(function (n, r) {
      var i = (e || {}).G$4I;t.show(Object.assign({}, e || {}, { onClose: function (e) {
          n(e || { isEnded: !0 });
        } })).then(function (e) {
        i && i(e);
      }).catch(r);
  ...
  return this.forceResult = void 0, this.destroyed = !1, this.inited = !1, this;
    ...
    if (!this.inited) {
      this.inited = !0;var t = e || {},
          ...
          s = t.success,
          o = t.fail,
          a = t.complete;this.successDiff = r || 2e3, this.onCallbackTime = i || 500, this.forceResult = n, this.showEnv = this.G$4I.bind(this, { success: s, fail: o, complete: a }), this._bind();
    }
  }, _bind: function () {
