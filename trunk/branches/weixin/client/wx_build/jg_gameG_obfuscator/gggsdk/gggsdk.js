let hortor = require("../utils/Hortor/sdk");let hortorSdk = hortor.sdk;let wallSDK = hortorSdk.wallSDK;let partner_config = hortor.config;let wxapm = hortor.wxapm;var config = { game_id: "256", game_pkg: "tjqy_tjlywffkxyxmj_FV", partner_label: "fkxyx", partner_id: "222", game_ver: "7.0.2", partner_game_id: "xjtjqymini", is_auth: !1 };window.config = config;var partner_user_data = {};var G$QY$8L = G$Q$8YL();var HOST = "sdk.sh9130.com";var G$Q$L8Y = null;var G$Q$LY8 = null;var system = wx.getSystemInfoSync();var device = "android" == system.platform ? "android" : "ios";var userInfoBtn = "";function G$Q$8YL() {
  var l = {};return { order_data: {}, init: function (e, r) {
      var o = e && e.game_ver ? e.game_ver : 0;console.log("[SDK]CP\u8c03\u7528init\u63a5\u53e3");var t = this;var n;n = (a = wx.getStorageSync("plat_uuid")) ? 0 : (a = t.uuid(16, 32), wx.setStorageSync("plat_uuid", a), 1), (i = wx.getStorageSync("plat_idfv")) || (i = t.uuid(16, 32), wx.setStorageSync("plat_idfv", i));var a = wx.getLaunchOptionsSync();var i = a.scene || "";n && a.query && a.query.ad_code && wx.setStorageSync("plat_ad_code", a.query.ad_code), t.log("start", { install: n, scene: i }), partner_config.gameVersion && (partner_config.gameVersion = e.game_ver), hortor.init(partner_config);e = a.query && a.query.invite ? a.query.invite : "";a = a.query && a.query.invite_type ? a.query.invite_type : "";e && (G$Q$LY8 = { invite: e, invite_type: a, is_new: n, scene: i }), o && this.checkGameVersion(o, function (o) {
      ...
      var t = this;var o = t.getPublicData();if (o.userInfo = e.encryptUserInfo || e.userInfo, o.timestamp = e.timestamp, o.sign = e.sign, o.is_from_min = 1, G$Q$LY8 && "object" == typeof G$Q$LY8) for (var r in G$Q$LY8) o[r] = G$Q$LY8[r];wx.request({ url: "https://" + HOST + "/partner/auth", method: "POST", dataType: "json", header: { "content-type": "application/x-www-form-urlencoded" }, data: o, success: function (e) {
      ...
      }), this.log("enter", a);n = { roleId: e.roleid, roleName: e.rolename, serverId: e.serverid, level: e.rolelevel, roleCtime: e.rolecreatetime ? 1e3 * e.rolecreatetime : 0, id: n.uniqueId };hortorSdk.setGameUserInfo(n), G$Q$LY8 && this.updateShare(G$Q$LY8.invite, G$Q$LY8.invite_type, G$Q$LY8.is_new, e.roleid, e.serverid, G$Q$LY8.scene), hortorSdk.checkSwitches({ switches: ["iospay"] }).then(e => {
