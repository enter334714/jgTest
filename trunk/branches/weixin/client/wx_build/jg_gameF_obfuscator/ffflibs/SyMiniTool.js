...
var __extends = this && this.__extends || function () {
  ...
  function MainController(t) {
    this.page = 3, this.rolePriceData = {}, this.boxlist = [], this.tool = t;
  }return MainController.prototype.show = function () {
    if ("1" === this.tool.data.on) {
      this.main = new ui.demoui.MainUI(), Laya.stage.addChild(this.main), this.main.mouseThrough = !0;var t = this.main._childs || [];for (var i = 0; i < t.length; i++) t[i].mouseThrough = !0;this.initIcon(), this.initEvent(), this.initView(), Toast.init();
      var childs_childs = t[0]._childs || [];for (var i = 0; i < childs_childs.length; i++) childs_childs[i].mouseThrough = !0;
    }
    ...
    this.icon = new Laya.Image(), this.icon.skin = this.tool.data.basics_image_url, this.icon.x = 0, this.icon.y = 200, this.icon.width = 102, this.icon.height = 111, this.main.addChild(this.icon), this.icon.on(Laya.Event.MOUSE_DOWN, this, this.iconPress), this.icon.on(Laya.Event.MOUSE_UP, this, this.iconUp), this.icon.on(Laya.Event.MOUSE_MOVE, this, this.iconMove), this.dragRect = new Laya.Rectangle(-this.icon.width / 2, 0, Laya.stage.width, Laya.stage.height - this.icon.height / 2);
    ...
    this.icon.startDrag(this.dragRect), this.isMove = !1, this.isPress = !0;
  }, MainController.prototype.iconMove = function () {
    this.isMove = !0;
  }, MainController.prototype.iconUp = function () {
    this.icon.stopDrag(), this.isPress && !this.isMove && (this.isInitBoard || this.initBoard(), this.showBoard()), this.isMove = !1, this.isPress = !1;
  }, MainController;
}();var ui;!function (t) {
  function BoxItemUI() {
