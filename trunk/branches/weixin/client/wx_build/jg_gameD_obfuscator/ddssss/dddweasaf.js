...
!function (n) {
  ...
  Object.defineProperty(t, "__esModule", { value: !0 });var r = function (e, t, n) {
    ...
    if (!e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return !t || "object" != typeof t && "function" != typeof t ? e : t;
  }var s = 0;var l = 1;var c = 2;var f = 3;var d = 4;var p = new WeakMap();var v = new WeakMap();new WeakMap();new WeakMap();(function (e, t) {
    if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function, not " + typeof t);e.prototype = Object.create(t && t.prototype, { constructor: { value: e, enumerable: !1, writable: !0, configurable: !0 } }), t && (Object.setPrototypeOf ? Object.setPrototypeOf(e, t) : e.__proto__ = t);
      ...
      var e = new Audio();return (0, u.isSubContext)() || (e.loop = p.get(this).loop, e.autoplay = p.get(this).loop, e.src = this.src), e;
      ...
      v.set(this, e), (0, u.isSubContext)() || (p.get(this).src = e);
    ...
    !function (e, t) {
      if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
    }(this, Audio);var t = _possibleConstructorReturn(this, (Audio.__proto__ || Object.getPrototypeOf(Audio)).call(this));if (t.HAVE_NOTHING = s, t.HAVE_METADATA = l, t.HAVE_CURRENT_DATA = c, t.HAVE_FUTURE_DATA = f, t.HAVE_ENOUGH_DATA = d, t.readyState = s, (0, u.isSubContext)()) return console.warn("HTMLAudioElement is not supported in SubContext."), _possibleConstructorReturn(t);v.set(t, "");var n = wx.createInnerAudioContext();return p.set(t, n), n.onCanplay(function () {
      t.dispatchEvent({ type: "load" }), t.dispatchEvent({ type: "loadend" }), t.dispatchEvent({ type: "canplay" }), t.dispatchEvent({ type: "canplaythrough" }), t.dispatchEvent({ type: "loadedmetadata" }), t.readyState = c;
    }), n.onPlay(function () {
      t.dispatchEvent({ type: "play" });
    }), n.onPause(function () {
      t.dispatchEvent({ type: "pause" });
    }), n.onEnded(function () {
      t.dispatchEvent({ type: "ended" }), t.readyState = d;
    }), n.onError(function () {
