console.info("0 \u8fdb\u5165\u6e38\u620f\u5305"), window.lastError, wx.onError(function (o) {
  if (o) {
    if (o.message) {
      var e = window.config.game_ver.replace(new RegExp(/\./, "g"), "_");var n = o.message;var r = n.match(/(subPackage\/bbbgame.js:)[0-9]{1,60}(:)/g);if (r) for (var a = 0; a < r.length; a++) {
        var i;r[a] && 0 < r[a].length && (i = parseInt(r[a].replace("game.js:", "").replace(":", "")), n = n.replace(r[a], r[a].replace(":" + i + ":", ":" + (i - 2) + ":")));
      }n = (n = n.replace(new RegExp("game.js", "g"), "subPackage/main__" + e + ".min.js")).replace(new RegExp("lsjdflaamain.js", "g"), "subPackage/main__" + e + ".min.js"), o.message = n;
  ...
  console.log("protobuf \u5206\u5305\u52a0\u8f7d");var o = wx.loadSubpackage({ name: "bbbbbbf", success: function (o) {
  ...
  console.log("Main \u5206\u5305\u52a0\u8f7d");var o = wx.loadSubpackage({ name: "bbbbbbbbb", success: function (o) {
