...
var ui,
  ...
  function b$f(t) {
    ...
    }for (var o = 0, n = this.m_serverRes1; o < n.length; o++) i = n[o], Laya.Loader.clearRes(i, !0);for (var s = 0, r = this.m_loadingRes; s < r.length; s++) i = r[s], Laya.Loader.clearRes(i, !0);for (var a = 0, b = this.m_loadingRes1; a < b.length; a++) i = b[a], Laya.Loader.clearRes(i, !0);for (var h = 0, l = this.m_loadingNewRes; h < l.length; h++) i = l[h], Laya.Loader.clearRes(i, !0);for (var g = 0, p = this.m_loadingNewRes1; g < p.length; g++) i = p[g], Laya.Loader.clearRes(i, !0);this.m_layer.parent && this.m_layer.parent.removeChild(this.m_layer);
    ...
    }Browser.container.style.top = "0px", e = (e = Math.floor(Browser.width)) + 1 & 2147483646, i = (i = Math.floor(Browser.height)) + 1 & 2147483646;t = Laya.stage;3 == ENV || i < e ? (t.scaleMode = Laya.Stage.SCALE_NOSCALE, t.width = e, t.height = i) : (t.scaleMode = Laya.Stage.SCALE_FIXED_WIDTH, t.width = 840, t.height = Math.floor(i / (e / 840)) + 1 & 2147483646), this.b$$();
  ...
  function b$c() {
    ...
    this.b$dc = t, this.b$cc.text = t.name, this.b$b.skin = t.select ? "bbblogin/btn_xuanqu_anniuhuang.png" : "bbblogin/btn_xuanqu_anniulan.png";
  }, b$c.prototype.destroy = function (t) {
    void 0 === t && (t = !0), this.rmEvts(), e.prototype.destroy.call(this, t);
  }, b$c.prototype.addEvt = function () {
  ...
  function b$c() {
    var t = e.call(this) || this;return t.b$b = new Laya.Image("bbblogin/btn_xuanqu_quanniu.png"), t.b$cc = new Laya.Label(), t.b$cc.fontSize = 30, t.b$cc.color = t.b$I, t.addChild(t.b$b), t.b$ec = new Laya.Image(), t.addChild(t.b$ec), t.width = 358, t.height = 70, t.addChild(t.b$cc), t.b$ec.centerY = 0, t.b$ec.x = 18, t.b$cc.x = 80, t.b$cc.centerY = 0, t.b$b.graphics.drawRect(0, 0, t.width, t.height, "#00sasd"), t;
  }var e;t = t.b$f || (t.b$f = {}), e = Laya.View, __extends(b$c, e), b$c.prototype.initialize = function () {
