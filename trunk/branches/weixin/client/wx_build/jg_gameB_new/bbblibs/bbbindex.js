import AKSDK from "../bbbk/bbbsdk.js";window.versions = { wxVersion: window.config.game_ver }, window.DEBUG = !1, window.PLATFORM = 1, window.ENV = 1, window.PACK = !0, window.WSS = !0, window.workerJsURL = "", window.PF_INFO = { base_cdn: "https://cdn-gz-jg.sh9130.com/weixin_0/", cdn: "https://cdn-gz-jg.sh9130.com/weixin_0/" }, PF_INFO.pay_infos = {}, PF_INFO.package = "0", PF_INFO.callback = "https://jgcenter.sh9130.com/api/sdk/game.php/", PF_INFO.version = window.versions.wxVersion, PF_INFO.mac = "", PF_INFO.os = "1", PF_INFO.sdk_name = "9130", PF_INFO.apiurl = "https://api-pjg.sh9130.com", PF_INFO.apikey = "MQx0mYlUWO5XYKvgAIPKWgK1w722GKih", PF_INFO.partnerId = "1", PF_INFO.pkgName = "", PF_INFO.device_id = "", PF_INFO.serverList = {}, PF_INFO.channelNum = parseInt(PF_INFO.partnerId), PF_INFO.channel = PF_INFO.partnerId, PF_INFO.selectedServer = {}, PF_INFO.clientlog = "https://jgcenter.sh9130.com/clientlog/", PF_INFO.showLogo = !1, PF_INFO.debugUsers = "39927500|58163716|74597555", PF_INFO.tick = Date.now(), PF_INFO.configType = "_weixin", PF_INFO.exposeType = "_a", PF_INFO.loadingType = 2, PF_INFO.lastVersion = 1985, PF_INFO.wxVersion = window.versions.wxVersion, PF_INFO.wxShield = !1, PF_INFO.wxIOS = !1, window.apiRetryAmount = 5, window.isCheckBan = !1, window.loadProbPkg = !1, window.loadMainPkg = !1, window.loadVersion = !1, window.loadOption = !1, window.loadServer = !1, window.bEnterGame = !1, window.alert = function (e) {
  ...
  console.log("#SDK \u521d\u59cb\u5316\uff1a");var e = AKSDK.getConfig();PF_INFO.channel = e.partner_id, PF_INFO.channelNum = e.partner_id, PF_INFO.partnerId = e.partner_id, PF_INFO.pkgName = e.game_pkg;e = { game_ver: PF_INFO.version };PF_INFO.device_id = this.guild(), AKSDK.init(e, this.sdkOnInited.bind(this));
}, window.sdkOnInited = function (e) {
  var n = e.develop;console.log("#\u521d\u59cb\u5316\u6210\u529f   \u63d0\u5ba1\u72b6\u6001:" + n + "   \u662f\u5426\u63d0\u5ba1:" + (1 == n) + "   \u63d0\u5ba1\u7248\u672c\u53f7:" + e.game_ver + "   \u5f53\u524d\u7248\u672c\u53f7:" + window.versions.wxVersion), window.compareVersion(window.versions.wxVersion, e.game_ver) < 0 ? (console.log("#\u6b63\u5f0f\u7248============================="), PF_INFO.apiurl = "https://api-tjqy.shzbkj.com", PF_INFO.apikey = "MQx0mYlUWO5XYKvgAIPKWgK1w722GKih", PF_INFO.spareCdn = "https://cdn-tjqy-ali.shzbkj.com/weixin_1/", PF_INFO.version_name = "weixin", PF_INFO.wxShield = !1) : 0 == window.compareVersion(window.versions.wxVersion, e.game_ver) ? (console.log("#\u5ba1\u6838\u7248============================="), PF_INFO.apiurl = "https://api-pjg.sh9130.com", PF_INFO.apikey = "MQx0mYlUWO5XYKvgAIPKWgK1w722GKih", PF_INFO.spareCdn = "https://cdn-tjqy-ali.shzbkj.com/weixin_1/", PF_INFO.version_name = "", PF_INFO.wxShield = !0) : (console.log("#\u5f00\u53d1\u7248============================="), PF_INFO.apiurl = "https://api-pjg.sh9130.com", PF_INFO.apikey = "MQx0mYlUWO5XYKvgAIPKWgK1w722GKih", PF_INFO.spareCdn = "https://cdn-tjqy-ali.shzbkj.com/weixin_1/", PF_INFO.version_name = "", PF_INFO.wxShield = !1), this.loadVersionConfig(), this.reqPkgOptions(), AKSDK.login(this.sdkOnLogin.bind(this));
}, window.sdkOnLogin = function (e, n) {
  wxShowLoading({ title: "\u6b63\u5728\u9a8c\u8bc1\u8d26\u53f7" }), 0 === e && n && n.token ? (PF_INFO.sdk_token = n.token, sendApi("User.login", { platform: PF_INFO.sdk_name, partner_id: PF_INFO.partnerId, token: n.token, game_pkg: PF_INFO.pkgName, deviceId: PF_INFO.device_id }, this.onUserLogin.bind(this), apiRetryAmount, onApiError)) : (clientlog(JSON.stringify({ error: JSON.stringify({ type: "sdkOnLoginError", status: e, data: n }) })), window.loginAlert("\u767b\u5f55/\u6ce8\u518c\u5931\u8d25" + (n && n.errMsg ? "\uff0c" + n.errMsg : "")));
}, window.onUserLogin = function (e) {
  e ? "success" == e.state ? (PF_INFO.userId = String(e.account), PF_INFO.account = String(e.account), PF_INFO.platform = String(e.platform), PF_INFO.channel = String(e.platform), PF_INFO.platform_uid = String(e.platform_uid), PF_INFO.php_sign = String(e.sign), PF_INFO.php_signtime = String(e.time), PF_INFO.sign = "", sendApi("Server.defaultServer", { partner_id: PF_INFO.partnerId, uid: PF_INFO.account, version: PF_INFO.version, game_pkg: PF_INFO.pkgName, device: PF_INFO.device_id }, this.onUserLoginDefaultServers.bind(this), apiRetryAmount, onApiError)) : window.loginAlert("User.login failed: " + e.state) : window.loginAlert("User.login failed");
  ...
  sendApi("User.getCdnVersion", { game_pkg: PF_INFO.pkgName, version_name: PF_INFO.version_name }, function (e) {
  ...
  sendApi("Common.get_option_pkg", { game_pkg: PF_INFO.pkgName }, reqPkgOptionsCallBack);
  ...
  r = String(r);PF_INFO.pay_infos[r] = { productid: r, productname: a, productdesc: s, roleid: e, rolename: n, rolelevel: o, price: t, callback: d }, sendApi("Order.order", { game_pkg: PF_INFO.pkgName, server_id: PF_INFO.selectedServer.server_id, server_name: PF_INFO.selectedServer.server_name, level: o, uid: PF_INFO.account, role_id: e, role_name: n, product_id: r, product_name: a, product_desc: s, money: t }, toPayCallBack, apiRetryAmount, onApiError);
  ...
  AKSDK.logCreateRole(PF_INFO.selectedServer.server_id, PF_INFO.selectedServer.server_name || PF_INFO.selectedServer.server_id, e, n, o), sendApi("User.create_role", { game_pkg: PF_INFO.pkgName, server_id: PF_INFO.selectedServer.server_id, role_id: e, uid: PF_INFO.account, role_name: n, role_type: i, level: o });
}, window.toLogin = function (e, n, o, i, r) {
  PF_INFO.roleId = e, PF_INFO.roleName = n, PF_INFO.roleLevel = o, AKSDK.logEnterGame(PF_INFO.selectedServer.server_id, PF_INFO.selectedServer.server_name || PF_INFO.selectedServer.server_id, e, n, o), sendApi("User.update_role", { game_pkg: PF_INFO.pkgName, server_id: PF_INFO.selectedServer.server_id, role_id: e, uid: PF_INFO.account, role_name: n, role_type: i, level: o, evolution: r });
...
}, window.sendApi = function (e, n, o, i, r, t) {
  n = n || {};var a = Math.floor(Date.now() / 1e3);n.time = a, n.method = e;var s = Object.keys(n).sort();var d = "";var w = "";for (var c = 0; c < s.length; c++) d = d + (0 == c ? "" : "&") + s[c] + n[s[c]], w = w + (0 == c ? "" : "&") + s[c] + "=" + encodeURIComponent(n[s[c]]);d += PF_INFO.apikey;e = "sign=" + md5(d);send(PF_INFO.apiurl + "?" + w + ("" == w ? "" : "&") + e, null, o, i, r, t || function (e) {
    return "success" == e.state;
  }, null, "application/x-www-form-urlencoded");
}, window.onRoleRecordStep = function (e, n) {
  var o = 0;PF_INFO.selectedServer && (o = PF_INFO.selectedServer.server_id), sendApi("UserLog.reportUidStep", { partnerId: PF_INFO.partnerId, gamePkg: PF_INFO.pkgName, logTime: Math.floor(Date.now() / 1e3), platformUid: PF_INFO.platform_uid, type: e, serverId: o }, null, 2, null, function () {
    return !0;
  });
}, window.req_server_group = function (e) {
  sendApi("Server.getServerGroup", { partner_id: PF_INFO.partnerId, uid: PF_INFO.account, version: PF_INFO.version, game_pkg: PF_INFO.pkgName, device: PF_INFO.device_id }, reqServerGroupCallBack, apiRetryAmount, onApiError);
  ...
  sendApi("Server.getServerByUid", { partner_id: PF_INFO.partnerId, uid: PF_INFO.account, version: PF_INFO.version, game_pkg: PF_INFO.pkgName }, reqServerOwnerCallBack, apiRetryAmount, onApiError);
  ...
  sendApi("Server.getServerByGroup", { partner_id: PF_INFO.partnerId, uid: PF_INFO.account, version: PF_INFO.version, game_pkg: PF_INFO.pkgName, device: PF_INFO.device_id, server_group_id: n }, reqServerListCallBack, apiRetryAmount, onApiError);
  ...
  sendApi("Server.getRecommendServerList", { partner_id: PF_INFO.partnerId, uid: PF_INFO.account, version: PF_INFO.version }, reqServerRecommendCallBack, apiRetryAmount, onApiError);
  ...
  e = e || PF_INFO.selectedServer.server_id, sendApi("Common.get_anno", { type: "4", game_pkg: PF_INFO.pkgName, server_id: e }, n);
  ...
  PF_INFO.last_check_ban = { step: e, server_id: n };sendApi("User.checkInfo", { partner_id: PF_INFO.partnerId, uid: PF_INFO.account, game_pkg: PF_INFO.pkgName, server_id: n, platform: PF_INFO.platform, platform_uid: PF_INFO.platform_uid, check_login_time: PF_INFO.php_signtime, check_login_sign: PF_INFO.php_sign, version_name: PF_INFO.version_name }, reqServerCheckBanCallBack, apiRetryAmount, onApiError, function (e) {
    return "success" == e.state || "time_err" == e.info || "sign_err" == e.info;
  });
}, window.reqServerCheckBanCallBack = function (e) {
  var n;"success" === e.state && e.data ? ((n = PF_INFO.selectedServer).channel_num = PF_INFO.channelNum, n.sign = String(e.data.login_sign), n.tick = parseInt(e.data.time), e.data.server_num ? n.server_num = parseInt(e.data.server_num) : n.server_num = parseInt(e.data.server_id), n.is_domain = 0, n.cdn = PF_INFO.base_cdn, n.resver = e.data.cdn_version, n.server_options = e.data.server_options, 1 == PF_INFO.newRegister && n.server_options && 1 == n.server_options.show_btn && (PF_INFO.showGetBtn = 1, window.ServerLoading.instance.setShowBtn()), checkBanSuccess()) : sendApi("User.login", { platform: PF_INFO.sdk_name, partner_id: PF_INFO.partnerId, token: PF_INFO.sdk_token, game_pkg: PF_INFO.pkgName, deviceId: PF_INFO.device_id }, function (e) {
