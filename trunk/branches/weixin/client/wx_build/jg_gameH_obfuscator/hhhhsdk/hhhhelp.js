...
module.exports = function (r) {
  var a = {};function n(e) {
    ...
    O[26806] != typeof Symbol && Symbol.toStringTag && Object.defineProperty(e, Symbol.toStringTag, { value: O[26807] }), Object.defineProperty(e, O[26808], { value: !0 });
  }, n.t = function (t, e) {
    if (1 & e && (t = n(t)), 8 & e) return t;if (4 & e && O[279] == typeof t && t && t.__esModule) return t;var r = Object.create(null);if (n.r(r), Object.defineProperty(r, O[328], { enumerable: !0, value: t }), 2 & e && O[297] != typeof t) for (var a in t) n.d(r, a, function (e) {
      return t[e];
  ...
  var r = { debug: !1, baseParams: { app_id: "", client_id: "", format: O[5680] }, gameParams: { "game-pkg_name": "", "game-app_ver": "", "game-h_ver": "", "game-sdk_ver": "", "game-mp_id": "" }, agentParams: { "agent-ch": "", "agent-sub_ch": "" }, deviceParams: { "device-device_id": "", "device-mac": "", "device-ip": "", "device-brand": "", "device-model": "", "device-os": "", "device-os_version": "", "device-screen": "", "device-net": "", "device-imsi": "", "device-longitude": "", "device-latitude": "", "device-userua": "", "device-disk_space": "", "device-open_time": "", "device-is_charge": "", "device-screen_luminance": "", "device-has_sim": "", "device-is_break": "" }, extParams: { brand: "", model: "", pixelRatio: "", screenWidth: "", screenHeight: "", windowWidth: "", windowHeight: "", statusBarHeight: "", language: "", version: "", system: "", platform: "", fontSizeSetting: "", SDKVersion: "", benchmarkLevel: "", albumAuthorized: "", cameraAuthorized: "", locationAuthorized: "", microphoneAuthorized: "", notificationAuthorized: "", notificationAlertAuthorized: "", notificationBadgeAuthorized: "", notificationSoundAuthorized: "", bluetoothEnabled: "", locationEnabled: "", wifiEnabled: "", safeArea: "" }, setting: { showLoading: !0, loadingParams: { title: O[27176], mask: !0 }, showToast: !1, toastParams: { icon: O[11278] } }, launchOptions: {}, baseUrl: O[27177], channelId: 536 };try {
    r.gameParams[O[27178]] = wx.canIUse ? "" : O[27179], wx.getSystemInfo({ success: function (e) {
        r.deviceParams[O[27180]] = encodeURIComponent(e.brand), r.deviceParams[O[27181]] = encodeURIComponent(e.model), r.deviceParams[O[27182]] = encodeURIComponent(e.screenWidth + "x" + e.screenHeight), r.deviceParams[O[27183]] = O[27184] === e.platform ? O[27185] : encodeURIComponent(e.platform), r.deviceParams[O[27186]] = encodeURIComponent(e.system), r.extParams.brand = e.brand, r.extParams.model = e.model, r.extParams.pixelRatio = e.pixelRatio, r.extParams.windowWidth = e.windowWidth, r.extParams.windowHeight = e.windowHeight, r.extParams.statusBarHeight = e.statusBarHeight, r.extParams.language = e.language, r.extParams.version = e.version, r.extParams.system = e.system, r.extParams.platform = e.platform, r.extParams.fontSizeSetting = e.fontSizeSetting, r.extParams.SDKVersion = e.SDKVersion, r.extParams.benchmarkLevel = e.benchmarkLevel, r.extParams[O[27187]] = e.albumAuthorized, r.extParams.cameraAuthorized = e.cameraAuthorized, r.extParams.locationAuthorized = e.locationAuthorized, r.extParams.microphoneAuthorized = e.microphoneAuthorized, r.extParams.notificationAuthorized = e.notificationAuthorized, r.extParams.notificationAlertAuthorized = e.notificationAlertAuthorized, r.extParams.notificationBadgeAuthorized = e.notificationBadgeAuthorized, r.extParams.notificationSoundAuthorized = e.notificationSoundAuthorized, r.extParams.bluetoothEnabled = e.bluetoothEnabled, r.extParams.locationEnabled = e.locationEnabled, r.extParams.wifiEnabled = e.wifiEnabled, r.extParams.safeArea = e.safeArea;
      } }), r.extParams.userua = window.navigator.userAgent, wx.getNetworkType({ success: function (e) {
        r.deviceParams[O[27188]] = encodeURIComponent(e.networkType), r.extParams.net = e.networkType;
      } }), wx.getScreenBrightness({ success: function (e) {
        r.deviceParams[O[27189]] = encodeURIComponent(parseInt(100 * e.value)), r.extParams.screen_luminance = parseInt(100 * e.value);
      } });
  } catch (e) {}e.exports = r;
}, function (e, t, n) {
  "use strict";
  ...
  var o = Object.assign || function (e) {
    ...
    return e && e.__esModule ? e : { default: e };
      ...
      var t;return e.method = (e.method || O[450]).toUpperCase(), O[27190] !== e.method || e.header || (e.header = { "Content-Type": O[27191] }), e.private || (t = wx.getStorageSync(O[27192]), e.data = o({}, d.default.baseParams, d.default.gameParams, d.default.agentParams, d.default.deviceParams, e.data, { "device-ext": encodeURIComponent(JSON.stringify(d.default.extParams)), token: t ? t.user_token : "", ts: new Date().getTime() })), e.data.sign = this.sign(e), /^http/.test(e.url) || (e.url = d.default.baseUrl + e.url), delete e.private, delete e.signUrl, e;
    }, setting: function () {
      return o({}, d.default.setting, 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {});
    }, sign: function (t) {
      var e = "";e = t.data.channel_id ? O[27193] : O[27194], t.app_key && (e = O[27195] + t.app_key);var n = (t.signUrl || t.url).substr(1),
          r = Object.keys(t.data).sort(),
          a = "";r.forEach(function (e) {
        a += "&" + e + "=" + t.data[e];
      });return t.app_key ? (0, u.default)(a.substr(1) + "&" + e) : (0, u.default)((t.method + "&" + encodeURIComponent(n) + "&" + encodeURIComponent(a.substr(1)) + "&" + e).replace(/\(/g, O[27196]).replace(/\)/g, O[27197]));
    }, renderQRCode: function (e, t, n) {
      var r = t.getContext("2d"),
          a = wx.createImage();a.src = n.image, a.onload = function () {
        r.lineJoin = O[3767], r.lineWidth = 30, r.strokeStyle = O[4308], r.strokeRect((window.innerWidth - 240) / 2, (window.innerHeight - 264) / 2, 240, 264), r.fillStyle = O[4308], r.fillRect((window.innerWidth - 220) / 2, (window.innerHeight - 244) / 2, 220, 244), r.fillStyle = O[27198], r.font = O[27199], r.textAlign = O[1543], r.fillText(n.intro, window.innerWidth / 2, (window.innerHeight - 258) / 2 + 218 + 30, 250), r.drawImage(a, (window.innerWidth - 218) / 2, (window.innerHeight - 258) / 2, 218, 218);
      }, s = { canvas: e, qrcvs: t, qrctx: r, data: n }, e.addEventListener(O[23672], c);
    }, removeOffScreen: function () {
      s && (s.qrctx.clearRect(0, 0, s.qrcvs.width, s.qrcvs.height), s.canvas.removeEventListener(O[23672], c));
    } };function c(e) {
    e.preventDefault();var t = e.touches[0],
        e = t.clientX,
        t = t.clientY;e >= (window.innerWidth - 218) / 2 && e <= (window.innerWidth - 218) / 2 + 218 && t >= (window.innerHeight - 258) / 2 && t <= (window.innerHeight - 258) / 2 + 218 ? wx.previewImage({ urls: [s.data.image] }) : (s.qrctx.clearRect(0, 0, s.qrcvs.width, s.qrcvs.height), s.canvas.removeEventListener(O[23672], c));
  }e.exports = n;
}, function (e, t, n) {
  "use strict";
  ...
  var o = Object.assign || function (e) {
    ...
    return t in e ? Object.defineProperty(e, t, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : e[t] = n, e;
      ...
      var m = this,
          h = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};return [O[27200], O[27201], O[4834], O[27202], O[27203], O[27204], O[24039]].map(function (e) {
        void 0 !== h[e] && (O[27200] === e ? g.default.baseParams[e] = h.app_id : O[27201] === e ? g.default.gameParams[O[27205]] = h.mp_id : O[24039] === e ? g.default.debug = h.debug : g.default.setting[e] = h[e]);
        ...
        h.app_id ? i.default.getDNSInfo({ data: o({ ts: parseInt(new Date().getTime() / 1e3), channel_id: g.default.channelId, url: g.default.baseUrl, un_url: "", app_id: g.default.baseParams.app_id }, g.default.deviceParams) }).then(function (e) {
              ...
              n = n && n.split("&");var a = !0,
                ...
                for (var d, u = n[Symbol.iterator](); !(a = (d = u.next()).done); a = !0) {
                  var c = function (e, t) {
                    ...
                    }(e, t);throw new TypeError(O[27206]);
                  }(d.value.split("="), 2),
                      s = c[0],
                      f = c[1];O[27207] === s && (r = f);
                }
          ...
          } else g.default.launchOptions = { state: t || r || "" }, l({ msg: O[9529] });
        }, function (e) {
          l({ msg: O[9529] });
        }) : e({ msg: O[27208] });
      });
      ...
      var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};return new Promise(function (n, r) {
        wx.login({ success: function (e) {
            var t;e.code ? (a.data = Object.assign({}, a.data, (c(t = {}, O[27209], g.default.extParams), c(t, O[8918], g.default.launchOptions.ext), c(t, O[3977], g.default.launchOptions.state), c(t, O[27210], e.code), t)), n(i.default.reversal(a))) : r(e);
          }, fail: function (e) {
            r(e);
          } });
      });
        ...
        wx.checkSession({ success: function (e) {
            i.default.wxLogin(o({}, a)).then(function (e) {
              var t = wx.getLaunchOptionsSync();i.default.reportAdClick({ data: { click_id: t.query && t.query.gdt_vid || "", url: "" } }).then(function (e) {
                console.log(O[27211], e);
              }), n(r.getUserInfo(o({}, a)));
            }, function (e) {
              t({ msg: e.msg || O[27208] });
            });
          }, fail: function (e) {
            console.log(O[27212], a), i.default.wxLogin(a).then(function (e) {
              var t = wx.getLaunchOptionsSync();i.default.reportAdClick({ data: { click_id: t.query && t.query.gdt_vid || "", url: "" } }).then(function (e) {
                console.log(O[27211], e);
              }), n(r.getUserInfo(a));
            }, function (e) {
      ...
      var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};return new Promise(function (t, n) {
        i.default.mpPay(e).then(function (e) {
          ...
          n({ msg: e.errMsg || O[27208] });
        });
      });
    }, mpPayQuery: function () {
      var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};var t;return e.data && void 0 !== e.data[O[27213]] || (t = wx.getStorageSync(O[27214]), e.data = o({}, e.data, { "order-order_id": t ? t.order_id : "" })), i.default.mpPayQuery(e);
    }, midasPay: function () {
      var a = this,
        ...
        i.default.midasPay(o).then(function (e) {
          ...
          t({ msg: e.errMsg || O[27208] });
        });
      });
    }, midasPayQuery: function () {
      var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};var t;return e.data && void 0 !== e.data[O[27213]] || (t = wx.getStorageSync(O[27214]), e.data = o({}, e.data, { "order-order_id": t ? t.order_id : "" })), i.default.midasPayQuery(e);
    }, checkPay: function () {
      ...
      var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {},
          r = o({}, g.default.baseParams, g.default.gameParams, g.default.agentParams, g.default.deviceParams, { token: wx.getStorageSync(O[27192]).user_token, ts: new Date().getTime() });return r.sign = a.default.sign({ url: O[27215], data: r }), new Promise(function (t, n) {
        wx.uploadFile({ url: g.default.baseUrl + O[27215], filePath: e.data.filePath, name: O[4547], formData: r, success: function (e) {
            e = e.data;200 === (e = JSON.parse(e)).code ? t({ msg: O[9529] }) : n({ msg: e.msg || O[27208] });
          } });
      });
    } };e.exports = n;
}, function (e, t, n) {
  ...
  var d = Object.assign || function (e) {
    ...
    var r = e.data,
      ...
      l.default.ajax(e).then(function (e) {
        e.data && e.data.data ? t({ data: e.data.data, msg: O[9529] }) : t({ msg: O[9529] });
      }, function (e) {
        ...
        } else n({ msg: e.data ? e.data.msg || O[27216] : e.errMsg });
      });
    });
  }var o = !1,
      u = { getDNSInfo: function (e) {
      return Pb(d({ method: O[4409], url: O[27217], signUrl: O[27218], private: !0 }, e));
    }, cpUserCheck: function (e) {
      return Pb(d({ method: O[4409], url: O[27219], private: !0 }, e));
    }, login: function (e) {
      return r.default.launchOptions.ext ? e.data = Object.assign({}, e.data, d({ state: r.default.launchOptions.state }, e)) : e.data = Object.assign({}, e.data, d({}, e)), r.default.launchOptions && r.default.launchOptions.state && (e.data.state = r.default.launchOptions.state), Pb(d({ method: O[4409], url: O[27220] }, e)).then(function (e) {
        return e && wx.setStorageSync(O[27192], e.data), e;
      });
    }, wxLogin: function (r) {
      ...
      return Pb(d({ method: O[4409], url: O[27221] }, e));
    }, setUserInfo: function (e) {
      return Pb(d({ method: O[4409], url: O[27222] }, e)).then(function (e) {
        return wx.setStorageSync(O[27192], e.data), e;
      });
    }, upRoleInfo: function (e) {
      return e.conf = { showLoading: !1, showToast: !1 }, Pb(d({ method: O[4409], url: O[27223] }, e)).then(function (e) {
        return e;
      });
    }, getUserInfo: function (e) {
      return Pb(d({ method: O[4409], url: O[27224] }, e)).then(function (e) {
        if (e.data.report_status && 2 == e.data.report_status) try {
          require(O[27225]);
        } catch (e) {}return wx.setStorageSync(O[27192], e.data), e;
      });
    }, getShareInfo: function (e) {
      return Pb(d({ url: O[27226] }, e));
    }, addShareInfo: function (e) {
      return Pb(d({ url: O[27227] }, e));
    }, getShareQrcode: function (e) {
      return Pb(d({ url: O[27228] }, e));
    }, mpPay: function (t) {
      var n = this;return this.preOrder(t).then(function (e) {
        return t.data = d({}, t.data, { payway: O[27229], "order-order_id": e.data.order_id }), n.mpOrder(t);
      });
    }, midasPay: function (t) {
      var n = this;return this.preOrder(t).then(function (e) {
      ...
      var f = this;return new Promise(function (t, n) {
        var e = c.mode,
            ...
            s.data[O[27213]] = c.order_id, s.conf = { showLoading: !1, showToast: !1 }, f.midasPayQuery(s).then(function (e) {
            ...
            e.errMsg && (O[27230] === e.errMsg ? (t = wx.getStorageSync(O[27192]), e.msg = t && t.ios_text || O[27231], e.duration = 3e3) : e.msg = e.errMsg);var t = l.default.setting(s.conf);t.showToast && (e.msg && (t.toastParams.title = e.msg), e.duration && (t.toastParams.duration = e.duration), wx.showToast(t.toastParams)), n(e);
          } });
      });
    }, checkPay: function (t) {
      var n = this;return this.preOrder(t).then(function (e) {
        return 2 === e.data.check ? n.wxMidasPay(e.data, t) : (t.data[O[27213]] = e.data.order_id, n.checkPayInfo(t));
      });
    }, preOrder: function (e) {
      return Pb(d({ method: O[4409], url: O[27232] }, e)).then(function (e) {
        return wx.setStorageSync(O[27214], e.data), e;
      }, function (e) {
        return e;
      });
    }, mpOrder: function (t) {
      var n = this;return Pb(d({ method: O[4409], url: O[27233] }, t)).then(function (e) {
      ...
      return new Promise(function (t, n) {
        wx.requestPayment(d({}, e, { success: function (e) {
            ...
            O[27234] === e.errMsg && n({ msg: O[27235] });
          } }));
      });
    }, mpPayQuery: function (e) {
      return Pb(d({ method: O[4409], url: O[27236] }, e));
    }, midasPayQuery: function (e) {
      return Pb(d({ url: O[27237] }, e));
    }, checkPayInfo: function (a) {
      var o = this;return Pb(d({ url: O[27238] }, a)).then(function (r) {
        return r.data.order_id = a.data[O[27213]], new Promise(function (t, e) {
          r.data.image && wx.setStorageSync(O[27239], r.data.image);var n = wx.getStorageSync(O[27239]);r.data && 4 == +r.data.pay_type ? (wx.showModal({ title: O[27240], content: O[27241], success: function (e) {
              e.confirm && wx.openCustomerServiceConversation();
            } }), t(r)) : r.data && r.data.mp_id ? (wx.navigateToMiniProgram({ appId: r.data.mp_id, path: r.data.path }), t(r)) : n ? (a.canvas && a.offscreen && l.default.renderQRCode(a.canvas, a.offscreen, { image: n, intro: r.data.intro || O[27242] }), r.data.image = n, t(r)) : o.checkQrcode(a).then(function (e) {
            e = e.data.poster_img;a.canvas && a.offscreen && l.default.renderQRCode(a.canvas, a.offscreen, { image: e, intro: r.data.intro || O[27242] }), wx.setStorageSync(O[27239], e), r.data.image = e, t(r);
          }, function (e) {
            t(r);
          });
        });
      ...
      return Pb(d({ method: O[4409], url: O[27243] }, e));
    }, checkOrder: function (t) {
      var n = this;return Pb(d({ method: O[4409], url: O[27244] }, t)).then(function (e) {
        return n.wxMpPay(JSON.parse(e.data.token), t);
      });
    }, checkQrcode: function (e) {
      return e.data && (e.data.is_last = 2), Pb(d({ url: O[27245] }, e));
    }, reportAdClick: function (e) {
      return Pb(d({ url: O[27246] }, e));
    }, removeOffScreen: function () {
      l.default.removeOffScreen();
    }, checkMsg: function (e) {
      return Pb(d({ method: O[4409], url: O[27247] }, e));
    }, gameMinicard: function (e) {
      return Pb(d({ method: O[4409], url: O[27248] }, e));
    }, userCheckpay: function (e) {
      return Pb(d({ method: O[4409], url: O[27249] }, e));
    } };e.exports = u;
}, function (e, t, n) {
  "use strict";
  ...
  function o(e, t) {
    ...
    var t,
        n,
        r = "";for (n = 0; n < e.length; n += 1) t = e.charCodeAt(n), r += O[27250].charAt(t >>> 4 & 15) + O[27250].charAt(15 & t);return r;
  }function h(e) {
