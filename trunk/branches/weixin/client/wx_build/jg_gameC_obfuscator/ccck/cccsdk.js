...
import Dall from "./ccchelp";var config = { game_id: p[25815], game_pkg: p[25816], partner_id: "19", game_ver: p[25817], is_auth: !1, from: null, tmpId: { 1: p[25818], 2: p[25819], 3: p[25820] }, min_app_id: "" };window.config = config;var $aAEBCD = $aAEDBC();var HOST = p[25801];var t;var t_second = 0;var t_max = 300;var $aAEBDC = null;var $aAECBD = null;var $aAECDB = null;function $aAEDBC() {
  var r = {};return { order_data: {}, init: function (e, n) {
      var o = e && e.game_ver ? e.game_ver : 0;console.log(p[25821]);var t = this;var a;a = (r = wx.getStorageSync(p[25822])) ? 0 : (r = t.uuid(16, 32), wx.setStorageSync(p[25822], r), 1), (i = wx.getStorageSync(p[25823])) || (i = t.uuid(16, 32), wx.setStorageSync(p[25823], i));e = wx.getLaunchOptionsSync();var r = e.scene || "";var i;console.log(p[25824]), console.log(e), a && e.query && e.query.ad_code && wx.setStorageSync(p[25825], e.query.ad_code), e.query && e.query.from && "" != e.query.from ? (a && wx.setStorageSync(p[25826], e.query.from), config.from = e.query.from) : (i = wx.getStorageSync(p[25826])) || "" == i || (config.from = i), console.log(config.from), t.log(p[282], { install: a, scene: r }), wx.showShareMenu();t = e.query && e.query.invite ? e.query.invite : "";e = e.query && e.query.invite_type ? e.query.invite_type : "";t && ($aAECBD = { invite: t, invite_type: e, is_new: a, scene: r }), o && this.checkGameVersion(o, function (e) {
        n && n(e);
      });
    }, login: function (e, n) {
      console.log(p[25827]);var t = this;r.login = p[25488] == typeof n ? n : null, config.is_auth ? wx.getSetting({ success: function (e) {
          var n, o;e.authSetting[p[25828]] ? (console.log(p[25829]), t.do_login()) : (console.log(p[25830]), wx.hideLoading({}), e = 2 * (n = wx.getSystemInfoSync()).screenWidth / 3, n.screenHeight, (o = wx.createUserInfoButton({ type: p[3748], text: p[25831], withCredentials: !1, style: { top: n.windowHeight / 2 + n.windowHeight / 4, left: n.windowWidth / 2 - 100, width: 200, height: 40, lineHeight: 40, backgroundColor: p[25832], color: p[3770], textAlign: p[1473], fontSize: 16, borderRadius: 4 } })).show(), o.onTap(e => {
      ...
      var a = this;wx.login({ success: function (e) {
          if (console.log(p[25837] + JSON.stringify(e)), e.code) {
            var t = a.getPublicData();if (t.is_from_min = 1, t.code = e.code, t.nick_name = o ? o.nick_name : "", t.head_img = o ? o.head_img : "", $aAECBD && p[277] == typeof $aAECBD) for (var n in $aAECBD) t[n] = $aAECBD[n];config.is_auth ? wx.getUserInfo({ success: function (e) {
                var n = e.encryptedData;var o = e.iv;e = e.signature;t.encryptedData = n, t.iv = o, t.signature = e, wx.request({ url: p[25804] + HOST + p[25838], method: p[25806], dataType: p[5107], header: { "content-type": p[25807] }, data: t, success: function (e) {
                ...
                r.login && r.login(1, { errMsg: e.errMsg });
              } }) : wx.request({ url: p[25804] + HOST + p[25838], method: p[25806], dataType: p[5107], header: { "content-type": p[25807] }, data: t, success: function (e) {
                if (console.log(p[25839]), console.log(e), 200 == e.statusCode) {
                  var n = e.data;if (n.state) {
                    e = { userid: n.data.user_id, account: n.data.nick_name, token: n.data.token, invite_uid: n.data.invite_uid || "", invite_nickname: n.data.invite_nickname || "", invite_head_img: n.data.invite_head_img || "", head_img: n.data.head_img || "", is_client: n.data.is_client || "0", ios_pay: n.data.ios_pay || "0" };try {
                      wx.setStorageSync(p[25840], n.data.sdk_token), wx.setStorageSync(p[25841], n.data.user_id), wx.setStorageSync(p[25802], n.data.username), n.data.ext && wx.setStorageSync(p[25842], n.data.ext);
      ...
      r.share = p[25488] == typeof callback ? callback : null;var n = e.type || p[25849];console.log(p[25850] + n);var o = this;this.getShareInfo(n, function (e) {
        o.logStartShare(n), wx.shareAppMessage({ title: e.title, imageUrl: e.img, query: e.query });
      });
    }, logStartShare: function (e) {
      var n = wx.getStorageSync(p[25840]);wx.request({ url: p[25804] + HOST + p[25851], method: p[25806], dataType: p[5107], header: { "content-type": p[25807] }, data: { game_pkg: config.game_pkg, partner_id: config.partner_id, sdk_token: n, server_id: $aAEBDC ? $aAEBDC.server_id : "", role_id: $aAEBDC ? $aAEBDC.role_id : "", type: e }, success: function (e) {} });
    }, $aCB: function () {
      wx.openCustomerServiceConversation();
    }, checkGameVersion: function (e, n) {
      console.log(p[25852]);wx.getStorageSync(p[25840]);wx.request({ url: p[25804] + HOST + p[25853], method: p[25806], dataType: p[5107], header: { "content-type": p[25807] }, data: { game_pkg: config.game_pkg, partner_id: config.partner_id, game_ver: e }, success: function (e) {
      ...
      console.log(p[25860]);var i = wx.getStorageSync(p[25840]);wx.request({ url: p[25804] + HOST + p[25861], method: p[25806], dataType: p[5107], header: { "content-type": p[25807] }, data: { game_pkg: config.game_pkg, partner_id: config.partner_id, sdk_token: i, invite: e, invite_type: n, is_new: o, role_id: t, sever_id: a, scene: r }, success: function (e) {
          console.log(p[25862]), console.log(e);
        } });
    }, msgCheck: function (e, n) {
      console.log(p[25863]);var o = wx.getStorageSync(p[25840]);wx.request({ url: p[25804] + HOST + p[25864], method: p[25806], dataType: p[5107], header: { "content-type": p[25807] }, data: { game_pkg: config.game_pkg, partner_id: config.partner_id, sdk_token: o, content: e }, success: function (e) {
      ...
      console.log(p[25867]), console.log(e);var o = this;r.pay = p[25488] == typeof n ? n : null;var t = wx.getStorageSync(p[25840]);n = wx.getStorageSync(p[25842]);var a;t && n ? (a = wx.getSystemInfoSync(), t = { cpbill: e.cpbill, productid: e.productid, productname: e.productname, productdesc: e.productdesc, serverid: e.serverid, servername: e.servername, roleid: e.roleid, rolename: e.rolename, rolelevel: e.rolelevel, price: e.price, extension: e.extension, sdk_token: t, session_key: n, platform: a.platform }, o.order_data = t, (n = o.getPublicData()).order_data = JSON.stringify(t), n.is_from_min = 1, wx.request({ url: p[25804] + HOST + p[25868], method: p[25806], dataType: p[5107], header: { "content-type": p[25807] }, data: n, success: function (e) {
      ...
      console.log(p[25893]);var o = this;var t = wx.getStorageSync(p[25842]);wx.request({ url: p[25804] + HOST + p[25894] + config.partner_id + "/" + config.game_pkg + "/", method: p[25806], dataType: p[5107], header: { "content-type": p[25807] }, data: { order_id: n.orderId, time: n.time, sign: n.sign, session_key: t }, success: function (e) {
      ...
      var n = wx.getStorageSync(p[25841]);var o = wx.getStorageSync(p[25802]);var t = {};t.user_id = n, t.user_name = o, t.role_id = e.roleid, t.role_lev = e.rolelevel, t.role_name = e.rolename, t.server_id = e.serverid, e.roleid && e.serverid && ($aAEBDC = { role_id: e.roleid, server_id: e.serverid }), this.log(p[6], t);
    }, logEnterGame: function (e) {
      var n = wx.getStorageSync(p[25841]);var o = wx.getStorageSync(p[25802]);var t = {};t.user_id = n, t.user_name = o, t.role_id = e.roleid, t.role_lev = e.rolelevel, t.role_name = e.rolename, t.server_id = e.serverid, e.roleid && e.serverid && ($aAEBDC = { role_id: e.roleid, server_id: e.serverid }), this.log(p[4989], t), $aAECBD && this.updateShare($aAECBD.invite, $aAECBD.invite_type, $aAECBD.is_new, e.roleid, e.serverid, $aAECBD.scene);
      ...
      console.log(p[25904] + e), r.subscribeMessage = p[25488] == typeof n ? n : null, wx.requestSubscribeMessage({ tmplIds: e, success(e) {
