...
function copy(e, t) {
  ...
  }o instanceof t || (n.prototype = t.prototype, n = new n(), copy(o, n), e.prototype = o = n), o.constructor != e && ($c[106] != typeof e && console.error($c[107] + e), o.constructor = e);
}function DOMException(e, t) {
  if (t instanceof Error) var n = t;else n = this, Error.call(this, ExceptionMessage[e]), this.message = ExceptionMessage[e], Error.captureStackTrace && Error.captureStackTrace(this, DOMException);return n.code = e, t && (this.message = this.message + $c[108] + t), n;
  ...
  var t = e._node._inc || e._node.ownerDocument._inc;if (e._inc != t) {
    var n = e._refresh(e._node);__set__(e, $c[109], n.length), copy(n, e), e._inc = t;
  }
  ...
  var o = _findNodeIndex(t, n);if (!(o >= 0)) throw DOMException(NOT_FOUND_ERR, new Error(e.tagName + $c[110] + n));for (var i = t.length - 1; i > o;) t[o] = t[++o];if (t.length = i, e) {
  ...
  return $c[111] == e && $c[112] || $c[113] == e && $c[114] || $c[115] == e && $c[116] || $c[117] == e && $c[118] || $c[119] + e.charCodeAt() + $c[120];
  ...
  e && e._inc++;var o = n.namespaceURI;$c[121] == o && (t._nsMap[n.prefix ? n.localName : ""] = n.value);
}function _onRemoveAttribute(e, t, n) {
  e && e._inc++;var o = n.namespaceURI;$c[122] == o && delete t._nsMap[n.prefix ? n.localName : ""];
  ...
  var o = e.prefix || "",
      i = e.namespaceURI;if (!o && !i) return !1;if ($c[123] === o && $c[124] === i || $c[125] == i) return !1;for (var r = n.length; r--;) {
    var a = n[r];if (a.prefix == o) return a.namespace != i;
  }return !0;
}function serializeToString(e, t, n, o, i) {
  if (o) {
    if (e = o(e), !e) return;if ($c[126] == typeof e) return t.push(e), void 0;
  }switch (e.nodeType) {case ELEMENT_NODE:
      i || (i = []);var r = (i.length, e.attributes),
          a = r.length,
          s = e.firstChild,
          u = e.tagName;n = htmlns === e.namespaceURI || n, t.push($c[127], u);for (var d = 0; a > d; d++) {
        var c = r.item(d);$c[128] == c.prefix ? i.push({ prefix: c.localName, namespace: c.value }) : $c[129] == c.nodeName && i.push({ prefix: "", namespace: c.value });
      }for (var d = 0; a > d; d++) {
        var c = r.item(d);if (needNamespaceDefine(c, n, i)) {
          var N = c.prefix || "",
              l = c.namespaceURI,
              p = N ? $c[130] + N : $c[131];t.push(p, $c[132], l, $c[133]), i.push({ prefix: N, namespace: l });
        }serializeToString(c, t, n, o, i);
      }if (needNamespaceDefine(e, n, i)) {
        var N = e.prefix || "",
            l = e.namespaceURI,
            p = N ? $c[134] + N : $c[135];t.push(p, $c[136], l, $c[137]), i.push({ prefix: N, namespace: l });
      }if (s || n && !/^(?:meta|link|img|br|hr|input)$/i.test(u)) {
        if (t.push($c[138]), n && /^script$/i.test(u)) for (; s;) s.data ? t.push(s.data) : serializeToString(s, t, n, o, i), s = s.nextSibling;else for (; s;) serializeToString(s, t, n, o, i), s = s.nextSibling;t.push($c[139], u, $c[140]);
      } else t.push($c[141]);return;case DOCUMENT_NODE:case DOCUMENT_FRAGMENT_NODE:
      for (var s = e.firstChild; s;) serializeToString(s, t, n, o, i), s = s.nextSibling;return;case ATTRIBUTE_NODE:
      return t.push($c[142], e.name, $c[143], e.value.replace(/[<&"]/g, _xmlEncoder), $c[144]);case TEXT_NODE:
      return t.push(e.data.replace(/[<&]/g, _xmlEncoder));case CDATA_SECTION_NODE:
      return t.push($c[145], e.data, $c[146]);case COMMENT_NODE:
      return t.push($c[147], e.data, $c[148]);case DOCUMENT_TYPE_NODE:
      var E = e.publicId,
          m = e.systemId;if (t.push($c[149], e.name), E) t.push($c[150], E), m && $c[151] != m && t.push($c[152], m), t.push($c[153]);else if (m && $c[154] != m) t.push($c[155], m, $c[156]);else {
        var h = e.internalSubset;h && t.push($c[157], h, $c[158]), t.push($c[159]);
      }return;case PROCESSING_INSTRUCTION_NODE:
      return t.push($c[160], e.target, $c[161], e.data, $c[162]);case ENTITY_REFERENCE_NODE:
      return t.push($c[163], e.nodeName, $c[164]);default:
      t.push($c[165], e.nodeName);}
  ...
  var o = new t.constructor();for (var i in t) {
    var r = t[i];$c[166] != typeof r && r != o[i] && (o[i] = r);
  ...
  switch (e.nodeType) {case ELEMENT_NODE:case DOCUMENT_FRAGMENT_NODE:
    ...
    ExceptionCode = {},
    ExceptionMessage = {},
    INDEX_SIZE_ERR = ExceptionCode.INDEX_SIZE_ERR = (ExceptionMessage[1] = $c[168], 1),
    DOMSTRING_SIZE_ERR = ExceptionCode.DOMSTRING_SIZE_ERR = (ExceptionMessage[2] = $c[169], 2),
    HIERARCHY_REQUEST_ERR = ExceptionCode.HIERARCHY_REQUEST_ERR = (ExceptionMessage[3] = $c[170], 3),
    WRONG_DOCUMENT_ERR = ExceptionCode.WRONG_DOCUMENT_ERR = (ExceptionMessage[4] = $c[171], 4),
    INVALID_CHARACTER_ERR = ExceptionCode.INVALID_CHARACTER_ERR = (ExceptionMessage[5] = $c[172], 5),
    NO_DATA_ALLOWED_ERR = ExceptionCode.NO_DATA_ALLOWED_ERR = (ExceptionMessage[6] = $c[173], 6),
    NO_MODIFICATION_ALLOWED_ERR = ExceptionCode.NO_MODIFICATION_ALLOWED_ERR = (ExceptionMessage[7] = $c[174], 7),
    NOT_FOUND_ERR = ExceptionCode.NOT_FOUND_ERR = (ExceptionMessage[8] = $c[175], 8),
    NOT_SUPPORTED_ERR = ExceptionCode.NOT_SUPPORTED_ERR = (ExceptionMessage[9] = $c[176], 9),
    INUSE_ATTRIBUTE_ERR = ExceptionCode.INUSE_ATTRIBUTE_ERR = (ExceptionMessage[10] = $c[177], 10),
    INVALID_STATE_ERR = ExceptionCode.INVALID_STATE_ERR = (ExceptionMessage[11] = $c[178], 11),
    SYNTAX_ERR = ExceptionCode.SYNTAX_ERR = (ExceptionMessage[12] = $c[179], 12),
    INVALID_MODIFICATION_ERR = ExceptionCode.INVALID_MODIFICATION_ERR = (ExceptionMessage[13] = $c[180], 13),
    NAMESPACE_ERR = ExceptionCode.NAMESPACE_ERR = (ExceptionMessage[14] = $c[181], 14),
    INVALID_ACCESS_ERR = ExceptionCode.INVALID_ACCESS_ERR = (ExceptionMessage[15] = $c[182], 15);DOMException.prototype = Error.prototype, copy(ExceptionCode, DOMException), NodeList.prototype = { length: 0, item: function (e) {
    return this[e] || null;
  ...
  return _updateLiveList(this), this[e];
  ...
  } }, copy(NodeType, Node), copy(NodeType, Node.prototype), Document.prototype = { nodeName: $c[183], nodeType: DOCUMENT_NODE, doctype: null, documentElement: null, _inc: 1, insertBefore: function (e, t) {
    ...
    var t = null;return _visitNode(this.documentElement, function (n) {
      return n.nodeType == ELEMENT_NODE && n.getAttribute($c[184]) == e ? (t = n, !0) : void 0;
    }), t;
    ...
    var n = new Attr(),
        o = t.split($c[186]);return n.ownerDocument = this, n.nodeName = t, n.name = t, n.namespaceURI = e, n.specified = !0, 2 == o.length ? (n.prefix = o[0], n.localName = o[1]) : n.localName = t, n;
    ...
    return new LiveNodeList(this, function (t) {
      var n = [];return _visitNode(t, function (o) {
        o === t || o.nodeType != ELEMENT_NODE || $c[187] !== e && o.tagName != e || n.push(o);
      }), n;
    });
  }, getElementsByTagNameNS: function (e, t) {
    return new LiveNodeList(this, function (n) {
      var o = [];return _visitNode(n, function (i) {
        i === n || i.nodeType !== ELEMENT_NODE || $c[188] !== e && i.namespaceURI !== e || $c[189] !== t && i.localName != t || o.push(i);
      }), o;
    });
  ...
  } }, _extends(CharacterData, Node), Text.prototype = { nodeName: $c[190], nodeType: TEXT_NODE, splitText: function (e) {
    var t = this.data,
