...
var ui,
  ...
  var e, i;function b$c(t) {
    ...
    this.b$w.showGetBtn && 1 == this.b$w.showGetBtn && (this.getTipsBtn.visible = !0, this.getTipsBtn.tag = !0, this.getTipsBtn.skin = "c2/a1.png", this.getTipsBtn.on(Laya.Event.CLICK, this, this.b$z), this.b$A(), this.b$B(!0));
  }, b$c.prototype.b$z = function () {
    this.getTipsBtn.tag && (this.getTipsBtn.tag = !1, this.getTipsBtn.skin = "c2/a2.png", this.b$C(), this.b$B(!1));
    ...
    this.b$D || (this.b$D = i.create(this.getTipsBtn, "r3", 4, 0, 12), this.b$D.pos(161, 106), this.b$D.scale(1.14, 1.15)), i.play(this.b$D);
