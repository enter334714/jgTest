console.info("0 \u8fdb\u5165\u6e38\u620f\u5305"), window.lastError, wx.onError(function (o) {
  ...
  render();
}, 16), console.info("2 \u52a0\u8f7d\u6e38\u620f"), wxShowLoading({ title: "\u6b63\u5728\u52a0\u8f7d" });var wxData = { showLoadingBtn: !0 };new window.ServerLoading(wxData), window.ServerLoading.instance.openAuthor(), window.loadingInterval && clearInterval(window.loadingInterval), window.loadingInterval = null, window.compareVersion = function (o, e) {
  if (!o || !e) return 0;o = o.split("."), e = e.split(".");var n = Math.max(o.length, e.length);for (; o.length < n;) o.push("0");for (; e.length < n;) e.push("0");for (var r = 0; r < n; r++) {
    var a = parseInt(o[r]),
        i = parseInt(e[r]);if (i < a) return 1;if (a < i) return -1;
  }return 0;
  ...
  console.log("protobuf \u5206\u5305\u52a0\u8f7d");var o = wx.loadSubpackage({ name: "ddddddf", success: function (o) {
  ...
  console.log("Main \u5206\u5305\u52a0\u8f7d");var o = wx.loadSubpackage({ name: "ddddddddd", success: function (o) {
