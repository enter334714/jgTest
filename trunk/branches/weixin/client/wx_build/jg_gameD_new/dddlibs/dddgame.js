console.info("0 \u8fdb\u5165\u6e38\u620f\u5305"), window.lastError, wx.onError(function (o) {
  if (o) {
    if (o.message) {
      var n = window.config.game_ver.replace(new RegExp(/\./, "g"), "_");var e = o.message;var i = e.match(/(subPackage\/dddgame.js:)[0-9]{1,60}(:)/g);if (i) for (var a = 0; a < i.length; a++) {
        var w;i[a] && 0 < i[a].length && (w = parseInt(i[a].replace("game.js:", "").replace(":", "")), e = e.replace(i[a], i[a].replace(":" + w + ":", ":" + (w - 2) + ":")));
      }e = (e = e.replace(new RegExp("game.js", "g"), "subPackage/main__" + n + ".min.js")).replace(new RegExp("dddmain.js", "g"), "subPackage/main__" + n + ".min.js"), o.message = e;
